...
return t.forEach(e=>delete a[e]),a}const _=/^on[^a-z]/,P=e=>_.test(e),T=["onAfterscriptexecute","onAnimationcancel","onAnimationend","onAnimationiteration","onAnimationstart","onAuxclick","onBeforeinput","onBeforescriptexecute","onChange","onClick","onCompositionend","onCompositionstart","onCompositionupdate","onContextmenu","onCopy","onCut","onDblclick","onFocusin","onFocusout","onFullscreenchange","onFullscreenerror","onGesturechange","onGestureend","onGesturestart","onGotpointercapture","onInput","onKeydown","onKeypress","onKeyup","onLostpointercapture","onMousedown","onMousemove","onMouseout","onMouseover","onMouseup","onMousewheel","onPaste","onPointercancel","onPointerdown","onPointerenter","onPointerleave","onPointermove","onPointerout","onPointerover","onPointerup","onReset","onSelect","onSubmit","onTouchcancel","onTouchend","onTouchmove","onTouchstart","onTransitioncancel","onTransitionend","onTransitionrun","onTransitionstart","onWheel"],A=["ArrowUp","ArrowDown","ArrowRight","ArrowLeft","Enter","Escape","Tab"," "]
function R(e){const[t,a]=E(e,[_]),l=I(t,T),[n,o]=E(a,["class","style","id",/^data-/])
...
const Ee=2.4,Ie=.2126729,_e=.7151522,Pe=.072175,Te=.03,Ae=12.82051282051282,Re=.06
...
if(u<=Te&&(u+=(Te-u)**1.45),c<=Te&&(c+=(Te-c)**1.45),Math.abs(c-u)<5e-4)return 0
if(c>u){const e=1.25*(c**.55-u**.58)
s=e<.001?0:e<.078?e-e*Ae*Re:e-Re}else{const e=1.25*(c**.62-u**.57)
s=e>-.001?0:e>-.078?e-e*Ae*Re:e+Re}return 100*s}const De=.20689655172413793,Fe=e=>e>De**3?Math.cbrt(e):e/(3*De**2)+4/29,$e=e=>e>De?e**3:3*De**2*(e-4/29)
...
return()=>t.h(a.tag,{class:[e,a.class],style:a.style},n.default?.())}})}function kt(e,t){let a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:new WeakMap
if(e===t)return!0
...
n.set(t,l),a.set(e,n)}}(e,t,a,!0),l.every(l=>kt(e[l],t[l],a)))}function xt(e){if("function"!=typeof e.getRootNode){for(;e.parentNode;)e=e.parentNode
...
for(;e;){if(t?Rt(e):At(e))return e
e=e.parentElement}return document.scrollingElement}function Tt(e,t){const a=[]
if(t&&e&&!t.contains(e))return a
for(;e&&(At(e)&&a.push(e),e!==t);)e=e.parentElement
return a}function At(e){if(!e||e.nodeType!==Node.ELEMENT_NODE)return!1
...
return{id:a,...l,size:Number(n.value),position:o.value}})),V=e=>y.value.find(t=>t.id===e),w=mt("createLayout"),S=t.shallowRef(!1)
t.onMounted(()=>{S.value=!0}),t.provide(qt,{register:(e,l)=>{let{id:d,order:v,position:g,layoutSize:h,elementSize:b,active:V,disableTransitions:k,absolute:x}=l
...
for(const r of y(a[n],1))l[`${e}-${n}-${r}`]=nt(o(qe(t),r))}return l}function Sa(e,t){if(!t)return{}
let a={}
for(const l of t.colors){const n=e[l]
n&&(a={...a,...wa(l,n,t)})}return a}function ka(e){const t={}
...
for(const[t,a]of Object.entries(i.value)){const n={...a.colors,...Sa(a.colors,l.variations)}
e[t]={...a,colors:{...n,...ka(n)}}}return e}),v=t.toRef(()=>d.value[c.value]),p=t.toRef(()=>"system"===r.value),m=t.computed(()=>{const e=[],t=l.unimportant?"":" !important",a=l.scoped?l.prefix:""
...
return Bt(()=>t.createElementVNode("div",{ref:s,class:t.normalizeClass(["v-application",n.themeClasses.value,o.value,u.value,e.class]),style:t.normalizeStyle([e.style])},[t.createElementVNode("div",{class:"v-application__wrap"},[l.default?.()])])),{getLayoutItem:r,items:i,theme:n}}}),Pa=vt({tag:{type:[String,Object,Function],default:"div"}},"tag"),Ta=vt({text:String,...pt(),...Pa()},"VToolbarTitle"),Aa=wt()({name:"VToolbarTitle",props:Ta(),setup(e,a){let{slots:l}=a
...
return t&&[...t]}function Oa(e,t){const a=ke(e),l=xe(t),[n,o]=getComputedStyle(t).transformOrigin.split(" ").map(e=>parseFloat(e)),[r,i]=getComputedStyle(t).getPropertyValue("--v-overlay-anchor-origin").split(" ")
...
return{colorClasses:n,colorStyles:o,variantClasses:l}}const zl=vt({baseColor:String,divided:Boolean,direction:{type:String,default:"horizontal"},...wl(),...pt(),...Rl(),...kl(),...pl(),...Pa(),...ya(),...$l()},"VBtnGroup"),Ll=wt()({name:"VBtnGroup",props:zl(),setup(e,a){let{slots:l}=a
const{themeClasses:n}=Ca(e),{densityClasses:o}=Bl(e),{borderClasses:r}=Sl(e),{elevationClasses:i}=xl(e),{roundedClasses:s}=ml(e)
...
return t.forEach(t=>{const l=e.find(e=>kt(t,e.value)),n=e[t]
...
const n=t.ref(),o=la(e,"modelValue"),{isRtl:r,rtlClasses:i}=ga(),{themeClasses:s}=Ca(e),{locationStyles:u}=on(e),{textColorClasses:c,textColorStyles:d}=cl(()=>e.color),{backgroundColorClasses:v,backgroundColorStyles:p}=dl(()=>e.bgColor||e.color),{backgroundColorClasses:m,backgroundColorStyles:f}=dl(()=>e.bufferColor||e.bgColor||e.color),{backgroundColorClasses:g,backgroundColorStyles:h}=dl(()=>e.color),{roundedClasses:y}=ml(e),{intersectionRef:V,isIntersecting:w}=en(),S=t.computed(()=>parseFloat(e.max)),k=t.computed(()=>parseFloat(e.height)),x=t.computed(()=>F(parseFloat(e.bufferValue)/S.value*100,0,100)),N=t.computed(()=>F(parseFloat(o.value)/S.value*100,0,100)),C=t.computed(()=>r.value!==e.reverse),E=t.computed(()=>e.indeterminate?"fade-transition":"slide-x-transition"),I=t.shallowRef(0),{hasChunks:_,chunksMaskStyles:P,snapValueToChunk:T}=function(e,a){const l=t.toRef(()=>!!e.chunkCount||!!e.chunkWidth),n=t.computed(()=>{const l=t.toValue(a)
if(!l)return 0
...
const A=t.computed(()=>_.value?T(x.value):x.value),R=t.computed(()=>_.value?T(N.value):N.value)
...
function wn(e,t){e.style.transform=t,e.style.webkitTransform=t}function Sn(e){return"TouchEvent"===e.constructor.name}function kn(e){return"KeyboardEvent"===e.constructor.name}const xn={show(e,t){let a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}
...
if(!kn(e)){const a=t.getBoundingClientRect(),o=Sn(e)?e.touches[e.touches.length-1]:e
...
if(a?._ripple&&!a._ripple.touched&&!e[Vn]){if(e[Vn]=!0,Sn(e))a._ripple.touched=!0,a._ripple.isTouch=!0
else if(a._ripple.isTouch)return
if(t.center=a._ripple.centered||kn(e),a._ripple.class&&(t.class=a._ripple.class),Sn(e)){if(a._ripple.showTimerCommit)return
...
function Tn(e,t){!Pn&&t.includes(e.key)&&(Pn=!0,Cn(e))}function An(e){Pn=!1,In(e)}function Rn(e){Pn&&(Pn=!1,In(e))}function Bn(e,t,a){const{value:l,modifiers:n}=t,o=Nn(l)
...
if(e._ripple.keyDownHandler=e=>Tn(e,i),o&&!a){if(n.stop)return e.addEventListener("touchstart",En,{passive:!0}),void e.addEventListener("mousedown",En)
e.addEventListener("touchstart",Cn,{passive:!0}),e.addEventListener("touchend",In,{passive:!0}),e.addEventListener("touchmove",_n,{passive:!0}),e.addEventListener("touchcancel",In),e.addEventListener("mousedown",Cn),e.addEventListener("mouseup",In),e.addEventListener("mouseleave",In),e.addEventListener("keydown",e=>Tn(e,i)),e.addEventListener("keyup",An),e.addEventListener("blur",Rn),e.addEventListener("dragstart",In,{passive:!0})}else!o&&a&&Dn(e)}function Dn(e){e.removeEventListener("mousedown",Cn),e.removeEventListener("touchstart",Cn),e.removeEventListener("touchend",In),e.removeEventListener("touchmove",_n),e.removeEventListener("touchcancel",In),e.removeEventListener("mouseup",In),e.removeEventListener("mouseleave",In),e._ripple?.keyDownHandler&&e.removeEventListener("keydown",e._ripple.keyDownHandler),e.removeEventListener("keyup",An),e.removeEventListener("dragstart",In),e.removeEventListener("blur",Rn)}const Fn={mounted:function(e,t){Bn(e,t,!1)},unmounted:function(e){Dn(e),delete e._ripple},updated:function(e,t){if(t.value===t.oldValue)return
Bn(e,t,Nn(t.oldValue))}},$n=vt({active:{type:Boolean,default:void 0},activeColor:String,baseColor:String,symbol:{type:null,default:Ul},flat:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Dt,appendIcon:Dt,block:Boolean,readonly:Boolean,slim:Boolean,stacked:Boolean,spaced:String,ripple:{type:[Boolean,Object],default:!0},text:{type:[String,Number,Boolean],default:void 0},...wl(),...pt(),...Rl(),...ol(),...kl(),...jl(),...cn(),...nn(),...mn(),...pl(),...yn(),...Xl(),...Pa({tag:"button"}),...ya(),...$l({variant:"elevated"})},"VBtn"),Mn=wt()({name:"VBtn",props:$n(),emits:{"group:selected":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
const{themeClasses:o}=Ca(e),{borderClasses:r}=Sl(e),{densityClasses:i}=Bl(e),{dimensionStyles:s}=rl(e),{elevationClasses:u}=xl(e),{loaderClasses:c}=dn(e),{locationStyles:d}=on(e),{positionClasses:v}=fn(e),{roundedClasses:p}=ml(e),{sizeClasses:m,sizeStyles:f}=Zl(e),g=Wl(e,e.symbol,!1),h=hn(e,l),y=t.computed(()=>void 0!==e.active?e.active:h.isRouterLink.value?h.isActive?.value:g?.isSelected.value),b=t.toRef(()=>y.value?e.activeColor??e.color:e.color),V=t.computed(()=>({color:g?.isSelected.value&&(!h.isLink.value||h.isActive?.value)||!g||h.isActive?.value?b.value??e.baseColor:e.baseColor,variant:e.variant})),{colorClasses:w,colorStyles:S,variantClasses:k}=Ml(V),x=t.computed(()=>g?.disabled.value||e.disabled),N=t.toRef(()=>"elevated"===e.variant&&!(e.disabled||e.flat||e.border)),C=t.computed(()=>{if(void 0!==e.value&&"symbol"!=typeof e.value)return Object(e.value)===e.value?JSON.stringify(e.value,null,0):e.value})
...
return Bt(()=>t.createElementVNode("label",{class:t.normalizeClass(["v-label",{"v-label--clickable":!!e.onClick},e.class]),style:t.normalizeStyle(e.style),onClick:e.onClick},[e.text,l.default?.()])),{}}}),Qn=Symbol.for("vuetify:selection-control-group"),Jn=vt({color:String,disabled:{type:Boolean,default:null},defaultsTarget:String,error:Boolean,id:String,inline:Boolean,falseIcon:Dt,trueIcon:Dt,ripple:{type:[Boolean,Object],default:!0},multiple:{type:Boolean,default:null},name:String,readonly:{type:Boolean,default:null},modelValue:null,type:String,valueComparator:{type:Function,default:kt},...pt(),...Rl(),...ya()},"SelectionControlGroup"),eo=vt({...Jn({defaultsTarget:"VSelectionControl"})},"VSelectionControlGroup"),to=wt()({name:"VSelectionControlGroup",props:eo(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
n&&l.push(...n)}}}}})}const ko=vt({...yo(),...I(no(),["inline"])},"VCheckbox"),xo=wt()({name:"VCheckbox",inheritAttrs:!1,props:ko(),emits:{"update:modelValue":e=>!0,"update:focused":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
...
return t.createVNode(oo,t.mergeProps(p,{id:a.value,"aria-describedby":l.value,disabled:r.value,readonly:u.value},d,{error:!1===c.value,modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,onFocus:i,onBlur:s}),n)}})}),So({},u)}}),No=["sm","md","lg","xl","xxl"],Co=Symbol.for("vuetify:display"),Eo={mobileBreakpoint:"lg",thresholds:{xs:0,sm:600,md:960,lg:1280,xl:1920,xxl:2560}}
...
function a(e){return Boolean(t.match(e))}return{android:a(/android/i),ios:a(/iphone|ipad|ipod/i),cordova:a(/cordova/i),electron:a(/electron/i),chrome:a(/chrome/i),edge:a(/edge/i),firefox:a(/firefox/i),opera:a(/opera/i),win:a(/win/i),mac:a(/mac/i),linux:a(/linux/i),touch:i,ssr:"ssr"===t}}function To(e,a){const{thresholds:l,mobileBreakpoint:n}=function(){return O(Eo,arguments.length>0&&void 0!==arguments[0]?arguments[0]:Eo)}(e),r=t.shallowRef(_o(a)),i=t.shallowRef(Po(a)),s=t.reactive({}),u=t.shallowRef(Io(a))
...
s.xs=e,s.sm=t,s.md=a,s.lg=o,s.xl=c,s.xxl=d,s.smAndUp=!e,s.mdAndUp=!(e||t),s.lgAndUp=!(e||t||a),s.xlAndUp=!(e||t||a||o),s.smAndDown=!(a||o||c||d),s.mdAndDown=!(o||c||d),s.lgAndDown=!(c||d),s.xlAndDown=!d,s.name=v,s.height=r.value,s.width=u.value,s.mobile=m,s.mobileBreakpoint=n,s.platform=i.value,s.thresholds=l}),o&&(window.addEventListener("resize",c,{passive:!0}),t.onScopeDispose(()=>{window.removeEventListener("resize",c)},!0)),{...t.toRefs(s),update:function(){c(),i.value=Po()},ssr:!!a}}const Ao=vt({mobile:{type:Boolean,default:!1},mobileBreakpoint:[Number,String]},"display")
...
function Do(){return{container:void 0,duration:300,layout:!1,offset:0,easing:"easeInOutCubic",patterns:It}}function Fo(e){return"string"==typeof e?document.querySelector(e):S(e)}function $o(e,t,a){if("number"==typeof e)return t&&a?-e:e
let l=Fo(e),n=0
...
c.value=p.value?a:t}function C(e){if(S.value=!0,u.value&&g.el)for(const t of e.composedPath())for(const e of g.el.children)if(e===t)return void k(e)}function E(e){S.value=!1}let I=!1
function _(e){I||S.value||e.relatedTarget&&g.el?.contains(e.relatedTarget)||R(),I=!1}function P(){I=!0}function T(e){function t(t){e.preventDefault(),R(t)}g.el&&(p.value?"ArrowRight"===e.key?t(n.value?"prev":"next"):"ArrowLeft"===e.key&&t(n.value?"next":"prev"):"ArrowDown"===e.key?t("next"):"ArrowUp"===e.key&&t("prev"),"Home"===e.key?t("first"):"End"===e.key&&t("last"))}function A(e,t){if(!e)return
let a=e
...
let t
if(e)if("next"===e){if(t=A(g.el.querySelector(":focus"),e),!t)return R("first")}else if("prev"===e){if(t=A(g.el.querySelector(":focus"),e),!t)return R("last")}else"first"===e?(t=g.el.firstElementChild,t?.hasAttribute("disabled")&&(t=A(t,"next"))):"last"===e&&(t=g.el.lastElementChild,t?.hasAttribute("disabled")&&(t=A(t,"prev")))
...
l+=e-t}x(l)}const D=t.computed(()=>({next:s.next,prev:s.prev,select:s.select,isSelected:s.isSelected})),F=t.computed(()=>u.value||Math.abs(c.value)>0),$=t.computed(()=>{switch(e.showArrows){case"always":return!0
...
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-list-item-subtitle",e.class]),style:t.normalizeStyle([{"--v-list-item-subtitle-opacity":e.opacity},e.style])},l)),{}}}),Sr=St("v-list-item-title"),kr=vt({active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:Dt,baseColor:String,disabled:Boolean,lines:[Boolean,String],link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:Dt,ripple:{type:[Boolean,Object],default:!0},slim:Boolean,prependGap:[Number,String],subtitle:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},value:null,onClick:Z(),onClickOnce:Z(),...wl(),...pt(),...Rl(),...ol(),...kl(),...pl(),...yn(),...Pa(),...ya(),...$l({variant:"text"})},"VListItem"),xr=wt()({name:"VListItem",directives:{vRipple:Fn},props:kr(),emits:{click:e=>!0},setup(e,a){let{attrs:l,slots:o,emit:r}=a
const i=hn(e,l),s=t.computed(()=>void 0===e.value?i.href.value:e.value),{activate:u,isActivated:c,select:d,isOpen:v,isSelected:p,isIndeterminate:m,isGroupActivator:f,root:g,parent:h,openOnSelect:y,id:V}=gr(s,()=>e.disabled,!1),w=lr(),S=t.computed(()=>!1!==e.active&&(e.active||i.isActive?.value||(g.activatable.value?c.value:p.value))),k=t.toRef(()=>!1!==e.link&&i.isLink.value),x=t.computed(()=>!!w&&(g.selectable.value||g.activatable.value||null!=e.value)),N=t.computed(()=>!e.disabled&&!1!==e.link&&(e.link||i.isClickable.value||x.value)),C=t.computed(()=>w?k.value?"link":x.value?"option":"listitem":void 0),E=t.computed(()=>{if(x.value)return g.activatable.value?c.value:g.selectable.value?p.value:S.value}),I=t.toRef(()=>e.rounded||e.nav),_=t.toRef(()=>e.color??e.activeColor),P=t.toRef(()=>({color:S.value?_.value??e.baseColor:e.baseColor,variant:e.variant}))
function T(){null!=h.value&&g.open(h.value,!0),y(!0)}t.watch(()=>i.isActive?.value,e=>{e&&T()}),t.onBeforeMount(()=>{i.isActive?.value&&t.nextTick(()=>T())})
const{themeClasses:A}=Ca(e),{borderClasses:R}=Sl(e),{colorClasses:B,colorStyles:D,variantClasses:F}=Ml(P),{densityClasses:$}=Bl(e),{dimensionStyles:M}=rl(e),{elevationClasses:z}=xl(e),{roundedClasses:L}=ml(I),O=t.toRef(()=>e.lines?`v-list-item--${e.lines}-line`:void 0),j=t.toRef(()=>void 0!==e.ripple&&e.ripple&&w?.filterable?{keys:["Enter"]}:e.ripple),W=t.computed(()=>({isActive:S.value,select:d,isOpen:v.value,isSelected:p.value,isIndeterminate:m.value}))
function H(t){r("click",t),["INPUT","TEXTAREA"].includes(t.target?.tagName)||N.value&&(i.navigate?.(t),f||(g.activatable.value?u(!c.value,t):g.selectable.value?d(!p.value,t):null==e.value||k.value||d(!p.value,t)))}function Y(e){const t=e.target;["INPUT","TEXTAREA"].includes(t.tagName)||("Enter"===e.key||" "===e.key&&!w?.filterable)&&(e.preventDefault(),e.stopPropagation(),e.target.dispatchEvent(new MouseEvent("click",e)))}return Bt(()=>{const a=k.value?"a":e.tag,l=o.title||null!=e.title,r=o.subtitle||null!=e.subtitle,s=!(!e.appendAvatar&&!e.appendIcon),u=!(!s&&!o.append),c=!(!e.prependAvatar&&!e.prependIcon),d=!(!c&&!o.prepend)
return w?.updateHasPrepend(d),e.activeColor&&n("active-color",["color","base-color"]),t.withDirectives(t.createVNode(a,t.mergeProps(i.linkProps,{class:["v-list-item",{"v-list-item--active":S.value,"v-list-item--disabled":e.disabled,"v-list-item--link":N.value,"v-list-item--nav":e.nav,"v-list-item--slim":e.slim,[`${e.activeClass}`]:e.activeClass&&S.value},A.value,R.value,B.value,$.value,z.value,O.value,L.value,F.value,e.class],style:[{"--v-list-prepend-gap":b(e.prependGap)},D.value,M.value,e.style],tabindex:N.value?w?-2:0:void 0,"aria-selected":E.value,role:C.value,onClick:H,onKeydown:N.value&&!k.value&&Y}),{default:()=>[Fl(N.value||S.value,"v-list-item"),d&&t.createElementVNode("div",{key:"prepend",class:"v-list-item__prepend"},[o.prepend?t.createVNode(nl,{key:"prepend-defaults",disabled:!c,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon},VListItemAction:{start:!0}}},{default:()=>[o.prepend?.(W.value)]}):t.createElementVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(qn,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Jl,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)]),t.createElementVNode("div",{class:"v-list-item__spacer"},null)]),t.createElementVNode("div",{class:"v-list-item__content","data-no-activator":""},[l&&t.createVNode(Sr,{key:"title"},{default:()=>[o.title?.({title:e.title})??t.toDisplayString(e.title)]}),r&&t.createVNode(wr,{key:"subtitle"},{default:()=>[o.subtitle?.({subtitle:e.subtitle})??t.toDisplayString(e.subtitle)]}),o.default?.(W.value)]),u&&t.createElementVNode("div",{key:"append",class:"v-list-item__append"},[o.append?t.createVNode(nl,{key:"append-defaults",disabled:!s,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon},VListItemAction:{end:!0}}},{default:()=>[o.append?.(W.value)]}):t.createElementVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Jl,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(qn,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)]),t.createElementVNode("div",{class:"v-list-item__spacer"},null)])]}),[[Fn,N.value&&j.value]])}),{activate:u,isActivated:c,isGroupActivator:f,isSelected:p,list:w,select:d,root:g,id:V,link:i}}}),Nr=vt({color:String,inset:Boolean,sticky:Boolean,title:String,...pt(),...Pa()},"VListSubheader"),Cr=wt()({name:"VListSubheader",props:Nr(),setup(e,a){let{slots:l}=a
...
return{type:r,title:String(i.title??""),value:i.value,props:i,children:"item"===r&&Array.isArray(n)?Ar(e,n):void 0,raw:t}}function Ar(e,t){const a=C(e,Tr.neededProps),l=[]
...
e||(e=[],t.set(n.value,e)),e.push(n)}else l.push(n)}n.value=t,o.value=l}),{items:a,transformIn:function(t){const r=n.value,i=a.value,s=o.value,u=l.value,c=e.returnObject,d=!!e.valueComparator,v=e.valueComparator||kt,p=C(e,Tr.neededProps),m=[]
...
return a}function $r(e){return{items:t.computed(()=>Fr(e,e.items))}}const Mr=vt({baseColor:String,activeColor:String,activeClass:String,bgColor:String,disabled:Boolean,filterable:Boolean,expandIcon:Dt,collapseIcon:Dt,lines:{type:[Boolean,String],default:"one"},slim:Boolean,prependGap:[Number,String],indent:[Number,String],nav:Boolean,"onClick:open":Z(),"onClick:select":Z(),"onUpdate:opened":Z(),...mr({selectStrategy:"single-leaf",openStrategy:"list"}),...wl(),...pt(),...Rl(),...ol(),...kl(),..._r(),...pl(),...Pa(),...ya(),...$l({variant:"text"})},"VList"),zr=wt()({name:"VList",props:Mr(),emits:{"update:selected":e=>!0,"update:activated":e=>!0,"update:opened":e=>!0,"click:open":e=>!0,"click:activate":e=>!0,"click:select":e=>!0},setup(e,a){let{slots:l}=a
const{items:n}=$r(e),{themeClasses:o}=Ca(e),{backgroundColorClasses:r,backgroundColorStyles:i}=dl(()=>e.bgColor),{borderClasses:s}=Sl(e),{densityClasses:u}=Bl(e),{dimensionStyles:c}=rl(e),{elevationClasses:d}=xl(e),{roundedClasses:v}=ml(e),{children:p,open:m,parents:f,select:g,getPath:h}=fr(e,n,()=>e.returnObject),y=t.toRef(()=>e.lines?`v-list--${e.lines}-line`:void 0),V=t.toRef(()=>e.activeColor),w=t.toRef(()=>e.baseColor),S=t.toRef(()=>e.color),k=t.toRef(()=>e.selectable||e.activatable)
ar({filterable:e.filterable}),yt({VListGroup:{activeColor:V,baseColor:w,color:S,expandIcon:t.toRef(()=>e.expandIcon),collapseIcon:t.toRef(()=>e.collapseIcon)},VListItem:{activeClass:t.toRef(()=>e.activeClass),activeColor:V,baseColor:w,color:S,density:t.toRef(()=>e.density),disabled:t.toRef(()=>e.disabled),lines:t.toRef(()=>e.lines),nav:t.toRef(()=>e.nav),slim:t.toRef(()=>e.slim),variant:t.toRef(()=>e.variant)}})
const x=t.shallowRef(!1),N=t.ref()
function C(e){x.value=!0}function E(e){x.value=!1}function I(e){x.value||e.relatedTarget&&N.value?.contains(e.relatedTarget)||T()}function _(e){const t=e.target
if(N.value&&("INPUT"!==t.tagName||!["Home","End"].includes(e.key))&&"TEXTAREA"!==t.tagName){if("ArrowDown"===e.key)T("next")
else if("ArrowUp"===e.key)T("prev")
else if("Home"===e.key)T("first")
else{if("End"!==e.key)return
T("last")}e.preventDefault()}}function P(e){x.value=!0}function T(e){if(N.value)return ae(N.value,e)}return Bt(()=>{const a=e.indent??(e.prependGap?Number(e.prependGap)+24:void 0)
return t.createVNode(e.tag,{ref:N,class:t.normalizeClass(["v-list",{"v-list--disabled":e.disabled,"v-list--nav":e.nav,"v-list--slim":e.slim},o.value,r.value,s.value,u.value,d.value,y.value,v.value,e.class]),style:t.normalizeStyle([{"--v-list-indent":b(a),"--v-list-group-prepend":a?"0px":void 0,"--v-list-prepend-gap":b(e.prependGap)},i.value,c.value,e.style]),tabindex:e.disabled?-1:0,role:k.value?"listbox":"list","aria-activedescendant":void 0,onFocusin:C,onFocusout:E,onFocus:I,onKeydown:_,onMousedown:P},{default:()=>[t.createVNode(Ir,{items:n.value,returnObject:e.returnObject},l)]})}),{open:m,select:g,focus:T,children:p,parents:f,getPath:h}}}),Lr=St("v-list-img"),Or=vt({start:Boolean,end:Boolean,...pt(),...Pa()},"VListItemAction"),jr=wt()({name:"VListItemAction",props:Or(),setup(e,a){let{slots:l}=a
...
return a.y-=parseFloat(e.style.top||0),a}(e.contentEl.value,e.isRtl.value),p=Tt(e.contentEl.value),m=Number(a.viewportMargin)
...
return{overflows:Se(a,f),x:o,y:r}}let V=0,w=0
...
let l=!1
if(["x","y"].forEach(o=>{if("x"===o&&t&&!k.x||"y"===o&&a&&!k.y){const t={anchor:{...h.anchor},origin:{...h.origin}},a="x"===o?"y"===e?ye:he:"y"===e?he:ye
t.anchor=a(t.anchor),t.origin=a(t.origin)
const{overflows:r}=y(t);(r[o].before<=n[o].before&&r[o].after<=n[o].after||r[o].before+r[o].after<(n[o].before+n[o].after)/2)&&(h=t,l=k[o]=!0)}}),l)continue}n.x.before&&(V+=n.x.before,t.x+=n.x.before),n.x.after&&(V-=n.x.after,t.x-=n.x.after),n.y.before&&(w+=n.y.before,t.y+=n.y.before),n.y.after&&(w-=n.y.after,t.y-=n.y.after)
{const e=Se(t,f)
S.x=f.width-e.x.before-e.x.after,S.y=f.height-e.y.before-e.y.after,V+=e.x.before,t.x+=e.x.before,w+=e.y.before,t.y+=e.y.before}break}const N=Ve(h.anchor)
return Object.assign(n.value,{"--v-overlay-anchor-origin":`${h.anchor.side} ${h.anchor.align}`,transformOrigin:`${h.origin.side} ${h.origin.align}`,top:b(qr(w)),left:e.isRtl.value?void 0:b(qr(V)),right:e.isRtl.value?b(qr(-V)):void 0,minWidth:b("y"===N?Math.min(i.value,g.width):i.value),maxWidth:b(Xr(F(S.x,i.value===1/0?0:i.value,u.value))),maxHeight:b(Xr(F(S.y,s.value===1/0?0:s.value,c.value)))}),{available:S,contentBox:t,flipped:k}}return t.watch(e.target,(e,t)=>{t&&!Array.isArray(t)&&f.unobserve(t),Array.isArray(e)?kt(e,t)||h():e&&f.observe(e)},{immediate:!0}),t.watch(e.contentEl,(e,t)=>{t&&f.unobserve(t),e&&f.observe(e)},{immediate:!0}),t.onScopeDispose(()=>{f.disconnect()}),t.watch(()=>[o.value,r.value,a.offset,a.minWidth,a.minHeight,a.maxWidth,a.maxHeight],()=>h()),t.nextTick(()=>{const e=h()
if(!e)return
...
e&&e(),Qr.length?ei():Zr=!0})}const ti={none:null,close:function(e){ni(li(e.target.value,e.contentEl.value),function(t){e.isActive.value=!1})},block:function(e,a){const l=e.root.value?.offsetParent,n=li(e.target.value,e.contentEl.value),o=[...new Set([...Tt(n,a.contained?l:void 0),...Tt(e.contentEl.value,a.contained?l:void 0)])].filter(e=>!e.classList.contains("v-overlay-scroll-blocked")),r=window.innerWidth-document.documentElement.offsetWidth,i=(s=l||document.documentElement,At(s)&&s)
var s
...
function li(e,t){return Array.isArray(e)?document.elementsFromPoint(...e).find(e=>!t?.contains(e)):e??t}function ni(e,a){const l=[document,...Tt(e)]
...
let u=!1,c=!1,d=!0
const v=t.computed(()=>e.openOnFocus||null==e.openOnFocus&&e.openOnHover),p=t.computed(()=>e.openOnClick||null==e.openOnClick&&!e.openOnHover&&!v.value),{runOpenDelay:m,runCloseDelay:f}=ii(e,t=>{t!==(e.openOnHover&&u||v.value&&c)||e.openOnHover&&l.value&&!n.value||(l.value!==t&&(d=!0),l.value=t)}),g=t.ref(),h=e=>{e.stopPropagation(),s.value=e.currentTarget||e.target,l.value||(g.value=[e.clientX,e.clientY]),l.value=!l.value},y=e=>{u=!0,s.value=e.currentTarget||e.target,m()},b=e=>{u=!1,f()},V=e=>{!1!==oe(e.target,":focus-visible")&&(c=!0,e.stopPropagation(),s.value=e.currentTarget||e.target,m())},w=e=>{c=!1,e.stopPropagation(),f({minDelay:1})},S=t.computed(()=>{const t={}
...
e&&i(e)}e&&t.nextTick(()=>r())},{immediate:!0}),t.watch(()=>e.activatorProps,()=>{r()}),t.onScopeDispose(()=>{i()})}(e,i,{activatorEl:s,activatorEvents:S})})):_&&_.stop()},{flush:"post",immediate:!0}),t.onScopeDispose(()=>{_?.stop()}),{activatorEl:s,activatorRef:N,target:E,targetEl:I,targetRef:C,activatorEvents:S,contentEvents:k,scrimEvents:x}}function ci(e,t){if(!e)return
let a
...
return n.push(t),!n.some(t=>t?.contains(e.target))}function ki(e,t){return("object"==typeof t.value&&t.value.closeConditional||wi)(e)}function xi(e,t){const a=xt(e)
...
return{globalTop:t.readonly(u),localTop:c,stackStyles:t.toRef(()=>({zIndex:s.value}))}}(v,()=>e.zIndex,e._disableGlobalStack),{activatorEl:k,activatorRef:x,target:N,targetEl:C,targetRef:E,activatorEvents:I,contentEvents:_,scrimEvents:P}=ui(e,{isActive:v,isTop:w,contentEl:c}),{teleportTarget:T}=function(e){return{teleportTarget:t.computed(()=>{const a=e()
if(!0===a||!o)return
...
return a instanceof ShadowRoot&&a}),{dimensionStyles:A}=rl(e),R=fi(),{scopeId:B}=yi()
...
const j=t.ref()
function W(){e.noClickAnimation||c.value&&Ne(c.value,[{transformOrigin:"center"},{transform:"scale(1.03)"},{transformOrigin:"center"}],{duration:150,easing:Nt})}function H(){r("afterEnter")}function Y(){h(),r("afterLeave")}return t.watch(()=>v.value&&(e.absolute||e.contained)&&null==T.value,e=>{if(e){const e=Pt(s.value)
e&&e!==document.scrollingElement&&(j.value=e.scrollTop)}}),Bt(()=>t.createElementVNode(t.Fragment,null,[l.activator?.({isActive:v.value,targetRef:E,props:t.mergeProps({ref:x},I.value,e.activatorProps)}),R.value&&g.value&&t.createVNode(t.Teleport,{disabled:!T.value,to:T.value},{default:()=>[t.createElementVNode("div",t.mergeProps({class:["v-overlay",{"v-overlay--absolute":e.absolute||e.contained,"v-overlay--active":v.value,"v-overlay--contained":e.contained},p.value,m.value,e.class],style:[S.value,{"--v-overlay-opacity":e.opacity,top:b(j.value)},e.style],ref:s,onKeydown:L},B,n),[t.createVNode(Ci,t.mergeProps({color:y,modelValue:v.value&&!!e.scrim,ref:u},P.value),null),t.createVNode(gl,{appear:!0,persisted:!0,transition:e.transition,target:N.value,onAfterEnter:H,onAfterLeave:Y},{default:()=>[t.withDirectives(t.createElementVNode("div",t.mergeProps({ref:c,class:["v-overlay__content",e.contentClass],style:[A.value,D.value]},_.value,e.contentProps),[l.default?.({isActive:v})]),[[t.vShow,v.value],[Ni,{handler:$,closeConditional:M,include:()=>[k.value]}]])]})])]})])),{activatorEl:k,scrimEl:u,target:N,animateClick:W,contentEl:c,rootEl:s,globalTop:V,localTop:w,updateLocation:F}}}),_i=vt({id:String,submenu:Boolean,...I(Ei({captureFocus:!0,closeDelay:250,closeOnContentClick:!0,locationStrategy:"connected",location:void 0,openDelay:300,scrim:!1,scrollStrategy:"reposition",transition:{component:za}}),["absolute"])},"VMenu"),Pi=wt()({name:"VMenu",props:_i(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode(nl,{root:"VMenu"},{default:()=>[l.default?.(...a)]})}})}),So({id:s,ΨopenChildren:d},u)}}),Ti=vt({active:Boolean,disabled:Boolean,max:[Number,String],value:{type:[Number,String],default:0},...pt(),...fl({transition:{component:Ja}})},"VCounter"),Ai=wt()({name:"VCounter",functional:!0,props:Ti(),setup(e,a){let{slots:l}=a
...
function b(){h.isSuppressing.value&&h.update(),i.value||s(),t.nextTick(()=>{g.value!==document.activeElement&&g.value?.focus()})}function V(e){n("mousedown:control",e),e.target!==g.value&&(b(),e.preventDefault())}function w(e){n("click:control",e)}function S(a){const l=a.target
...
n.trimStart().length===l.value.length&&(e=n.length-l.value.length),null!=o&&(l.selectionStart=o-e),null!=i&&(l.selectionEnd=i-e)})}return Bt(()=>{const a=!!(o.counter||!1!==e.counter&&null!=e.counter),n=!(!a&&!o.details),[k,x]=R(l),{modelValue:N,...C}=bo.filterProps(e),E=$i.filterProps(e)
return t.createVNode(bo,t.mergeProps({ref:m,modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-text-field",{"v-text-field--prefixed":e.prefix,"v-text-field--suffixed":e.suffix,"v-input--plain-underlined":p.value},e.class],style:e.style},k,C,{centerAffix:!p.value,focused:i.value}),{...o,default:a=>{let{id:l,isDisabled:n,isDirty:d,isReadonly:v,isValid:p,hasDetails:m,reset:k}=a
return t.createVNode($i,t.mergeProps({ref:f,onMousedown:V,onClick:w,"onClick:clear":a=>function(a,l){a.stopPropagation(),b(),t.nextTick(()=>{l(),J(e["onClick:clear"],a)})}(a,k),role:e.role},I(E,["onClick:clear"]),{id:l.value,active:y.value||d.value,dirty:d.value||e.dirty,disabled:n.value,focused:i.value,details:m.value,error:!1===p.value}),{...o,default:a=>{let{props:{class:l,...i},controlRef:d}=a
const p=t.withDirectives(t.createElementVNode("input",t.mergeProps({ref:e=>g.value=d.value=e,value:r.value,onInput:S,autofocus:e.autofocus,readonly:v.value,disabled:n.value,name:h.fieldName.value,autocomplete:h.fieldAutocomplete.value,placeholder:e.placeholder,size:1,role:e.role,type:e.type,onFocus:s,onBlur:u},i,x),null),[[yl,{handler:c},null,{once:!0}]])
return t.createElementVNode(t.Fragment,null,[e.prefix&&t.createElementVNode("span",{class:"v-text-field__prefix"},[t.createElementVNode("span",{class:"v-text-field__prefix__text"},[e.prefix])]),o.default?t.createElementVNode("div",{class:t.normalizeClass(l),"data-no-activator":""},[o.default(),p]):t.cloneVNode(p,{class:l}),e.suffix&&t.createElementVNode("span",{class:"v-text-field__suffix"},[t.createElementVNode("span",{class:"v-text-field__suffix__text"},[e.suffix])])])}})},details:n?l=>t.createElementVNode(t.Fragment,null,[o.details?.(l),a&&t.createElementVNode(t.Fragment,null,[t.createElementVNode("span",null,null),t.createVNode(Ai,{active:e.persistentCounter||i.value,value:d.value,max:v.value,disabled:e.disabled},o.counter)])]):void 0})}),So({},m,f,g)}}),Hi=vt({renderless:Boolean,...pt()},"VVirtualScrollItem"),Yi=wt()({name:"VVirtualScrollItem",inheritAttrs:!1,props:Hi(),emits:{"update:height":e=>!0},setup(e,a){let{attrs:l,emit:n,slots:o}=a
...
V.value=Math.max(V.value,performance.now()-e)},V),x=t.watch(g,e=>{e&&(x(),v=d.value.offsetTop,k.immediate(),R(),~w&&t.nextTick(()=>{o&&window.requestAnimationFrame(()=>{$(w),w=-1})}))})
...
let P=-1
function T(){c.value&&d.value&&(I=0,_=0,window.clearTimeout(P),R())}let A=-1
function R(){cancelAnimationFrame(A),A=requestAnimationFrame(B)}function B(){if(!c.value||!f.value||!n.value)return
...
return t.watch(a,()=>{y=Array.from({length:a.value.length}),b=Array.from({length:a.value.length}),k.immediate(),R()},{deep:1}),{calculateVisibleItems:R,containerRef:c,markerRef:d,computedItems:M,paddingTop:s,paddingBottom:u,scrollToIndex:$,handleScroll:function(){if(!c.value||!d.value)return
const e=c.value.scrollTop,t=performance.now()
t-_>500?(I=Math.sign(e-E),v=d.value.offsetTop):I=e-E,E=e,_=t,window.clearTimeout(P),P=window.setTimeout(T,500),R()},handleScrollend:T,handleItemResize:function(e,t){const a=y[e],l=n.value
n.value=l?Math.min(n.value,t):t,a===t&&l===n.value||(y[e]=t,k())}}}const Ki=vt({items:{type:Array,default:()=>[]},renderless:Boolean,...Ui(),...pt(),...ol()},"VVirtualScroll"),qi=wt()({name:"VVirtualScroll",props:Ki(),setup(e,a){let{slots:l}=a
...
return e.multiple?a:a[0]??null}),p=t.computed(()=>"function"==typeof e.counterValue?e.counterValue(v.value):"number"==typeof e.counterValue?e.counterValue:v.value.length),m=mo(e),f=t.computed(()=>v.value.map(e=>e.value)),g=t.shallowRef(!1)
let h,y="",b=-1
const V=t.computed(()=>e.hideSelected?u.value.filter(t=>!v.value.some(a=>(e.valueComparator||kt)(a,t))):u.value),w=t.computed(()=>e.hideNoData&&!V.value.length||m.isReadonly.value||m.isDisabled.value),S=la(e,"menu"),k=t.computed({get:()=>S.value,set:e=>{S.value&&!e&&i.value?.ΨopenChildren.size||e&&w.value||(S.value=e)}}),{menuId:x,ariaExpanded:N,ariaControls:C,ariaLabel:E}=Qi(e,k),I=t.computed(()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}})),_=t.ref(),P=Xi(_,r)
function T(t){e.openOnClear&&(k.value=!0)}function A(){w.value||(k.value=!k.value)}function R(e){ue(e)&&D(e)}function D(t){if(!t.key||m.isReadonly.value)return;["Enter"," ","ArrowDown","ArrowUp","Home","End"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"," "].includes(t.key)&&(k.value=!0),["Escape","Tab"].includes(t.key)&&(k.value=!1),"Home"===t.key?_.value?.focus("first"):"End"===t.key&&_.value?.focus("last")
if(!ue(t))return
const a=performance.now()
a-h>1e3&&(y="",b=-1),y+=t.key.toLowerCase(),h=a
const l=V.value
function n(){for(let e=b+1;e<l.length;e++){const t=l[e]
if(t.title.toLowerCase().startsWith(y))return[t,e]}}const o=function(){let e=n()
return e||(y.at(-1)===y.at(-2)&&(y=y.slice(0,-1),e=n(),e)?e:(b=-1,e=n(),e||(y=t.key.toLowerCase(),n())))}()
if(!o)return
const[r,i]=o
b=i,_.value?.focus(i),e.multiple||(v.value=[r])}function F(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
if(!a.props.disabled)if(e.multiple){const t=v.value.findIndex(t=>(e.valueComparator||kt)(t.value,a.value)),n=null==l?!~t:l
if(~t){const e=n?[...v.value,a]:[...v.value]
e.splice(t,1),v.value=e}else n&&(v.value=[...v.value,a])}else{const e=!1!==l
v.value=e?[a]:[],t.nextTick(()=>{k.value=!1})}}function $(e){_.value?.$el.contains(e.relatedTarget)||(k.value=!1)}function M(){e.eager&&s.value?.calculateVisibleItems()}function z(){g.value&&r.value?.focus()}function L(e){g.value=!0}function O(e){if(null==e)v.value=[]
else if(oe(r.value,":autofill")||oe(r.value,":-webkit-autofill")){const t=u.value.find(t=>t.title===e)
t&&F(t)}else r.value&&(r.value.value="")}return t.watch(k,()=>{if(!e.hideSelected&&k.value&&v.value.length){const t=V.value.findIndex(t=>v.value.some(a=>(e.valueComparator||kt)(a.value,t.value)))
o&&!e.noAutoScroll&&window.requestAnimationFrame(()=>{t>=0&&s.value?.scrollToIndex(t)})}}),t.watch(u,(t,a)=>{k.value||g.value&&e.hideNoData&&!a.length&&t.length&&(k.value=!0)}),Bt(()=>{const a=!(!e.chips&&!l.chip),o=!!(!e.hideNoData||V.value.length||l["prepend-item"]||l["append-item"]||l["no-data"]),u=v.value.length>0,c=Wi.filterProps(e),d=u||!g.value&&e.label&&!e.persistentPlaceholder?void 0:e.placeholder
return t.createVNode(Wi,t.mergeProps({ref:r},c,{modelValue:v.value.map(e=>e.props.value).join(", "),"onUpdate:modelValue":O,focused:g.value,"onUpdate:focused":e=>g.value=e,validationValue:v.externalValue,counterValue:p.value,dirty:u,class:["v-select",{"v-select--active-menu":k.value,"v-select--chips":!!e.chips,["v-select--"+(e.multiple?"multiple":"single")]:!0,"v-select--selected":v.value.length,"v-select--selection-slot":!!l.selection},e.class],style:e.style,inputmode:"none",placeholder:d,"onClick:clear":T,"onMousedown:control":A,onBlur:$,onKeydown:D,"aria-expanded":N.value,"aria-controls":C.value,"aria-label":E.value,title:E.value}),{...l,default:()=>t.createElementVNode(t.Fragment,null,[t.createVNode(Pi,t.mergeProps({id:x.value,ref:i,modelValue:k.value,"onUpdate:modelValue":e=>k.value=e,activator:"parent",contentClass:"v-select__content",disabled:w.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:M,onAfterLeave:z},I.value),{default:()=>[o&&t.createVNode(zr,t.mergeProps({ref:_,selected:f.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:R,onFocusin:L,tabindex:"-1",selectable:!0,"aria-live":"polite","aria-label":`${e.label}-list`,color:e.itemColor??e.color},P,e.listProps),{default:()=>[l["prepend-item"]?.(),!V.value.length&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(xr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(qi,{ref:s,renderless:!0,items:V.value,itemKey:"value"},{default:a=>{let{item:n,index:o,itemRef:r}=a
const i=function(e){const a={}
for(const l in e)a[t.camelize(l)]=e[l]
return a}(n.props),s=t.mergeProps(n.props,{ref:r,key:n.value,onClick:()=>F(n,null)})
...
return t.createElementVNode(t.Fragment,null,[l["append-inner"]?.(...n),e.menuIcon?t.createVNode(Jl,{class:"v-select__menu-icon",color:r.value?.fieldIconColor,icon:e.menuIcon},null):void 0])}})}),So({isFocused:g,menu:k,select:F},r)}}),as=(e,t,a)=>{if(null==e||null==t)return-1
...
return e.multiple?a:a[0]??null}),w=t.computed(()=>"function"==typeof e.counterValue?e.counterValue(V.value):"number"==typeof e.counterValue?e.counterValue:V.value.length),S=mo(e),{filteredItems:k,getMatches:x}=os(e,m,()=>p.value??(s.value?"":b.value)),N=t.computed(()=>e.hideSelected&&null===p.value?k.value.filter(e=>!V.value.some(t=>t.value===e.value)):k.value),C=t.computed(()=>!(!e.chips&&!l.chip)),E=t.computed(()=>C.value||!!l.selection),I=t.computed(()=>V.value.map(e=>e.props.value)),_=t.computed(()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&b.value===N.value[0]?.title)&&N.value.length>0&&!s.value&&!u.value),P=t.computed(()=>e.hideNoData&&!N.value.length||S.isReadonly.value||S.isDisabled.value),T=la(e,"menu"),A=t.computed({get:()=>T.value,set:e=>{T.value&&!e&&c.value?.ΨopenChildren.size||e&&P.value||(T.value=e)}}),{menuId:R,ariaExpanded:D,ariaControls:F,ariaLabel:$}=Qi(e,A),M=t.ref(),z=Xi(M,r)
function L(t){e.openOnClear&&(A.value=!0),b.value=""}function O(){P.value||(A.value=!0)}function j(e){P.value||(i.value&&(e.preventDefault(),e.stopPropagation()),A.value=!A.value)}function W(e){(ue(e)||"Backspace"===e.key)&&r.value?.focus()}function H(t){if(S.isReadonly.value)return
...
if(a&&!a.props.disabled)if(e.multiple){const t=V.value.findIndex(t=>(e.valueComparator||kt)(t.value,a.value)),n=null==l?!~t:l
if(~t){const e=n?[...V.value,a]:[...V.value]
e.splice(t,1),V.value=e}else n&&(V.value=[...V.value,a])
e.clearOnSelect&&(b.value="")}else{const e=!1!==l
V.value=e?[a]:[],p.value=s.value?"":b.value??"",b.value=e&&!E.value?a.title:"",t.nextTick(()=>{A.value=!1,s.value=!0})}}return t.watch(i,(a,l)=>{a!==l&&(a?(Z.value=!0,b.value=e.multiple||E.value?"":String(V.value.at(-1)?.props.title??""),s.value=!0,t.nextTick(()=>Z.value=!1)):(e.multiple||null!=b.value||(V.value=[]),A.value=!1,!s.value&&b.value&&(p.value=b.value),b.value="",v.value=-1))}),t.watch(b,e=>{i.value&&!Z.value&&(e&&(A.value=!0),s.value=!e)}),t.watch(A,t=>{if(!e.hideSelected&&t&&V.value.length&&s.value){const e=N.value.findIndex(e=>V.value.some(t=>e.value===t.value))
o&&window.requestAnimationFrame(()=>{e>=0&&d.value?.scrollToIndex(e)})}t&&(p.value=null)}),t.watch(m,(e,t)=>{A.value||i.value&&!t.length&&e.length&&(A.value=!0)}),Bt(()=>{const a=!!(!e.hideNoData||N.value.length||l["prepend-item"]||l["append-item"]||l["no-data"]),o=V.value.length>0,u=Wi.filterProps(e)
return t.createVNode(Wi,t.mergeProps({ref:r},u,{modelValue:b.value,"onUpdate:modelValue":[e=>b.value=e,X],focused:i.value,"onUpdate:focused":e=>i.value=e,validationValue:V.externalValue,counterValue:w.value,dirty:o,onChange:Y,class:["v-autocomplete","v-autocomplete--"+(e.multiple?"multiple":"single"),{"v-autocomplete--active-menu":A.value,"v-autocomplete--chips":!!e.chips,"v-autocomplete--selection-slot":!!E.value,"v-autocomplete--selecting-index":v.value>-1},e.class],style:e.style,readonly:S.isReadonly.value,placeholder:o?void 0:e.placeholder,"onClick:clear":L,"onMousedown:control":O,onKeydown:H,"aria-expanded":D.value,"aria-controls":F.value}),{...l,default:()=>t.createElementVNode(t.Fragment,null,[t.createVNode(Pi,t.mergeProps({id:R.value,ref:c,modelValue:A.value,"onUpdate:modelValue":e=>A.value=e,activator:"parent",contentClass:"v-autocomplete__content",disabled:P.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,onAfterEnter:U,onAfterLeave:G},e.menuProps),{default:()=>[a&&t.createVNode(zr,t.mergeProps({ref:M,filterable:!0,selected:I.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:W,onFocusin:K,onFocusout:q,tabindex:"-1",selectable:!0,"aria-live":"polite",color:e.itemColor??e.color},z,e.listProps),{default:()=>[l["prepend-item"]?.(),!N.value.length&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(xr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(qi,{ref:d,renderless:!0,items:N.value,itemKey:"value"},{default:a=>{let{item:n,index:o,itemRef:r}=a
...
return t.createElementVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(oo,{key:n.value,modelValue:l,ripple:!1,tabindex:"-1",onClick:e=>e.preventDefault()},null):void 0,n.props.prependAvatar&&t.createVNode(qn,{image:n.props.prependAvatar},null),n.props.prependIcon&&t.createVNode(Jl,{icon:n.props.prependIcon},null)])},title:()=>s.value?n.title:rs("v-autocomplete",n.title,x(n)?.title)})}}),l["append-item"]?.()]})]}),V.value.map((a,n)=>{function o(e){e.stopPropagation(),e.preventDefault(),Q(a,!1)}const r={"onClick:close":o,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),o(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=C.value?!!l.chip:!!l.selection,s=i?re(C.value?l.chip({item:a,index:n,props:r}):l.selection({item:a,index:n})):void 0
...
return t.createVNode(nl,{root:"VDialog"},{default:()=>[n.default?.(...a)]})}})}),So({},i)}}),Vs=vt({inset:Boolean,...ys({transition:"bottom-sheet-transition"})},"VBottomSheet"),ws=wt()({name:"VBottomSheet",props:Vs(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const n=la(e,"modelValue")
return Bt(()=>{const a=bs.filterProps(e)
return t.createVNode(bs,t.mergeProps(a,{contentClass:["v-bottom-sheet__content",e.contentClass],modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,class:["v-bottom-sheet",{"v-bottom-sheet--inset":e.inset},e.class],style:e.style}),l)}),{}}}),Ss=vt({divider:[Number,String],...pt()},"VBreadcrumbsDivider"),ks=wt()({name:"VBreadcrumbsDivider",props:Ss(),setup(e,a){let{slots:l}=a
...
return t.createElementVNode(t.Fragment,null,[l.item?.({item:r,index:n})??t.createVNode(Ns,t.mergeProps({key:n,disabled:n>=o.length-1},"string"==typeof r?{title:r}:r,e.itemProps&&V(i)?i:{}),{default:l.title?()=>l.title?.({item:r,index:n}):void 0}),n<o.length-1&&t.createVNode(ks,null,{default:l.divider?()=>l.divider?.({item:i,index:n}):void 0})])}),l.default?.()]})}),{}}}),Is=vt({active:{type:Boolean,default:void 0},activeColor:String,activeIcon:[String,Function,Object],activeVariant:String,baseVariant:{type:String,default:"tonal"},disabled:Boolean,height:[Number,String],width:[Number,String],hideOverlay:Boolean,icon:[String,Function,Object],iconColor:String,loading:Boolean,opacity:[Number,String],readonly:Boolean,rotate:[Number,String],size:{type:[Number,String],default:"default"},sizes:{type:Array,default:()=>[["x-small",16],["small",24],["default",40],["large",48],["x-large",56]]},text:{type:[String,Number,Boolean],default:void 0},...wl(),...pt(),...kl(),...Wn(),...pl(),...Pa({tag:"button"}),...ya(),...$l({variant:"flat"})},"VIconBtn"),_s=wt()({name:"VIconBtn",props:Is(),emits:{"update:active":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
const o=la(e,"active"),{themeClasses:r}=Ca(e),{borderClasses:i}=Sl(e),{elevationClasses:s}=xl(e),{roundedClasses:u}=ml(e),{colorClasses:c,colorStyles:d,variantClasses:v}=Ml(()=>({color:(()=>{if(!e.disabled)return o.value?e.activeColor??e.color??"surface-variant":e.color})(),variant:void 0===o.value?e.variant:o.value?e.activeVariant??e.variant:e.baseVariant??e.variant})),p=new Map(e.sizes)
...
function Ps(e,t,a){const l=7+t-a,n=(7+function(e){let t,a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,l=arguments.length>2&&void 0!==arguments[2]?arguments[2]:1
return e<100&&e>=0?(t=new Date(Date.UTC(e,a,l)),isFinite(t.getUTCFullYear())&&t.setUTCFullYear(e)):t=new Date(Date.UTC(e,a,l)),t}(e,0,l).getUTCDay()-t)%7
return-n+l-1}function Ts(e,t,a){const l=Ps(e,t,a),n=Ps(e+1,t,a)
return((Rs(e)?366:365)-l+n)/7}function As(e,t,a,l,n){const o=Ps(e,l,n),r=Math.ceil((function(e,t,a){let l=[0,31,59,90,120,151,181,212,243,273,304,334][t]
return t>1&&Rs(e)&&l++,l+a}(e,t,a)-o)/7)
return r<1?r+Ts(e-1,l,n):r>Ts(e,l,n)?r-Ts(e,l,n):r}function Rs(e){return e%4==0&&e%100!=0||e%400==0}const Bs=/^(\d{4})-(\d{1,2})(-(\d{1,2}))?([^\d]+(\d{1,2}))?(:(\d{1,2}))?(:(\d{1,2}))?$/,Ds=/(\d\d?)(:(\d\d?)|)(:(\d\d?)|)/,Fs=[0,31,28,31,30,31,30,31,31,30,31,30,31],$s=[0,31,29,31,30,31,30,31,31,30,31,30,31]
function Ms(e){const t=tu(e)
return t.day=1,Qs(t),Js(t),t}function zs(e){const t=tu(e)
return t.day=eu(t.year,t.month),Qs(t),Js(t),t}function Ls(e){return isFinite(parseInt(e))}function Os(e){if("number"==typeof e)return e
if("string"==typeof e){const t=Ds.exec(e)
return!!t&&60*parseInt(t[1])+parseInt(t[3]||0)}return"object"==typeof e&&("number"==typeof e.hour&&"number"==typeof e.minute&&60*e.hour+e.minute)}function js(e){return"number"==typeof e&&isFinite(e)||"string"==typeof e&&!!Bs.exec(e)||e instanceof Date}function Ws(e){let t=arguments.length>1&&void 0!==arguments[1]&&arguments[1],a=arguments.length>2?arguments[2]:void 0
if("number"==typeof e&&isFinite(e)&&(e=new Date(e)),e instanceof Date){const t=Hs(e)
return a&&Ks(t,a,t.hasTime),t}if("string"!=typeof e){if(t)throw new Error(`${e} is not a valid timestamp. It must be a Date, number of milliseconds since Epoch, or a string in the format of YYYY-MM-DD or YYYY-MM-DD hh:mm. Zero-padding is optional and seconds are ignored.`)
return null}const l=Bs.exec(e)
...
return Qs(n),Js(n),a&&Ks(n,a,n.hasTime),n}function Hs(e){return Js({date:"",time:"",year:e.getFullYear(),month:e.getMonth()+1,day:e.getDate(),weekday:e.getDay(),hour:e.getHours(),minute:e.getMinutes(),hasDay:!0,hasTime:!0,past:!1,present:!0,future:!1})}function Ys(e){return 1e4*e.year+100*e.month+e.day}function Us(e){return 100*e.hour+e.minute}function Gs(e){return 1e4*Ys(e)+Us(e)}function Ks(e,t){let a=arguments.length>2&&void 0!==arguments[2]&&arguments[2],l=Ys(t),n=Ys(e),o=l===n
return e.hasTime&&a&&o&&(l=Us(t),n=Us(e),o=l===n),e.past=n<l,e.present=o,e.future=n>l,e}function qs(e){return e instanceof Date||"number"==typeof e&&isFinite(e)}function Xs(e,t,a){return e.hasTime!==t&&(e.hasTime=t,t||(e.hour=23,e.minute=59,e.time=lu(e))),e}function Zs(e,t,a){return e.hasTime=!0,e.hour=Math.floor(t/60),e.minute=t%60,e.time=lu(e),a&&Ks(e,a,!0),e}function Qs(e){return e.weekday=function(e){if(e.hasDay){const t=Math.floor,a=e.day,l=(e.month+9)%12+1,n=t(e.year/100),o=e.year%100-(e.month<=2?1:0)
return((a+t(2.6*l-.2)-2*n+o+t(o/4)+t(n/4))%7+7)%7}return e.weekday}(e),e}function Js(e){return e.time=lu(e),e.date=function(e){let t=`${au(e.year,4)}-${au(e.month,2)}`
e.hasDay&&(t+=`-${au(e.day,2)}`)
return t}(e),e}function eu(e,t){return Rs(e)?$s[t]:Fs[t]}function tu(e){if(null==e)return null
const{date:t,time:a,year:l,month:n,day:o,weekday:r,hour:i,minute:s,hasDay:u,hasTime:c,past:d,present:v,future:p}=e
return{date:t,time:a,year:l,month:n,day:o,weekday:r,hour:i,minute:s,hasDay:u,hasTime:c,past:d,present:v,future:p}}function au(e,t){let a=String(e)
for(;a.length<t;)a="0"+a
return a}function lu(e){return e.hasTime?`${au(e.hour,2)}:${au(e.minute,2)}`:""}function nu(e){return e.day++,e.weekday=(e.weekday+1)%7,e.day>28&&e.day>eu(e.year,e.month)&&(e.day=1,e.month++,e.month>12&&(e.month=1,e.year++)),e}function ou(e){return e.day--,e.weekday=(e.weekday+6)%7,e.day<1&&(e.month--,e.month<1&&(e.year--,e.month=12),e.day=eu(e.year,e.month)),e}function ru(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:nu,a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:1
for(;--a>=0;)t(e)
return e}function iu(e,t){let a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:nu,l=arguments.length>3&&void 0!==arguments[3]?arguments[3]:6
for(;e.weekday!==t&&--l>=0;)a(e)
return e}function su(e){const t=`${au(e.hour,2)}:${au(e.minute,2)}`,a=e.date
return new Date(`${a}T${t}:00+00:00`)}function uu(e,t,a,l){let n=arguments.length>4&&void 0!==arguments[4]?arguments[4]:42,o=arguments.length>5&&void 0!==arguments[5]?arguments[5]:0
const r=Ys(t),i=[]
let s=tu(e),u=0,c=u===r
if(r<Ys(e))throw new Error("End date is earlier than start date.")
for(;(!c||i.length<o)&&i.length<n;){if(u=Ys(s),c=c||u===r,0===l[s.weekday]){s=nu(s)
continue}const e=tu(s)
Js(e),Ks(e,a),i.push(e),s=ru(s,nu,l[s.weekday])}if(!i.length)throw new Error("No dates found using specified start date, end date, and weekdays.")
return i}function cu(e,t){const a=(e,t)=>""
return"undefined"==typeof Intl||void 0===Intl.DateTimeFormat?a:(a,l)=>{try{return new Intl.DateTimeFormat(e||void 0,t(a,l)).format(su(a))}catch(e){return""}}}const du=vt({start:{type:[String,Number,Date],validate:js,default:()=>Hs(new Date).date},end:{type:[String,Number,Date],validate:js},weekdays:{type:[Array,String],default:()=>[0,1,2,3,4,5,6],validate:function(e){if("string"==typeof e&&(e=e.split(",")),Array.isArray(e)){const t=e.map(e=>parseInt(e))
...
a[n]=!0}return!0}return!1}},weekdayFormat:{type:Function,default:null},dayFormat:{type:Function,default:null},locale:String,now:{type:String,validator:js},type:{type:String,default:"month"}},"VCalendar-base")
function vu(e){const{times:a}=function(e){const a=t.reactive({now:Ws("0000-00-00 00:00",!0),today:Ws("0000-00-00",!0)}),l=t.computed(()=>e.now&&js(e.now)?Ws(e.now,!0):null)
function n(){a.now.present=a.today.present=!0,a.now.past=a.today.past=!1,a.now.future=a.today.future=!1}function o(){return Hs(new Date)}function r(e,t){e.date!==t.date&&(t.year=e.year,t.month=e.month,t.day=e.day,t.weekday=e.weekday,t.date=e.date)}function i(e,t){e.time!==t.time&&(t.hour=e.hour,t.minute=e.minute,t.time=e.time)}function s(){const e=l.value||o()
r(e,a.now),i(e,a.now),r(e,a.today)}return t.watch(l,s),s(),n(),{times:a,parsedNow:l,updateTimes:s,setPresent:n,getNow:o,updateDay:r,updateTime:i}}({now:e.now}),l=fa(e),n=t.computed(()=>"month"===e.type?Ms(Ws(e.start,!0)):Ws(e.start,!0)),o=t.computed(()=>{const t=n.value,a=e.end&&Ws(e.end)||t,l=Gs(a)<Gs(t)?t:a
return"month"===e.type?zs(l):l}),r=t.computed(()=>js(e.modelValue)?Ws(e.modelValue,!0):n.value||a.today),i=t.computed(()=>Array.isArray(e.weekdays)?e.weekdays:(e.weekdays||"").split(",").map(e=>parseInt(e,10))),s=t.computed(()=>{const t=r.value,a=parseInt(String(e.categoryDays))||1
...
default:return i.value}}),u=t.computed(()=>function(e){const t=[1,1,1,1,1,1,1],a=[0,0,0,0,0,0,0]
for(let t=0;t<e.length;t++)a[e[t]]=1
for(let e=0;e<7;e++){let l=1
for(let t=1;t<7&&!a[(e+t)%7];t++)l++
t[e]=a[e]*l}return t}(i.value)),c=t.computed(()=>uu(n.value,o.value,a.today,u.value)),d=t.computed(()=>e.dayFormat?e.dayFormat:cu(l.current.value,()=>({timeZone:"UTC",day:"numeric"}))),v=t.computed(()=>e.weekdayFormat?e.weekdayFormat:cu(l.current.value,(e,t)=>({timeZone:"UTC",weekday:t?"short":"long"})))
return{times:a,locale:l,parsedValue:r,parsedWeekdays:i,effectiveWeekdays:s,weekdaySkips:u,parsedStart:n,parsedEnd:o,days:c,dayFormatter:d,weekdayFormatter:v,getColorProps:function(e){return vl(e)},getRelativeClasses:function(e){let t=arguments.length>1&&void 0!==arguments[1]&&arguments[1]
return{"v-present":e.present,"v-past":e.past,"v-future":e.future,"v-outside":t}},getStartOfWeek:function(e){return function(e,t,a){const l=tu(e)
return iu(l,t[0],ou),Js(l),a&&Ks(l,a,l.hasTime),l}(e,i.value,a.today)},getEndOfWeek:function(e){return function(e,t,a){const l=tu(e)
return iu(l,t[t.length-1]),Js(l),a&&Ks(l,a,l.hasTime),l}(e,i.value,a.today)},getFormatter:function(e){return cu(l.current.value,()=>e)}}}const pu=vt({maxDays:{type:Number,default:7},intervalHeight:{type:[Number,String],default:48,validate:Ls},intervalWidth:{type:[Number,String],default:60,validate:Ls},intervalMinutes:{type:[Number,String],default:60,validate:Ls},firstInterval:{type:[Number,String],default:0,validate:Ls},firstTime:{type:[Number,String,Object],validate:function(e){return"number"==typeof e&&isFinite(e)||!!Ds.exec(e)||"object"==typeof e&&isFinite(e.hour)&&isFinite(e.minute)}},intervalCount:{type:[Number,String],default:24,validate:Ls},intervalFormat:{type:Function,default:null},intervalStyle:{type:Function,default:null},showIntervalLabel:{type:Function,default:null}},"VCalendar-intervals")
function mu(e){const a=vu(e),l=t.shallowRef(),n=t.computed(()=>parseInt(String(e.firstInterval||0))),o=t.computed(()=>parseInt(String(e.intervalMinutes||60))),r=t.computed(()=>parseInt(String(e.intervalCount||24))),i=t.computed(()=>parseFloat(String(e.intervalHeight||48))),s=t.computed(()=>Os(e.firstTime)),u=t.computed(()=>{const e=s.value
return!1!==e&&e>=0&&e<=1440?e:n.value*o.value}),c=t.computed(()=>r.value*i.value),d=t.computed(()=>uu(a.parsedStart.value,a.parsedEnd.value,a.times.today,a.weekdaySkips.value,e.maxDays)),v=t.computed(()=>{const e=d.value,t=u.value,l=o.value,n=r.value,i=a.times.now
return e.map(e=>function(e,t,a,l,n){const o=[]
for(let r=0;r<l;r++){const l=t+r*a,i=tu(e)
o.push(Zs(i,l,n))}return o}(e,t,l,n,i))}),p=t.computed(()=>e.intervalFormat?e.intervalFormat:cu(a.locale.current.value,(e,t)=>t?0===e.minute?{timeZone:"UTC",hour:"numeric"}:{timeZone:"UTC",hour:"numeric",minute:"2-digit"}:{timeZone:"UTC",hour:"2-digit",minute:"2-digit"}))
function m(e){return e/o.value*i.value}function f(e){let t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],a=g(e)
return!1!==a&&(a*=c.value,t&&(a<0&&(a=0),a>c.value&&(a=c.value))),a}function g(e){const t=Os(e)
if(!1===t)return!1
return(t-u.value)/(r.value*o.value)}return{...a,scrollAreaRef:l,parsedFirstInterval:n,parsedIntervalMinutes:o,parsedIntervalCount:r,parsedIntervalHeight:i,parsedFirstTime:s,firstMinute:u,bodyHeight:c,days:d,intervals:v,intervalFormatter:p,showIntervalLabelDefault:function(e){const t=v.value[0][0]
return!(t.hour===e.hour&&t.minute===e.minute)},intervalStyleDefault:function(e){},getTimestampAtEvent:function(e,t){const l=tu(t),n=e.currentTarget.getBoundingClientRect(),r=u.value,s=e,c=e,d=s.changedTouches||s.touches,v=((d&&d[0]?d[0].clientY:c.clientY)-n.top)/i.value
return Zs(l,r+Math.floor(v*o.value),a.times.now)},getSlotScope:function(e){const t=tu(e)
return t.timeToY=f,t.timeDelta=g,t.minutesToPixels=m,t.week=d.value,t},scrollToTime:function(e){const t=f(e),a=l.value
return!(!1===t||!a)&&(a.scrollTop=t,!0)},minutesToPixels:m,timeToY:f,timeDelta:g}}const fu={mounted:function(e,t){const a=t.value,l={passive:!t.modifiers?.active}
window.addEventListener("resize",a,l),e._onResize=Object(e._onResize),e._onResize[t.instance.$.uid]={handler:a,options:l},t.modifiers?.quiet||a()},unmounted:function(e,t){if(!e._onResize?.[t.instance.$.uid])return
const{handler:a,options:l}=e._onResize[t.instance.$.uid]
window.removeEventListener("resize",a,l),delete e._onResize[t.instance.$.uid]}},gu=Vt({name:"VCalendarDaily",directives:{vResize:fu},props:{color:String,shortWeekdays:{type:Boolean,default:!0},shortIntervals:{type:Boolean,default:!0},hideHeader:Boolean,...du(),...pu()},setup(e,a){let{slots:l,attrs:n}=a
const o=t.ref(0),r=t.ref(),i=mu(e)
...
return t.createElementVNode("div",t.mergeProps({class:"v-calendar-daily__intervals-body",style:{width:a}},l),[S()])}function S(){return i.intervals.value.length?i.intervals.value[0].map(k):null}function k(a){const l=b(e.intervalHeight),n=e.shortIntervals,o=(e.showIntervalLabel||i.showIntervalLabelDefault)(a)?i.intervalFormatter.value(a,n):void 0
...
return t.createElementVNode("div",t.mergeProps({key:e.date,class:["v-calendar-daily__day",i.getRelativeClasses(e)]},l),[y(a),h(e)])})])])])])]),[[fu,u,void 0,{quiet:!0}]])),{...i,scrollPush:o,pane:r,init:s,onResize:u,getScrollPush:c}}})
...
return{...e,categoryName:a}}):[]}const yu=Vt({name:"VCalendarCategory",props:{categories:{type:[Array,String],default:""},categoryText:[String,Function],categoryForInvalid:{type:String,default:""},...du(),...pu()},setup(e,a){let{slots:l,attrs:n}=a
const o=mu(e),r=t.computed(()=>hu(e.categories,e.categoryText))
...
return t.createElementVNode("div",t.mergeProps({class:"v-calendar-category__column"},r),[l["day-body"]?.(i(o.getSlotScope(e),a))])}return Bt(()=>t.createVNode(gu,t.mergeProps({class:["v-calendar-daily","v-calendar-category"]},e),{...l,days:c,"day-header":s})),{...o,parsedCategories:r}}})
...
default:return null}}function Vu(e,t,l){let n=(l??bu(t)?.firstDay??0)%7;[0,1,2,3,4,5,6].includes(n)||(a("Invalid firstDayOfWeek, expected discrete number in range [0-6]"),n=0)
const o=new Date(e)
...
function Cu(e,t,a,l){const n=xu(e)??new Date,o=l?.[t]
...
default:r=o??{timeZone:"UTC",timeZoneName:"short"}}return new Intl.DateTimeFormat(a,r).format(n)}function Eu(e,t){const a=new Date(e)
return a.setDate(a.getDate()+t),a}function Iu(e){return e.getFullYear()}function _u(e,t,a,l){const n=bu(t),o=a??n?.firstDay??0,r=n?.firstWeekSize??1
return void 0!==l?function(e,t,a,l){const n=(7+l-a)%7,o=Vu(e,t,a),r=Eu(o,6)
function i(e){return(7+new Date(e,0,1).getDay()-a)%7}let s=Iu(e)
s<Iu(r)&&i(s+1)<=n&&s++
const u=new Date(s,0,1),c=i(s),d=Eu(u,c<=n?-c:7-c)
return 1+Au(Bu(e),Ru(d),"weeks")}(e,t,o,l):function(e,t,a,l){const n=Eu(Vu(e,t,a),6)
function o(e){const l=new Date(e,0,1)
return 7-Au(l,Vu(l,t,a),"days")}let r=Iu(e)
r<Iu(n)&&o(r+1)>=l&&r++
const i=new Date(r,0,1),s=o(r),u=Eu(i,s>=l?s-7:s)
return 1+Au(Bu(e),Ru(u),"weeks")}(e,t,o,r)}function Pu(e,t){return e.getTime()>t.getTime()}function Tu(e,t){return e.getTime()===t.getTime()}function Au(e,t,a){const l=new Date(e),n=new Date(t)
...
default:return l.getTime()-n.getTime()}}function Ru(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0,0)}function Bu(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate(),23,59,59,999)}class Du{constructor(e){this.locale=e.locale,this.formats=e.formats}date(e){return xu(e)}toJsDate(e){return e}toISO(e){return function(e,t){const a=e.toJsDate(t)
...
let n=[]
const o=wu(e),r=Su(e),i=a??bu(t)?.firstDay??0,s=(o.getDay()-i+7)%7,u=(r.getDay()-i+7)%7
...
return a}(e,this.locale)}startOfMonth(e){return wu(e)}endOfMonth(e){return Su(e)}format(e,t){return Cu(e,t,this.locale,this.formats)}isEqual(e,t){return Tu(e,t)}isValid(e){return function(e){const t=new Date(e)
return t instanceof Date&&!isNaN(t.getTime())}(e)}isWithinRange(e,t){return function(e,t){return Pu(e,t[0])&&function(e,t){return e.getTime()<t.getTime()}(e,t[1])}(e,t)}isAfter(e,t){return Pu(e,t)}isAfterDay(e,t){return function(e,t){return Pu(Ru(e),Ru(t))}(e,t)}isBefore(e,t){return!Pu(e,t)&&!Tu(e,t)}isSameDay(e,t){return function(e,t){return e.getDate()===t.getDate()&&e.getMonth()===t.getMonth()&&e.getFullYear()===t.getFullYear()}(e,t)}isSameMonth(e,t){return function(e,t){return e.getMonth()===t.getMonth()&&e.getFullYear()===t.getFullYear()}(e,t)}isSameYear(e,t){return function(e,t){return e.getFullYear()===t.getFullYear()}(e,t)}setMinutes(e,t){return function(e,t){const a=new Date(e)
...
return y(7).map(t=>{const n=new Date(Nu)
return n.setDate(Nu.getDate()+l+t),new Intl.DateTimeFormat(e,{weekday:a??"narrow"}).format(n)})}(this.locale,a,t)}getYear(e){return Iu(e)}getMonth(e){return function(e){return e.getMonth()}(e)}getWeek(e,t,a){const l=void 0!==t?Number(t):void 0,n=void 0!==a?Number(a):void 0
return _u(e,this.locale,l,n)}getDate(e){return function(e){return e.getDate()}(e)}getNextMonth(e){return function(e){return new Date(e.getFullYear(),e.getMonth()+1,1)}(e)}getPreviousMonth(e){return function(e){return new Date(e.getFullYear(),e.getMonth()-1,1)}(e)}getHours(e){return function(e){return e.getHours()}(e)}getMinutes(e){return function(e){return e.getMinutes()}(e)}startOfDay(e){return Ru(e)}endOfDay(e){return Bu(e)}startOfYear(e){return function(e){return new Date(e.getFullYear(),0,1)}(e)}endOfYear(e){return function(e){return new Date(e.getFullYear(),11,31)}(e)}}const Fu=Symbol.for("vuetify:date-options"),$u=Symbol.for("vuetify:date-adapter")
function Mu(e,t,a){const l=[`${e.toISO(a??t).split("T")[0]}T00:00:00Z`,`${e.toISO(t).split("T")[0]}T00:00:00Z`]
return"string"==typeof e.date()?e.getDiff(l[0],l[1],"days"):e.getDiff(e.date(l[0]),e.date(l[1]),"days")}function zu(e,a){const l=t.reactive("function"==typeof e.adapter?new e.adapter({locale:e.locale[a.current.value]??a.current.value,formats:e.formats}):e.adapter)
return t.watch(a.current,t=>{l.locale=e.locale[t]??t??l.locale}),l}function Lu(){const e=t.inject(Fu)
if(!e)throw new Error("[Vuetify] Could not find injected date options")
return zu(e,ma())}const Ou={control:"ctrl",command:"cmd",option:"alt",up:"arrowup",down:"arrowdown",left:"arrowleft",right:"arrowright",esc:"escape",spacebar:" ",space:" ",return:"enter",del:"delete",minus:"-",hyphen:"-"}
function ju(e){const t=e.toLowerCase()
return Ou[t]||t}function Wu(e){let t=arguments.length>1&&void 0!==arguments[1]&&arguments[1]
...
const n=[],o=[]
let r=""
const i=e=>{r&&(e&&o.push(e),n.push(ju(r)),r="")}
for(let t=0;t<e.length;t++){const a=e[t],l=e[t+1];["+","/","_","-"].includes(a)?a===l?(i(a),n.push(a),t++):["+","/","_"].includes(a)?i(a):r+=a:r+=a}i()
return n.some(e=>e.length>1&&e.includes("-")&&"--"!==e)?(t||a(`Invalid hotkey combination: "${e}" has invalid structure`),l):0===n.length&&e?{keys:[ju(e)],separators:o}:{keys:n,separators:o}}const Hu={"credit-card":"#### - #### - #### - ####",date:"##/##/####","date-time":"##/##/#### ##:##","iso-date":"####-##-##","iso-date-time":"####-##-## ##:##",phone:"(###) ### - ####",social:"###-##-####",time:"##:##","time-with-seconds":"##:##:##"},Yu={"#":{pattern:/[0-9]/},A:{pattern:/[A-Z]/i,convert:e=>e.toUpperCase()},a:{pattern:/[a-z]/i,convert:e=>e.toLowerCase()},N:{pattern:/[0-9A-Z]/i,convert:e=>e.toUpperCase()},n:{pattern:/[0-9a-z]/i,convert:e=>e.toLowerCase()},X:{pattern:/[-!$%^&*()_+|~=`{}[\]:";'<>?,./\\ ]/}}
const Uu=Vt({name:"VCalendarWeekly",props:{minWeeks:{validate:Ls,default:1},monthFormat:Function,showWeek:Boolean,color:String,shortWeekdays:{type:Boolean,default:!0},localeFirstDayOfYear:{type:[String,Number],default:0},showMonthOnFirst:{type:Boolean,default:!0},shortMonths:{type:Boolean,default:!0},hideHeader:Boolean,...du()},setup(e,a){let{slots:l,attrs:n}=a
const o=vu(e),r=Ea(),i=t.computed(()=>parseInt(String(e.minWeeks))),s=t.computed(()=>{const e=i.value*o.parsedWeekdays.value.length
return uu(o.getStartOfWeek(o.parsedStart.value),o.getEndOfWeek(o.parsedEnd.value),o.times.today,o.weekdaySkips.value,Number.MAX_SAFE_INTEGER,e)}),u=t.computed(()=>{const e=o.times.today
return uu(o.getStartOfWeek(e),o.getEndOfWeek(e),e,o.weekdaySkips.value,o.parsedWeekdays.value.length,o.parsedWeekdays.value.length)}),c=t.computed(()=>e.monthFormat?e.monthFormat:cu(o.locale.current.value,(e,t)=>({timeZone:"UTC",month:t?"short":"long"})))
function d(e){const t=Ys(e)
return t<Ys(o.parsedStart.value)||t>Ys(o.parsedEnd.value)}function v(){const a=u.value.map(p)
...
return e.showWeek&&i.unshift(function(e){return t.createElementVNode("div",{class:"v-calendar-weekly__weeknumber"},[t.createElementVNode("small",null,[String(e)])])}(r)),t.createElementVNode("div",{key:a[0].date,class:"v-calendar-weekly__week",role:"row"},[i])}function g(t){return As(t.year,t.month-1,t.day,o.parsedWeekdays.value[0],parseInt(String(e.localeFirstDayOfYear)))}function h(e){return t.createElementVNode("div",{class:"v-calendar-weekly__day-label"},[l["day-label"]?.(e)??y(e)])}function y(a){const l=1===a.day&&e.showMonthOnFirst,r=_t(n,":date",e=>({nativeEvent:e,...a}))
return t.createVNode(_s,t.mergeProps({active:a.present,activeColor:e.color,variant:e.color?"flat":"tonal",baseVariant:"text"},r),{default:()=>[l?c.value(a,e.shortMonths)+" "+o.dayFormatter.value(a,!1):o.dayFormatter.value(a,!1)]})}return Bt(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-calendar-weekly",r.themeClasses.value]),onDragstart:e=>e.preventDefault()},[e.hideHeader?void 0:t.createElementVNode("div",{class:"v-calendar-weekly__head",role:"row"},[v()]),m()])),{...o,days:s,todayWeek:u,monthFormatter:c,isOutside:d}}})
function Gu(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
const a=e.map(e=>({event:e,columnCount:0,column:0,left:0,width:100}))
return a.sort((e,a)=>Math.max(t,e.event.startTimestampIdentifier)-Math.max(t,a.event.startTimestampIdentifier)||a.event.endTimestampIdentifier-e.event.endTimestampIdentifier),a}function Ku(e,t,a,l){return!(arguments.length>4&&void 0!==arguments[4])||arguments[4]?!(e>=l||t<=a):!(e>l||t<a)}function qu(e){e.forEach(t=>{t.visuals.forEach(t=>{t.columnCount=e.length})})}function Xu(e){return[e.startTimestampIdentifier,e.endTimestampIdentifier]}function Zu(e){return[e.startIdentifier,e.endIdentifier]}function Qu(e,t){return[Math.max(t,e.startTimestampIdentifier),Math.min(t+864e5,e.endTimestampIdentifier)]}function Ju(e){const t={groups:[],min:-1,max:-1,reset:()=>{t.groups=[],t.min=t.max=-1},getVisuals:function(a,l,n){let o=arguments.length>3&&void 0!==arguments[3]&&arguments[3];(a.weekday===e||o)&&t.reset()
const r=Gu(l,Gs(a))
return r.forEach(e=>{const[a,l]=n?Xu(e.event):Zu(e.event)
t.groups.length>0&&!Ku(a,l,t.min,t.max,n)&&(qu(t.groups),t.reset())
let o=function(e,t,a,l){for(let n=0;n<e.length;n++){const o=e[n]
let r=!1
if(Ku(t,a,o.start,o.end,l))for(let e=0;e<o.visuals.length;e++){const n=o.visuals[e],[i,s]=l?Xu(n.event):Zu(n.event)
if(Ku(t,a,i,s,l)){r=!0
break}}if(!r)return n}return-1}(t.groups,a,l,n);-1===o&&(o=t.groups.length,t.groups.push({start:a,end:l,visuals:[]}))
const r=t.groups[o]
r.visuals.push(e),r.start=Math.min(r.start,a),r.end=Math.max(r.end,l),e.column=o,-1===t.min?(t.min=a,t.max=l):(t.min=Math.min(t.min,a),t.max=Math.max(t.max,l))}),qu(t.groups),n&&t.reset(),r}}
return t}const ec=100
function tc(e,t){for(const a of e){const{visual:l,parent:n}=a,o=sc(a)+1,r=n?n.visual.left:0,i=ec-r,s=Math.min(5,ec/o),u=ac(a,e),c=i/(o-a.index+1),d=i/(o-a.index+(a.sibling?1:0))*u
n&&(l.left=a.sibling?r+c:r+s),l.width=rc(a,e,t)?ec-l.left:Math.min(ec-l.left,1.7*d)}}function ac(e,t){if(!e.children.length)return 1
const a=e.index+t.length
return e.children.reduce((e,t)=>Math.min(e,t.index),a)-e.index}function lc(e,t){const a=function(e,t){const a=[]
for(const l of t)Ku(e.start,e.end,l.start,l.end)&&a.push(l.index)
return a}(e,t)
a.sort()
for(let e=0;e<a.length;e++)if(e<a[e])return e
return!1}function nc(e,t,a,l){let n=arguments.length>4&&void 0!==arguments[4]&&arguments[4]
const o=[]
for(const n of t)n.index>=a&&n.index<=l&&Ku(e.start,e.end,n.start,n.end)&&o.push(n)
if(n&&o.length>0){const e=o.reduce((e,t)=>Math.min(e,t.index),o[0].index)
return o.filter(t=>t.index===e)}return o}function oc(e,t){let a=null
for(const l of t)Ku(e.start,e.end,l.start,l.end)&&(null===a||l.index>a.index)&&(a=l)
return a}function rc(e,t,a){for(const l of t)if(l!==e&&l.index>e.index&&Ku(e.start,uc(e.start,a),l.start,l.end))return!1
return!0}function ic(e,t){const[a,l]=Qu(e.event,t)
return{parent:null,sibling:!0,index:0,visual:e,start:a,end:l,children:[]}}function sc(e){let t=e.index
for(const a of e.children){const e=sc(a)
e>t&&(t=e)}return t}function uc(e,t){const a=e%100,l=a+t
return e-a+100*Math.floor(l/60)+l%60}const cc={stack:(e,t,a)=>{const l=Ju(t)
return(e,t,n,o)=>{if(!n)return l.getVisuals(e,t,n,o)
const r=Gs(e),i=Gu(t,r),s=function(e,t){const a=[]
for(const l of e){const[e,n]=Qu(l.event,t)
let o=!1
for(const t of a)if(Ku(e,n,t.start,t.end)){t.visuals.push(l),t.end=Math.max(t.end,n),o=!0
break}o||a.push({start:e,end:n,visuals:[l]})}return a}(i,r)
for(const e of s){const t=[]
for(const l of e.visuals){const e=ic(l,r),n=lc(e,t)
if(!1===n){const l=oc(e,t)
l&&(e.parent=l,e.sibling=Ku(e.start,e.end,l.start,uc(l.start,a)),e.index=l.index+1,l.children.push(e))}else{const[l]=nc(e,t,n-1,n-1),o=nc(e,t,n+1,n+t.length,!0)
e.children=o,e.index=n,l&&(e.parent=l,e.sibling=Ku(e.start,e.end,l.start,uc(l.start,a)),l.children.push(e))
for(const t of o){t.parent===l&&(t.parent=e)
t.index-e.index<=1&&e.sibling&&Ku(e.start,uc(e.start,a),t.start,t.end)&&(t.sibling=!0)}}t.push(e)}tc(t,a)}return i.sort((e,t)=>e.left-t.left||e.event.startTimestampIdentifier-t.event.startTimestampIdentifier),i}},column:(e,t,a)=>{const l=Ju(t)
...
function dc(e,t){return t>=e.startIdentifier&&t<=e.endIdentifier}function vc(e,t,a,l){return a===e.startIdentifier||l===t.weekday&&dc(e,a)}const pc=vt({events:{type:Array,default:()=>[]},eventStart:{type:String,default:"start"},eventEnd:{type:String,default:"end"},eventTimed:{type:[String,Function],default:"timed"},eventCategory:{type:[String,Function],default:"category"},eventHeight:{type:Number,default:20},eventColor:{type:[String,Function],default:"primary"},eventTextColor:{type:[String,Function]},eventName:{type:[String,Function],default:"name"},eventOverlapThreshold:{type:[String,Number],default:60},eventOverlapMode:{type:[String,Function],default:"stack",validate:e=>e in cc||"function"==typeof e},eventMore:{type:Boolean,default:!0},eventMoreText:{type:String,default:"$vuetify.calendar.moreEvents"},eventRipple:{type:[Boolean,Object],default:null},eventMarginBottom:{type:Number,default:1}},"VCalendar-events")
function mc(e,a,l){const n=vu(e),o=t.computed(()=>!Array.isArray(e.events)||0===e.events.length),r=t.computed(()=>"category"===e.type),i=t.computed(()=>"function"==typeof e.eventTimed?e.eventTimed:t=>!!t[e.eventTimed]),s=t.computed(()=>"function"==typeof e.eventCategory?e.eventCategory:t=>t[e.eventCategory]),u=t.computed(()=>e.events?e.events.map((t,a)=>function(e,t,a,l){let n=arguments.length>4&&void 0!==arguments[4]&&arguments[4],o=arguments.length>5&&void 0!==arguments[5]&&arguments[5]
const r=e[a],i=e[l],s=Ws(r,!0),u=i?Ws(i,!0):s,c=qs(r)?Xs(s,n):s,d=qs(i)?Xs(u,n):u,v=Ys(c),p=Gs(c),m=Ys(d),f=c.hasTime?0:2359
return{input:e,start:c,startIdentifier:v,startTimestampIdentifier:p,end:d,endIdentifier:m,endTimestampIdentifier:Gs(d)+f,allDay:!c.hasTime,index:t,category:o}}(t,a,e.eventStart||"",e.eventEnd||"",i.value(t),!!r.value&&s.value(t))):[]),c=t.computed(()=>parseInt(String(e.eventOverlapThreshold||0))),d=t.computed(()=>"function"==typeof e.eventTextColor?e.eventTextColor:()=>e.eventTextColor),v=t.computed(()=>"function"==typeof e.eventName?e.eventName:(t,a)=>t.input[e.eventName]||""),p=t.computed(()=>"function"==typeof e.eventOverlapMode?e.eventOverlapMode:cc[e.eventOverlapMode]),m=t.computed(()=>n.effectiveWeekdays.value)
...
const n=e.eventHeight||0,o=e.eventMarginBottom||0,i=Ys(a),s=a.week,u=i===l.startIdentifier
let c=i===l.endIdentifier,d=95
if(!r.value)for(let e=a.index+1;e<s.length;e++){const t=Ys(s[e])
...
const r=a.timeDelta(l.end),i=a.timeDelta(l.start)
if(!1===r||!1===i||r<0||i>=1||function(e,t){return"00:00"===e.end.time&&e.end.date===t.date&&e.start.date!==t.date}(l,a))return!1
const s=Ys(a),u=l.startIdentifier>=s,c=l.endIdentifier>s,d=u?a.timeToY(l.start):0,v=c?a.timeToY(1440):a.timeToY(l.end)
...
return t.createElementVNode("span",{class:"v-event-summary"},[t.createElementVNode("strong",null,[a]),t.createTextVNode(" "),e])}}return t.createElementVNode("span",{class:"v-event-summary"},[e])},N={...r,event:o.input,outside:r.day.outside,singline:y,overlapsNoon:h,formatTime:S,timeSummary:k,eventSummary:x},C=_t(l,":event",e=>({...N,nativeEvent:e}))
return t.withDirectives(t.createElementVNode("div",t.mergeProps(n.getColorProps({text:p,background:m}),C,s,{ref_for:!0,ref:g}),[u?.(N)??w(x)]),[[Fn,e.eventRipple??!0]])}function w(e){return t.createElementVNode("div",{class:"pl-1"},[e()])}function S(a){const l=(e.eventHeight||0)+(e.eventMarginBottom||0)
return t.createElementVNode("div",{style:{height:`${l}px`},"data-date":a.date,ref_for:!0,ref:g},null)}function k(a){const n=e.eventHeight||0,o=e.eventMarginBottom||0,r=_t(l,":more",e=>({nativeEvent:e,...a}))
return t.withDirectives(t.createElementVNode("div",t.mergeProps({class:["v-event-more pl-1",{"v-outside":a.outside}],"data-date":a.date,"data-more":"1",style:{display:"none",height:`${n}px`,marginBottom:`${o}px`},ref_for:!0,ref:g},r),null),[[Fn,e.eventRipple??!0]])}function x(e,t){return!r.value||"object"==typeof t&&t.categoryName&&t.categoryName===e.category||"string"==typeof e.category&&t===e.category||"string"!=typeof e.category&&null===t}function N(e){const t=Ys(e),a=m.value[0]
return u.value.filter(l=>vc(l,e,t,a))}function C(e){const t=Ys(e),a=m.value[0]
return u.value.filter(l=>l.allDay&&(r.value?dc(l,t):vc(l,e,t,a))&&x(l,e.category))}function E(e){const t=Ys(e)
return u.value.filter(a=>!a.allDay&&dc(a,t)&&x(a,e.category))}return{...n,noEvents:o,parsedEvents:u,parsedEventOverlapThreshold:c,eventTimedFunction:i,eventCategoryFunction:s,eventTextColorFunction:d,eventNameFunction:v,eventModeFunction:p,eventWeekdays:m,categoryMode:r,eventColorFunction:f,eventsRef:g,updateEventVisibility:function(){if(o.value||!e.eventMore)return
...
t&&(n=n.concat(t))}return n}}}}}const fc=wt()({name:"VCalendar",directives:{vResize:fu},props:{modelValue:{type:[String,Number,Date],validate:js},categoryDays:{type:[Number,String],default:1,validate:e=>isFinite(parseInt(e))&&parseInt(e)>0},categories:{type:[Array,String],default:""},categoryText:{type:[String,Function]},maxDays:{type:Number,default:7},categoryHideDynamic:{type:Boolean},categoryShowAll:{type:Boolean},categoryForInvalid:{type:String,default:""},...du(),...pc()},setup(e,a){let{slots:l,attrs:n,emit:o}=a
const r=t.ref(),i=mc(e,l,n),s=t.ref(null),u=t.ref(null),c=t.computed(()=>parseInt(String(e.categoryDays))||1),d=t.computed(()=>hu(e.categories,e.categoryText)),v=t.computed(()=>{const t=i.parsedValue.value
let a=null,l=e.maxDays,n=d.value,o=t,r=t
switch(e.type){case"month":a=Uu,o=Ms(t),r=zs(t)
break
case"week":a=gu,o=i.getStartOfWeek(t),r=i.getEndOfWeek(t),l=7
break
case"day":a=gu,l=1
break
case"4day":a=gu,r=ru(tu(r),nu,3),Js(r),l=4
break
case"custom-weekly":a=Uu,o=i.parsedStart.value||t,r=i.parsedEnd.value
break
case"custom-daily":a=gu,o=i.parsedStart.value||t,r=i.parsedEnd.value
break
case"category":const s=c.value
a=yu,r=ru(tu(r),nu,s),Js(r),l=s,n=V(n)
break
...
const a=tu(i.parsedValue.value),l=t>0,n=l?nu:ou,r=l?31:1
let s=l?t:-t
...
case"4day":ru(a,n,4)
break
case"category":ru(a,n,c.value)}Qs(a),Js(a),Ks(a,i.times.now),e.modelValue instanceof Date?o("update:modelValue",su(a)):"number"==typeof e.modelValue?o("update:modelValue",su(a).getTime()):o("update:modelValue",a.date),o("moved",a)}function V(t){if(!i.noEvents.value){const a=t.reduce((e,t,a)=>("object"==typeof t&&t.categoryName?e[t.categoryName]={index:a,count:0}:"string"==typeof t&&(e[t]={index:a,count:0}),e),{})
...
return t.withDirectives(t.createVNode(u,t.mergeProps({ref:r,class:["v-calendar",{"v-calendar-events":!i.noEvents.value}],role:"grid"},u.filterProps(e),{start:a.date,end:l.date,maxDays:s,weekdays:i.effectiveWeekdays.value,categories:c,"onClick:date":(e,t)=>{n["onUpdate:modelValue"]&&o("update:modelValue",t.date)}}),i.getScopedSlots()),[[fu,i.updateEventVisibility,void 0,{quiet:!0}]])}),So({...i,lastStart:s,lastEnd:u,parsedCategoryDays:c,renderProps:v,eventWeekdays:p,categoryMode:m,title:h,monthLongFormatter:f,monthShortFormatter:g,parsedCategories:d,checkChange:y,move:b,next:function(){b(arguments.length>0&&void 0!==arguments[0]?arguments[0]:1)},prev:function(){b(-(arguments.length>0&&void 0!==arguments[0]?arguments[0]:1))},getCategoryList:V},r)}}),gc=vt({...pt(),...Pa()},"VCardActions"),hc=wt()({name:"VCardActions",props:gc(),setup(e,a){let{slots:l}=a
return yt({VBtn:{slim:!0,variant:"text"}}),Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-actions",e.class]),style:t.normalizeStyle(e.style)},l)),{}}}),yc=vt({opacity:[Number,String],...pt(),...Pa()},"VCardSubtitle"),bc=wt()({name:"VCardSubtitle",props:yc(),setup(e,a){let{slots:l}=a
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-subtitle",e.class]),style:t.normalizeStyle([{"--v-card-subtitle-opacity":e.opacity},e.style])},l)),{}}}),Vc=St("v-card-title"),wc=vt({appendAvatar:String,appendIcon:Dt,prependAvatar:String,prependIcon:Dt,subtitle:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...pt(),...Rl(),...Pa()},"VCardItem"),Sc=wt()({name:"VCardItem",props:wc(),setup(e,a){let{slots:l}=a
...
return t.createVNode(e.tag,{class:t.normalizeClass(["v-card-item",e.class]),style:t.normalizeStyle(e.style)},{default:()=>[n&&t.createElementVNode("div",{key:"prepend",class:"v-card-item__prepend"},[l.prepend?t.createVNode(nl,{key:"prepend-defaults",disabled:!a,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon}}},l.prepend):t.createElementVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(qn,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Jl,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)])]),t.createElementVNode("div",{class:"v-card-item__content"},[i&&t.createVNode(Vc,{key:"title"},{default:()=>[l.title?.()??t.toDisplayString(e.title)]}),s&&t.createVNode(bc,{key:"subtitle"},{default:()=>[l.subtitle?.()??t.toDisplayString(e.subtitle)]}),l.default?.()]),r&&t.createElementVNode("div",{key:"append",class:"v-card-item__append"},[l.append?t.createVNode(nl,{key:"append-defaults",disabled:!o,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon}}},l.append):t.createElementVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Jl,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(qn,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)])])]})}),{}}}),kc=vt({opacity:[Number,String],...pt(),...Pa()},"VCardText"),xc=wt()({name:"VCardText",props:kc(),setup(e,a){let{slots:l}=a
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-text",e.class]),style:t.normalizeStyle([{"--v-card-text-opacity":e.opacity},e.style])},l)),{}}}),Nc=vt({appendAvatar:String,appendIcon:Dt,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:Dt,ripple:{type:[Boolean,Object],default:!0},subtitle:{type:[String,Number,Boolean],default:void 0},text:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...wl(),...pt(),...Rl(),...ol(),...kl(),...cn(),...nn(),...mn(),...pl(),...yn(),...Pa(),...ya(),...$l({variant:"elevated"})},"VCard"),Cc=wt()({name:"VCard",directives:{vRipple:Fn},props:Nc(),setup(e,a){let{attrs:l,slots:n}=a
const{themeClasses:o}=Ca(e),{borderClasses:r}=Sl(e),{colorClasses:i,colorStyles:s,variantClasses:u}=Ml(e),{densityClasses:c}=Bl(e),{dimensionStyles:d}=rl(e),{elevationClasses:v}=xl(e),{loaderClasses:p}=dn(e),{locationStyles:m}=on(e),{positionClasses:f}=fn(e),{roundedClasses:g}=ml(e),h=hn(e,l),y=t.shallowRef(void 0)
return t.watch(()=>e.loading,(e,t)=>{y.value=e||"string"!=typeof t?"boolean"==typeof e?void 0:e:t},{immediate:!0}),Bt(()=>{const a=!1!==e.link&&h.isLink.value,l=!e.disabled&&!1!==e.link&&(e.link||h.isClickable.value),b=a?"a":e.tag,V=!(!n.title&&null==e.title),w=!(!n.subtitle&&null==e.subtitle),S=V||w,k=!!(n.append||e.appendAvatar||e.appendIcon),x=!!(n.prepend||e.prependAvatar||e.prependIcon),N=!(!n.image&&!e.image),C=S||x||k,E=!(!n.text&&null==e.text)
return t.withDirectives(t.createVNode(b,t.mergeProps(h.linkProps,{class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":l},o.value,r.value,i.value,c.value,v.value,p.value,f.value,g.value,u.value,e.class],style:[s.value,d.value,m.value,e.style],onClick:l&&h.navigate,tabindex:e.disabled?-1:void 0}),{default:()=>[N&&t.createElementVNode("div",{key:"image",class:"v-card__image"},[n.image?t.createVNode(nl,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},n.image):t.createVNode(Vl,{key:"image-img",cover:!0,src:e.image},null)]),t.createVNode(vn,{name:"v-card",active:!!e.loading,color:y.value},{default:n.loader}),C&&t.createVNode(Sc,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:n.item,prepend:n.prepend,title:n.title,subtitle:n.subtitle,append:n.append}),E&&t.createVNode(xc,{key:"text"},{default:()=>[n.text?.()??e.text]}),n.default?.(),n.actions&&t.createVNode(hc,null,{default:n.actions}),Fl(l,"v-card")]}),[[Fn,l&&e.ripple]])}),{}}})
function Ec(e,t){const a=e.changedTouches[0]
...
t.touchstartX=a.clientX,t.touchstartY=a.clientY,t.start?.({originalEvent:e,...t})}(e,t),touchend:e=>Ec(e,t),touchmove:e=>function(e,t){const a=e.changedTouches[0]
...
x(n).forEach(e=>{a.removeEventListener(e,n[e])}),delete a._touchHandlers[l]}},_c=Symbol.for("vuetify:v-window"),Pc=Symbol.for("vuetify:v-window-group"),Tc=vt({continuous:Boolean,nextIcon:{type:[Boolean,String,Function,Object],default:"$next"},prevIcon:{type:[Boolean,String,Function,Object],default:"$prev"},reverse:Boolean,showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||"hover"===e},verticalArrows:[Boolean,String],touch:{type:[Object,Boolean],default:void 0},direction:{type:String,default:"horizontal"},modelValue:null,disabled:Boolean,selectedClass:{type:String,default:"v-window-item--active"},mandatory:{type:[Boolean,String],default:"force"},crossfade:Boolean,transitionDuration:Number,...pt(),...Pa(),...ya()},"VWindow"),Ac=wt()({name:"VWindow",directives:{vTouch:Ic},props:Tc(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:n}=Ca(e),{isRtl:r}=ga(),{t:i}=ma(),s=Hl(e,Pc),u=t.ref(),d=t.computed(()=>r.value?!e.reverse:e.reverse),v=t.shallowRef(!1),p=t.computed(()=>{if(e.crossfade)return"v-window-crossfade-transition"
...
l.scrollTop!==n.top&&l.scrollTo({...n,behavior:"instant"})})})},{flush:"sync"}),t.provide(_c,{transition:p,isReversed:v,transitionCount:m,transitionHeight:f,rootRef:u})
const h=t.toRef(()=>e.continuous||0!==g.value),y=t.toRef(()=>e.continuous||g.value!==s.items.value.length-1)
function V(){h.value&&s.prev()}function w(){y.value&&s.next()}const S=t.computed(()=>{const a=[],n={icon:r.value?e.nextIcon:e.prevIcon,class:"v-window__"+(d.value?"right":"left"),onClick:s.prev,"aria-label":i("$vuetify.carousel.prev")}
...
return a.push(y.value?l.next?l.next({props:o}):t.createVNode(Mn,o,null):t.createElementVNode("div",null,null)),a}),k=t.computed(()=>{if(!1===e.touch)return e.touch
return{...{left:()=>{d.value?V():w()},right:()=>{d.value?w():V()},start:e=>{let{originalEvent:t}=e
t.stopPropagation()}},...!0===e.touch?{}:e.touch}})
return Bt(()=>t.withDirectives(t.createVNode(e.tag,{ref:u,class:t.normalizeClass(["v-window",{"v-window--show-arrows-on-hover":"hover"===e.showArrows,"v-window--vertical-arrows":!!e.verticalArrows,"v-window--crossfade":!!e.crossfade},n.value,e.class]),style:t.normalizeStyle([e.style,e.transitionDuration&&!c?{"--v-window-transition-duration":b(e.transitionDuration,"ms")}:void 0])},{default:()=>[t.createElementVNode("div",{class:"v-window__container",style:{height:f.value}},[l.default?.({group:s}),!1!==e.showArrows&&t.createElementVNode("div",{class:t.normalizeClass(["v-window__controls",{"v-window__controls--left":"left"===e.verticalArrows||!0===e.verticalArrows},{"v-window__controls--right":"right"===e.verticalArrows}])},[S.value])]),l.additional?.({group:s})]}),[[Ic,k.value]])),{group:s}}}),Rc=vt({color:String,cycle:Boolean,delimiterIcon:{type:Dt,default:"$delimiter"},height:{type:[Number,String],default:500},hideDelimiters:Boolean,hideDelimiterBackground:Boolean,interval:{type:[Number,String],default:6e3,validator:e=>Number(e)>0},progress:[Boolean,String],verticalDelimiters:[Boolean,String],...Tc({continuous:!0,mandatory:"force",showArrows:!0})},"VCarousel"),Bc=wt()({name:"VCarousel",props:Rc(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const n=la(e,"modelValue"),{t:o}=ma(),r=t.ref()
let i=-1
function s(){e.cycle&&r.value&&(i=window.setTimeout(r.value.group.next,Number(e.interval)>0?Number(e.interval):6e3))}function u(){window.clearTimeout(i),window.requestAnimationFrame(s)}return t.watch(n,u),t.watch(()=>e.interval,u),t.watch(()=>e.cycle,e=>{e?u():window.clearTimeout(i)}),t.onMounted(s),Bt(()=>{const a=Ac.filterProps(e)
return t.createVNode(Ac,t.mergeProps({ref:r},a,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,class:["v-carousel",{"v-carousel--hide-delimiter-background":e.hideDelimiterBackground,"v-carousel--vertical-delimiters":e.verticalDelimiters},e.class],style:[{height:b(e.height)},e.style]}),{default:l.default,additional:a=>{let{group:r}=a
...
return l.item?l.item({props:n,item:e}):t.createVNode(Mn,t.mergeProps(e,n),null)})]})]),e.progress&&t.createVNode(un,{absolute:!0,class:"v-carousel__progress",color:"string"==typeof e.progress?e.progress:void 0,modelValue:(r.getItemIndex(n.value)+1)/r.items.value.length*100},null)])},prev:l.prev,next:l.next})}),{}}}),Dc=vt({reverseTransition:{type:[Boolean,String],default:void 0},transition:{type:[Boolean,String],default:void 0},...pt(),...jl(),...gi()},"VWindowItem"),Fc=wt()({name:"VWindowItem",directives:{vTouch:Ic},props:Dc(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const n=t.inject(_c),o=Wl(e,Pc),{isBooted:r}=_l()
...
return Bt(()=>t.createVNode(gl,{transition:p.value,disabled:!r.value},{default:()=>[t.withDirectives(t.createElementVNode("div",{class:t.normalizeClass(["v-window-item",o.selectedClass.value,e.class]),style:t.normalizeStyle(e.style)},[m.value&&l.default?.()]),[[t.vShow,o.isSelected.value]])]})),{groupItem:o}}}),$c=vt({...bl(),...Dc()},"VCarouselItem"),Mc=wt()({name:"VCarouselItem",inheritAttrs:!1,props:$c(),setup(e,a){let{slots:l,attrs:n}=a
Bt(()=>{const a=Vl.filterProps(e),o=Fc.filterProps(e)
return t.createVNode(Fc,t.mergeProps({class:["v-carousel-item",e.class]},o),{default:()=>[t.createVNode(Vl,t.mergeProps(n,a),l)]})})}}),zc=St("v-code","code"),Lc=Vt({name:"VColorPickerCanvas",props:vt({color:{type:Object},disabled:Boolean,dotSize:{type:[Number,String],default:10},height:{type:[Number,String],default:150},width:{type:[Number,String],default:300},...pt()},"VColorPickerCanvas")(),emits:{"update:color":e=>!0,"update:position":e=>!0},setup(e,a){let{emit:l}=a
...
const Oc={h:0,s:0,v:0,a:1},jc={inputProps:{type:"number",min:0},inputs:[{label:"R",max:255,step:1,getValue:e=>Math.round(e.r),getColor:(e,t)=>({...e,r:Number(t)}),localeKey:"redInput"},{label:"G",max:255,step:1,getValue:e=>Math.round(e.g),getColor:(e,t)=>({...e,g:Number(t)}),localeKey:"greenInput"},{label:"B",max:255,step:1,getValue:e=>Math.round(e.b),getColor:(e,t)=>({...e,b:Number(t)}),localeKey:"blueInput"},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)}),localeKey:"alphaInput"}],to:Xe,from:Qe},Wc={inputProps:{type:"number",min:0},inputs:[{label:"H",max:360,step:1,getValue:e=>Math.round(e.h),getColor:(e,t)=>({...e,h:Number(t)}),localeKey:"hueInput"},{label:"S",max:1,step:.01,getValue:e=>Math.round(100*e.s)/100,getColor:(e,t)=>({...e,s:Number(t)}),localeKey:"saturationInput"},{label:"L",max:1,step:.01,getValue:e=>Math.round(100*e.l)/100,getColor:(e,t)=>({...e,l:Number(t)}),localeKey:"lightnessInput"},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)}),localeKey:"alphaInput"}],to:Je,from:et},Hc={inputProps:{type:"text"},inputs:[{label:"HEXA",getValue:e=>e,getColor:(e,t)=>t,localeKey:"hexaInput"}],to:rt,from:function(e){return Qe(ot(e))}},Yc={rgb:{...jc,inputs:jc.inputs?.slice(0,3)},rgba:jc,hsl:{...Wc,inputs:Wc.inputs.slice(0,3)},hsla:Wc,hex:{...Hc,inputs:[{label:"HEX",getValue:e=>e.slice(0,7),getColor:(e,t)=>t,localeKey:"hexInput"}]},hexa:Hc},Uc=e=>{let{label:a,...l}=e
return t.createElementVNode("div",{class:"v-color-picker-edit__input"},[t.createElementVNode("input",t.normalizeProps(t.guardReactiveProps(l)),null),t.createElementVNode("span",null,[a])])},Gc=Vt({name:"VColorPickerEdit",props:vt({color:Object,disabled:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys(Yc).includes(e)},modes:{type:Array,default:()=>Object.keys(Yc),validator:e=>Array.isArray(e)&&e.every(e=>Object.keys(Yc).includes(e))},...pt()},"VColorPickerEdit")(),emits:{"update:color":e=>!0,"update:mode":e=>!0},setup(e,a){let{emit:l}=a
const{t:n}=ma(),o=t.computed(()=>e.modes.map(e=>({...Yc[e],name:e}))),r=t.computed(()=>{const t=o.value.find(t=>t.name===e.mode)
if(!t)return[]
...
n&&l("update:color",t.from(i(a??t.to(Oc),n.value)))}}})})
return Bt(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-color-picker-edit",e.class]),style:t.normalizeStyle(e.style)},[r.value?.map(e=>t.createVNode(Uc,e,null)),o.value.length>1&&t.createVNode(Mn,{icon:"$unfold",size:"x-small",variant:"plain","aria-label":n("$vuetify.colorPicker.ariaLabel.changeFormat"),onClick:()=>{const t=o.value.findIndex(t=>t.name===e.mode)
l("update:mode",o.value[(t+1)%o.value.length].name)}},null)])),{}}}),Kc=Symbol.for("vuetify:v-slider")
function qc(e,t,a){const l="vertical"===a,n=t.getBoundingClientRect(),o="touches"in e?e.touches[0]:e
return l?o.clientY-(n.top+n.height/2):o.clientX-(n.left+n.width/2)}const Xc=vt({disabled:{type:Boolean,default:null},error:Boolean,readonly:{type:Boolean,default:null},max:{type:[Number,String],default:100},min:{type:[Number,String],default:0},step:{type:[Number,String],default:0},thumbColor:String,thumbLabel:{type:[Boolean,String],default:void 0,validator:e=>"boolean"==typeof e||"always"===e},thumbSize:{type:[Number,String],default:20},showTicks:{type:[Boolean,String],default:!1,validator:e=>"boolean"==typeof e||"always"===e},ticks:{type:[Array,Object]},tickSize:{type:[Number,String],default:2},color:String,trackColor:String,trackFillColor:String,trackSize:{type:[Number,String],default:4},direction:{type:String,default:"horizontal",validator:e=>["vertical","horizontal"].includes(e)},reverse:Boolean,noKeyboard:Boolean,...pl(),...kl({elevation:2}),ripple:{type:Boolean,default:!0}},"Slider"),Zc=e=>{const a=t.computed(()=>parseFloat(e.min)),l=t.computed(()=>parseFloat(e.max)),n=t.computed(()=>Number(e.step)>0?parseFloat(e.step):0),o=t.computed(()=>Math.max($(n.value),$(a.value)))
...
return t>i&&i+n.value>l.value&&(i=l.value),parseFloat(Math.min(i,l.value).toFixed(o.value))}}},Qc=e=>{let{props:a,steps:l,onSliderStart:n,onSliderMove:o,onSliderEnd:r,getActiveThumb:i}=e
...
function T(e){const t=_.value?.$el
if(!t)return
...
return(l?v.value:v.value!==u.value)&&(d=1-d),h(p.value+d*(m.value-p.value))}const A=e=>{const t=T(e)
null!=t&&r({value:t}),E.value=!1,I.value=0},R=e=>{const l=T(e)
P.value=i(e),P.value&&(E.value=!0,P.value.contains(e.target)?I.value=qc(e,P.value,a.direction):(I.value=0,null!=l&&o({value:l})),null!=l&&n({value:l}),t.nextTick(()=>P.value?.focus()))},B={passive:!0,capture:!0}
function D(e){const t=T(e)
null!=t&&o({value:t})}function $(e){e.stopPropagation(),e.preventDefault(),A(e),window.removeEventListener("mousemove",D,B),window.removeEventListener("mouseup",$)}function M(e){A(e),window.removeEventListener("touchmove",D,B),e.target?.removeEventListener("touchend",M)}const z=e=>{const t=(e-p.value)/(m.value-p.value)*100
return F(isNaN(t)?0:t,0,100)},L=t.toRef(()=>a.showTicks),O=t.computed(()=>L.value?a.ticks?Array.isArray(a.ticks)?a.ticks.map(e=>({value:e,position:z(e),label:e.toString()})):Object.keys(a.ticks).map(e=>({value:parseFloat(e),position:z(parseFloat(e)),label:a.ticks[e]})):S.value!==1/0?y(S.value+1).map(e=>{const t=p.value+e*f.value
return{value:t,position:z(t)}}):[]:[]),j=t.computed(()=>O.value.some(e=>{let{label:t}=e
return!!t})),W={activeThumbRef:P,color:t.toRef(()=>a.color),decimals:g,disabled:s.isDisabled,direction:t.toRef(()=>a.direction),elevation:t.toRef(()=>a.elevation),hasLabels:j,isReversed:c,indexFromEnd:v,min:p,max:m,mousePressed:E,noKeyboard:t.toRef(()=>a.noKeyboard),numTicks:S,onSliderMousedown:function(e){0===e.button&&(e.preventDefault(),R(e),window.addEventListener("mousemove",D,B),window.addEventListener("mouseup",$,{passive:!1}))},onSliderTouchstart:function(e){R(e),window.addEventListener("touchmove",D,B),e.target?.addEventListener("touchend",M,{passive:!1})},parsedTicks:O,parseMouseMove:T,position:z,readonly:s.isReadonly,rounded:t.toRef(()=>a.rounded),roundValue:h,showTicks:L,startOffset:I,step:f,thumbSize:b,thumbColor:k,thumbLabelColor:x,thumbLabel:t.toRef(()=>a.thumbLabel),ticks:t.toRef(()=>a.ticks),tickSize:V,trackColor:N,trackContainerRef:_,trackFillColor:C,trackSize:w,vertical:d}
return t.provide(Kc,W),W},Jc=vt({focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0},ripple:{type:[Boolean,Object],default:!0},name:String,noKeyboard:Boolean,...pt()},"VSliderThumb"),ed=wt()({name:"VSliderThumb",directives:{vRipple:Fn},props:Jc(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l,emit:n}=a
const o=t.inject(Kc),{isRtl:r,rtlClasses:i}=ga()
if(!o)throw new Error("[Vuetify] v-slider-thumb must be used inside v-slider or v-range-slider")
const{min:s,max:u,thumbColor:c,thumbLabelColor:d,step:v,disabled:p,thumbSize:m,thumbLabel:f,direction:g,isReversed:h,vertical:y,readonly:V,elevation:w,mousePressed:S,decimals:x,indexFromEnd:N}=o,C=t.computed(()=>p.value?void 0:w.value),{elevationClasses:E}=xl(C),{textColorClasses:I,textColorStyles:_}=cl(c),{backgroundColorClasses:P,backgroundColorStyles:T}=dl(d),{pageup:A,pagedown:R,end:B,home:D,left:F,right:$,down:M,up:z}=k,L=[A,R,B,D,F,$,M,z],O=t.computed(()=>v.value?[1,2,3]:[1,5,10])
...
l("update:color",{...e.color??Oc,...a})}catch(e){}}return t.onUnmounted(()=>o.abort()),Bt(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-color-picker-preview",{"v-color-picker-preview--hide-alpha":e.hideAlpha},e.class]),style:t.normalizeStyle(e.style)},[s&&!e.hideEyeDropper&&t.createElementVNode("div",{class:"v-color-picker-preview__eye-dropper",key:"eyeDropper"},[t.createVNode(Mn,{"aria-label":n("$vuetify.colorPicker.ariaLabel.eyedropper"),density:"comfortable",disabled:e.disabled,icon:e.eyeDropperIcon,variant:"plain",onClick:r},null)]),t.createElementVNode("div",{class:"v-color-picker-preview__dot"},[t.createElementVNode("div",{style:{background:at(e.color??Oc)}},null)]),t.createElementVNode("div",{class:"v-color-picker-preview__sliders"},[t.createVNode(nd,{class:"v-color-picker-preview__track v-color-picker-preview__hue",name:n("$vuetify.colorPicker.ariaLabel.hueSlider"),modelValue:e.color?.h,"onUpdate:modelValue":t=>l("update:color",{...e.color??Oc,h:t}),step:1,min:0,max:360,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null),!e.hideAlpha&&t.createVNode(nd,{class:"v-color-picker-preview__track v-color-picker-preview__alpha",name:n("$vuetify.colorPicker.ariaLabel.alphaSlider"),modelValue:e.color?.a??1,"onUpdate:modelValue":t=>l("update:color",{...e.color??Oc,a:t}),step:.01,min:0,max:1,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null)])])),{}}})
var id={red:{base:"#f44336",lighten5:"#ffebee",lighten4:"#ffcdd2",lighten3:"#ef9a9a",lighten2:"#e57373",lighten1:"#ef5350",darken1:"#e53935",darken2:"#d32f2f",darken3:"#c62828",darken4:"#b71c1c",accent1:"#ff8a80",accent2:"#ff5252",accent3:"#ff1744",accent4:"#d50000"},pink:{base:"#e91e63",lighten5:"#fce4ec",lighten4:"#f8bbd0",lighten3:"#f48fb1",lighten2:"#f06292",lighten1:"#ec407a",darken1:"#d81b60",darken2:"#c2185b",darken3:"#ad1457",darken4:"#880e4f",accent1:"#ff80ab",accent2:"#ff4081",accent3:"#f50057",accent4:"#c51162"},purple:{base:"#9c27b0",lighten5:"#f3e5f5",lighten4:"#e1bee7",lighten3:"#ce93d8",lighten2:"#ba68c8",lighten1:"#ab47bc",darken1:"#8e24aa",darken2:"#7b1fa2",darken3:"#6a1b9a",darken4:"#4a148c",accent1:"#ea80fc",accent2:"#e040fb",accent3:"#d500f9",accent4:"#aa00ff"},deepPurple:{base:"#673ab7",lighten5:"#ede7f6",lighten4:"#d1c4e9",lighten3:"#b39ddb",lighten2:"#9575cd",lighten1:"#7e57c2",darken1:"#5e35b1",darken2:"#512da8",darken3:"#4527a0",darken4:"#311b92",accent1:"#b388ff",accent2:"#7c4dff",accent3:"#651fff",accent4:"#6200ea"},indigo:{base:"#3f51b5",lighten5:"#e8eaf6",lighten4:"#c5cae9",lighten3:"#9fa8da",lighten2:"#7986cb",lighten1:"#5c6bc0",darken1:"#3949ab",darken2:"#303f9f",darken3:"#283593",darken4:"#1a237e",accent1:"#8c9eff",accent2:"#536dfe",accent3:"#3d5afe",accent4:"#304ffe"},blue:{base:"#2196f3",lighten5:"#e3f2fd",lighten4:"#bbdefb",lighten3:"#90caf9",lighten2:"#64b5f6",lighten1:"#42a5f5",darken1:"#1e88e5",darken2:"#1976d2",darken3:"#1565c0",darken4:"#0d47a1",accent1:"#82b1ff",accent2:"#448aff",accent3:"#2979ff",accent4:"#2962ff"},lightBlue:{base:"#03a9f4",lighten5:"#e1f5fe",lighten4:"#b3e5fc",lighten3:"#81d4fa",lighten2:"#4fc3f7",lighten1:"#29b6f6",darken1:"#039be5",darken2:"#0288d1",darken3:"#0277bd",darken4:"#01579b",accent1:"#80d8ff",accent2:"#40c4ff",accent3:"#00b0ff",accent4:"#0091ea"},cyan:{base:"#00bcd4",lighten5:"#e0f7fa",lighten4:"#b2ebf2",lighten3:"#80deea",lighten2:"#4dd0e1",lighten1:"#26c6da",darken1:"#00acc1",darken2:"#0097a7",darken3:"#00838f",darken4:"#006064",accent1:"#84ffff",accent2:"#18ffff",accent3:"#00e5ff",accent4:"#00b8d4"},teal:{base:"#009688",lighten5:"#e0f2f1",lighten4:"#b2dfdb",lighten3:"#80cbc4",lighten2:"#4db6ac",lighten1:"#26a69a",darken1:"#00897b",darken2:"#00796b",darken3:"#00695c",darken4:"#004d40",accent1:"#a7ffeb",accent2:"#64ffda",accent3:"#1de9b6",accent4:"#00bfa5"},green:{base:"#4caf50",lighten5:"#e8f5e9",lighten4:"#c8e6c9",lighten3:"#a5d6a7",lighten2:"#81c784",lighten1:"#66bb6a",darken1:"#43a047",darken2:"#388e3c",darken3:"#2e7d32",darken4:"#1b5e20",accent1:"#b9f6ca",accent2:"#69f0ae",accent3:"#00e676",accent4:"#00c853"},lightGreen:{base:"#8bc34a",lighten5:"#f1f8e9",lighten4:"#dcedc8",lighten3:"#c5e1a5",lighten2:"#aed581",lighten1:"#9ccc65",darken1:"#7cb342",darken2:"#689f38",darken3:"#558b2f",darken4:"#33691e",accent1:"#ccff90",accent2:"#b2ff59",accent3:"#76ff03",accent4:"#64dd17"},lime:{base:"#cddc39",lighten5:"#f9fbe7",lighten4:"#f0f4c3",lighten3:"#e6ee9c",lighten2:"#dce775",lighten1:"#d4e157",darken1:"#c0ca33",darken2:"#afb42b",darken3:"#9e9d24",darken4:"#827717",accent1:"#f4ff81",accent2:"#eeff41",accent3:"#c6ff00",accent4:"#aeea00"},yellow:{base:"#ffeb3b",lighten5:"#fffde7",lighten4:"#fff9c4",lighten3:"#fff59d",lighten2:"#fff176",lighten1:"#ffee58",darken1:"#fdd835",darken2:"#fbc02d",darken3:"#f9a825",darken4:"#f57f17",accent1:"#ffff8d",accent2:"#ffff00",accent3:"#ffea00",accent4:"#ffd600"},amber:{base:"#ffc107",lighten5:"#fff8e1",lighten4:"#ffecb3",lighten3:"#ffe082",lighten2:"#ffd54f",lighten1:"#ffca28",darken1:"#ffb300",darken2:"#ffa000",darken3:"#ff8f00",darken4:"#ff6f00",accent1:"#ffe57f",accent2:"#ffd740",accent3:"#ffc400",accent4:"#ffab00"},orange:{base:"#ff9800",lighten5:"#fff3e0",lighten4:"#ffe0b2",lighten3:"#ffcc80",lighten2:"#ffb74d",lighten1:"#ffa726",darken1:"#fb8c00",darken2:"#f57c00",darken3:"#ef6c00",darken4:"#e65100",accent1:"#ffd180",accent2:"#ffab40",accent3:"#ff9100",accent4:"#ff6d00"},deepOrange:{base:"#ff5722",lighten5:"#fbe9e7",lighten4:"#ffccbc",lighten3:"#ffab91",lighten2:"#ff8a65",lighten1:"#ff7043",darken1:"#f4511e",darken2:"#e64a19",darken3:"#d84315",darken4:"#bf360c",accent1:"#ff9e80",accent2:"#ff6e40",accent3:"#ff3d00",accent4:"#dd2c00"},brown:{base:"#795548",lighten5:"#efebe9",lighten4:"#d7ccc8",lighten3:"#bcaaa4",lighten2:"#a1887f",lighten1:"#8d6e63",darken1:"#6d4c41",darken2:"#5d4037",darken3:"#4e342e",darken4:"#3e2723"},blueGrey:{base:"#607d8b",lighten5:"#eceff1",lighten4:"#cfd8dc",lighten3:"#b0bec5",lighten2:"#90a4ae",lighten1:"#78909c",darken1:"#546e7a",darken2:"#455a64",darken3:"#37474f",darken4:"#263238"},grey:{base:"#9e9e9e",lighten5:"#fafafa",lighten4:"#f5f5f5",lighten3:"#eeeeee",lighten2:"#e0e0e0",lighten1:"#bdbdbd",darken1:"#757575",darken2:"#616161",darken3:"#424242",darken4:"#212121"},shades:{black:"#000000",white:"#ffffff",transparent:"#ffffff00"}}
const sd=vt({swatches:{type:Array,default:()=>function(e){return Object.keys(e).map(t=>{const a=e[t]
return a.base?[a.base,a.darken4,a.darken3,a.darken2,a.darken1,a.lighten1,a.lighten2,a.lighten3,a.lighten4,a.lighten5]:[a.black,a.white,a.transparent]})}(id)},disabled:Boolean,color:Object,maxHeight:[Number,String],...pt()},"VColorPickerSwatches")
const ud=Vt({name:"VColorPickerSwatches",props:sd(),emits:{"update:color":e=>!0},setup(e,a){let{emit:l}=a
...
return t.createElementVNode("div",{class:"v-color-picker-swatches__color",onClick:()=>o&&l("update:color",o)},[t.createElementVNode("div",{style:{background:r}},[e.color&&kt(e.color,o)?t.createVNode(Jl,{size:"x-small",icon:"$success",color:ct(a,"#FFFFFF")>2?"white":"black"},null):void 0])])})]))])])),{}}}),cd=St("v-picker-title"),dd=vt({color:String,...wl(),...pt(),...ol(),...kl(),...nn(),...mn(),...pl(),...Pa(),...ya()},"VSheet"),vd=wt()({name:"VSheet",props:dd(),setup(e,a){let{slots:l}=a
const{themeClasses:n}=Ca(e),{backgroundColorClasses:o,backgroundColorStyles:r}=dl(()=>e.color),{borderClasses:i}=Sl(e),{dimensionStyles:s}=rl(e),{elevationClasses:u}=xl(e),{locationStyles:c}=on(e),{positionClasses:d}=fn(e),{roundedClasses:v}=ml(e)
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-sheet",n.value,o.value,i.value,u.value,d.value,v.value,e.class]),style:t.normalizeStyle([r.value,s.value,c.value,e.style])},l)),{}}}),pd=vt({bgColor:String,divided:Boolean,landscape:Boolean,title:String,hideHeader:Boolean,hideTitle:Boolean,...dd()},"VPicker"),md=wt()({name:"VPicker",props:pd(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:n,backgroundColorStyles:o}=dl(()=>e.color)
return Bt(()=>{const a=vd.filterProps(e),r=!(e.hideTitle||!e.title&&!l.title)
return t.createVNode(vd,t.mergeProps(a,{color:e.bgColor,class:["v-picker",{"v-picker--divided":e.divided,"v-picker--landscape":e.landscape,"v-picker--with-actions":!!l.actions},e.class],style:e.style}),{default:()=>[!e.hideHeader&&t.createElementVNode("div",{key:"header",class:t.normalizeClass(["v-picker__header-wrapper",n.value]),style:t.normalizeStyle([o.value])},[r&&t.createVNode(cd,{key:"picker-title"},{default:()=>[l.title?.()??e.title]}),l.header&&t.createElementVNode("div",{class:"v-picker__header"},[l.header()])]),t.createElementVNode("div",{class:"v-picker__body"},[l.default?.()]),l.actions&&t.createVNode(nl,{defaults:{VBtn:{slim:!0,variant:"text"}}},{default:()=>[t.createElementVNode("div",{class:"v-picker__actions"},[l.actions()])]})]})}),{}}}),fd=Vt({name:"VColorPicker",props:vt({canvasHeight:{type:[String,Number],default:150},disabled:Boolean,dotSize:{type:[Number,String],default:10},hideCanvas:Boolean,hideSliders:Boolean,hideInputs:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys(Yc).includes(e)},modes:{type:Array,default:()=>Object.keys(Yc),validator:e=>Array.isArray(e)&&e.every(e=>Object.keys(Yc).includes(e))},showSwatches:Boolean,swatches:Array,swatchesMaxHeight:{type:[Number,String],default:150},modelValue:{type:[Object,String]},...pd({hideHeader:!0}),...C(od(),["hideEyeDropper","eyeDropperIcon"])},"VColorPicker")(),emits:{"update:modelValue":e=>!0,"update:mode":e=>!0},setup(e,l){let{slots:n}=l
...
return t.onBeforeMount(()=>{e.modes.includes(o.value)||(o.value=e.modes[0])}),yt({VSlider:{color:void 0,trackColor:void 0,trackFillColor:void 0}}),Bt(()=>{const a=md.filterProps(e)
return t.createVNode(md,t.mergeProps(a,{class:["v-color-picker",u.value,e.class],style:[{"--v-color-picker-color-hsv":at({...s.value??Oc,a:1})},e.style]}),{...n,default:()=>t.createElementVNode(t.Fragment,null,[!e.hideCanvas&&t.createVNode(Lc,{key:"canvas",color:s.value,"onUpdate:color":d,disabled:e.disabled,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&t.createElementVNode("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&t.createVNode(rd,{key:"preview",color:s.value,"onUpdate:color":d,hideAlpha:!o.value.endsWith("a"),disabled:e.disabled,hideEyeDropper:e.hideEyeDropper,eyeDropperIcon:e.eyeDropperIcon},null),!e.hideInputs&&t.createVNode(Gc,{key:"edit",modes:e.modes,mode:o.value,"onUpdate:mode":e=>o.value=e,color:s.value,"onUpdate:color":d,disabled:e.disabled},null)]),e.showSwatches&&t.createVNode(ud,{key:"swatches",color:s.value,"onUpdate:color":d,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled},null)])})}),{}}}),gd=vt({alwaysFilter:Boolean,autoSelectFirst:{type:[Boolean,String]},clearOnSelect:{type:Boolean,default:!0},delimiters:Array,...ns({filterKeys:["title"]}),...Ji({hideNoData:!0,returnObject:!0}),...I(ji({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"])},"VCombobox"),hd=wt()({name:"VCombobox",props:gd(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,a){let{emit:l,slots:n}=a
...
return e.multiple?a:a[0]??null}),w=mo(e),S=t.computed(()=>!(!e.chips&&!n.chip)),k=t.computed(()=>S.value||!!n.selection),x=t.shallowRef(e.multiple||k.value?"":V.value[0]?.title??""),N=t.shallowRef(null),C=t.computed({get:()=>x.value,set:async a=>{if(x.value=a??"",null===a||""===a&&!e.multiple&&!k.value?V.value=[]:e.multiple||k.value||(V.value=[Tr(e,a)],t.nextTick(()=>v.value?.scrollToIndex(0))),a&&e.multiple&&e.delimiters?.length){const e=J(a)
e.length>1&&(ee(e),x.value="")}a||(p.value=-1),u.value=!a}}),E=t.computed(()=>"function"==typeof e.counterValue?e.counterValue(V.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?V.value.length:C.value.length),{filteredItems:I,getMatches:_}=os(e,f,()=>N.value??(e.alwaysFilter||!u.value?C.value:"")),P=t.computed(()=>e.hideSelected&&null===N.value?I.value.filter(e=>!V.value.some(t=>t.value===e.value)):I.value),T=t.computed(()=>e.hideNoData&&!P.value.length||w.isReadonly.value||w.isDisabled.value),R=la(e,"menu"),D=t.computed({get:()=>R.value,set:e=>{R.value&&!e&&d.value?.ΨopenChildren.size||e&&T.value||(R.value=e)}}),{menuId:F,ariaExpanded:$,ariaControls:M,ariaLabel:z}=Qi(e,D)
...
function H(a){m=!0,t.nextTick(()=>m=!1),e.openOnClear&&(D.value=!0)}function Y(){T.value||(D.value=!0)}function U(e){T.value||(s.value&&(e.preventDefault(),e.stopPropagation()),D.value=!D.value)}function G(e){(ue(e)||"Backspace"===e.key)&&i.value?.focus()}function K(t){if(function(e){return e.isComposing&&A.includes(e.key)}(t)||w.isReadonly.value)return
...
return t===P.value[0].value})&&Q(I.value[0]),"ArrowDown"===t.key&&O.value&&j.value?.focus("next"),"Enter"===t.key&&C.value&&(Q(Tr(e,C.value),!0,!0),k.value&&(x.value="")),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&k.value&&V.value.length>0&&!C.value)return Q(V.value[0],!1)
...
V.value=o?[a]:[],u.value&&!e.alwaysFilter||!x.value||(N.value=x.value),x.value=o&&!k.value?a.title:"",t.nextTick(()=>{D.value=n,u.value=!0})}}function J(t){const a=["\n",...e.delimiters??[]].map(de).join("|")
return t.split(new RegExp(`(?:${a})+`))}async function ee(a){for(let l of a)l=l.trim(),l&&(Q(Tr(e,l)),await t.nextTick())}function te(e){s.value=!0,setTimeout(()=>{c.value=!0})}function ae(e){c.value=!1}return t.watch(s,(t,a)=>{if(!t&&t!==a&&(p.value=-1,D.value=!1,C.value)){if(e.multiple)return void Q(Tr(e,C.value))
if(!k.value)return
V.value.some(e=>{let{title:t}=e
return t===C.value})?x.value="":Q(Tr(e,C.value))}}),t.watch(D,t=>{if(!e.hideSelected&&t&&V.value.length&&u.value){const t=P.value.findIndex(t=>V.value.some(a=>(e.valueComparator||kt)(a.value,t.value)))
...
return t.createElementVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(oo,{key:l.value,modelValue:n,ripple:!1,tabindex:"-1",onClick:e=>e.preventDefault()},null):void 0,l.props.prependAvatar&&t.createVNode(qn,{image:l.props.prependAvatar},null),l.props.prependIcon&&t.createVNode(Jl,{icon:l.props.prependIcon},null)])},title:()=>u.value?l.title:rs("v-combobox",l.title,_(l)?.title)})}}),n["append-item"]?.()]})]}),V.value.map((a,l)=>{function o(e){e.stopPropagation(),e.preventDefault(),Q(a,!1)}const r={"onClick:close":o,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),o(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=S.value?!!n.chip:!!n.selection,s=i?re(S.value?n.chip({item:a,index:l,props:r}):n.selection({item:a,index:l})):void 0
if(!i||s)return t.createElementVNode("div",{key:a.value,class:t.normalizeClass(["v-combobox__selection",l===p.value&&["v-combobox__selection--selected",y.value]]),style:t.normalizeStyle(l===p.value?b.value:{})},[S.value?n.chip?t.createVNode(nl,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:a.title}}},{default:()=>[s]}):t.createVNode(Zo,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:a.title,disabled:a.props.disabled},r),null):s??t.createElementVNode("span",{class:"v-combobox__selection-text"},[a.title,e.multiple&&l<V.value.length-1&&t.createElementVNode("span",{class:"v-combobox__selection-comma"},[t.createTextVNode(",")])])])})]),"append-inner":function(){for(var a=arguments.length,l=new Array(a),o=0;o<a;o++)l[o]=arguments[o]
return t.createElementVNode(t.Fragment,null,[n["append-inner"]?.(...l),e.hideNoData&&!e.items.length||!e.menuIcon?void 0:t.createVNode(Jl,{class:"v-combobox__menu-icon",color:i.value?.fieldIconColor,icon:e.menuIcon,onMousedown:U,onClick:ne,"aria-label":z.value,title:z.value,tabindex:"-1"},null)])}})}),So({isFocused:s,isPristine:u,menu:D,search:C,selectionIndex:p,filteredItems:I,select:Q},i)}}),yd=vt({modelValue:null,color:String,cancelText:{type:String,default:"$vuetify.confirmEdit.cancel"},okText:{type:String,default:"$vuetify.confirmEdit.ok"},disabled:{type:[Boolean,Array],default:void 0},hideActions:Boolean},"VConfirmEdit"),bd=wt()({name:"VConfirmEdit",props:yd(),emits:{cancel:()=>!0,save:e=>!0,"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:n}=a
const o=la(e,"modelValue"),r=t.ref()
t.watchEffect(()=>{r.value=structuredClone(ve(o.value))})
const{t:i}=ma(),s=t.computed(()=>kt(o.value,r.value))
...
return e}const xd=vt({groupBy:{type:Array,default:()=>[]}},"DataTable-group"),Nd=Symbol.for("vuetify:data-table-group")
function Cd(e){return{groupBy:la(e,"groupBy")}}function Ed(e){const{disableSort:a,groupBy:l,sortBy:n}=e,o=t.ref(new Set)
...
return e}function _d(e,t){let a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,l=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"root"
if(!t.length)return[]
...
return l}function Td(e,a,l,n){return{flatItems:t.computed(()=>{if(!a.value.length)return e.value
return Pd(_d(e.value,a.value.map(e=>e.key)),l.value,t.toValue(n))})}}function Ad(e){let{page:a,itemsPerPage:l,sortBy:n,groupBy:o,search:r}=e
const i=mt("VDataTable")
let s=null
t.watch(()=>({page:a.value,itemsPerPage:l.value,sortBy:n.value,groupBy:o.value,search:r.value}),e=>{kt(s,e)||(s&&s.search!==e.search&&(a.value=1),i.emit("update:options",e),s=e)},{deep:!0,immediate:!0})}const Rd=vt({page:{type:[Number,String],default:1},itemsPerPage:{type:[Number,String],default:10}},"DataTable-paginate"),Bd=Symbol.for("vuetify:data-table-pagination")
function Dd(e){return{page:la(e,"page",void 0,e=>Number(e??1)),itemsPerPage:la(e,"itemsPerPage",void 0,e=>Number(e??10))}}function Fd(e){const{page:a,itemsPerPage:l,itemsLength:n}=e,o=t.computed(()=>-1===l.value?0:l.value*(a.value-1)),r=t.computed(()=>-1===l.value?n.value:Math.min(n.value,o.value+l.value)),i=t.computed(()=>-1===l.value||0===n.value?1:Math.ceil(n.value/l.value))
...
return t.provide(Bd,s),s}function $d(e){const a=mt("usePaginatedItems"),{items:l,startIndex:n,stopIndex:o,itemsPerPage:r}=e,i=t.computed(()=>r.value<=0?l.value:l.value.slice(n.value,o.value))
return t.watch(i,e=>{a.emit("update:currentItems",e)},{immediate:!0}),{paginatedItems:i}}const Md={showSelectAll:!1,allSelected:()=>[],select:e=>{let{items:t,value:a}=e
return new Set(a?[t[0]?.value]:[])},selectAll:e=>{let{selected:t}=e
return t}},zd={showSelectAll:!0,allSelected:e=>{let{currentPage:t}=e
...
return zd.select({items:a,value:t,selected:l})}},Ld={showSelectAll:!0,allSelected:e=>{let{allItems:t}=e
return t},select:e=>{let{items:t,value:a,selected:l}=e
for(const e of t)a?l.add(e.value):l.delete(e.value)
return l},selectAll:e=>{let{value:t,allItems:a}=e
return new Set(t?a.map(e=>e.value):[])}},Od=vt({showSelect:Boolean,selectStrategy:{type:[String,Object],default:"page"},modelValue:{type:Array,default:()=>[]},valueComparator:Function},"DataTable-select"),jd=Symbol.for("vuetify:data-table-selection")
function Wd(e,a){let{allItems:l,currentPage:n}=a
const o=la(e,"modelValue",e.modelValue,t=>{const a=e.valueComparator
return a?new Set(B(t).map(e=>l.value.find(t=>a(e,t.value))?.value??e)):new Set(B(t).map(e=>ce(e)?l.value.find(t=>e===t.value)?.value??e:l.value.find(t=>kt(e,t.value))?.value??e))},e=>[...e.values()]),r=t.computed(()=>l.value.filter(e=>e.selectable)),i=t.computed(()=>n.value.filter(e=>e.selectable)),s=t.computed(()=>{if("object"==typeof e.selectStrategy)return e.selectStrategy
switch(e.selectStrategy){case"single":return Md
case"all":return Ld
default:return zd}}),u=t.shallowRef(null)
...
return t.provide(jd,m),m}function Hd(){const e=t.inject(jd)
if(!e)throw new Error("Missing selection!")
return e}const Yd=vt({initialSortOrder:{type:String,default:"asc",validator:e=>!e||["asc","desc"].includes(e)},sortBy:{type:Array,default:()=>[]},customKeySort:Object,multiSort:{type:[Boolean,Object],default:!1},mustSort:Boolean},"DataTable-sort"),Ud=Symbol.for("vuetify:data-table-sort")
function Gd(e){const a=t.toRef(()=>e.initialSortOrder),l=la(e,"sortBy"),n=t.toRef(()=>e.mustSort)
...
return t.provide(Ud,i),i}function qd(){const e=t.inject(Ud)
if(!e)throw new Error("Missing sort!")
return e}function Xd(e,a,l,n){const o=ma(),r=t.computed(()=>l.value.length?function(e,t,a,l){const n=new Intl.Collator(a,{sensitivity:"accent",usage:"sort"}),o=e.map(e=>[e,l?.transform?l.transform(e):e])
...
return{sortedItems:r}}const Zd=vt({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},returnObject:Boolean},"DataIterator-items")
function Qd(e,t){return{type:"item",value:e.returnObject?t:h(t,e.itemValue),selectable:h(t,e.itemSelectable,!0),raw:t}}function Jd(e){const a=t.computed(()=>function(e,t){const a=[]
for(const l of t)a.push(Qd(e,l))
return a}(e,e.items))
return{items:a}}const ev=vt({search:String,loading:Boolean,...pt(),...Zd(),...Od(),...Yd(),...Rd({itemsPerPage:5}),...Vd(),...xd(),...ns(),...Pa(),...fl({transition:{component:Ya,hideOnLeave:!0}})},"VDataIterator"),tv=wt()({name:"VDataIterator",props:ev(),emits:{"update:modelValue":e=>!0,"update:groupBy":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{slots:l}=a
const n=la(e,"groupBy"),o=t.toRef(()=>e.search),{items:r}=Jd(e),{filteredItems:i}=os(e,r,o,{transform:e=>e.raw}),{initialSortOrder:s,sortBy:u,multiSort:c,mustSort:d}=Gd(e),{page:v,itemsPerPage:p}=Dd(e),{toggleSort:m}=Kd({initialSortOrder:s,sortBy:u,multiSort:c,mustSort:d,page:v}),{sortByWithGroups:f,opened:g,extractRows:h,isGroupOpen:y,toggleGroup:b}=Ed({groupBy:n,sortBy:u}),{sortedItems:V}=Xd(e,i,f,{transform:e=>e.raw}),{flatItems:w}=Td(V,n,g,!1),S=t.toRef(()=>w.value.length),{startIndex:k,stopIndex:x,pageCount:N,prevPage:C,nextPage:E,setItemsPerPage:I,setPage:_}=Fd({page:v,itemsPerPage:p,itemsLength:S}),{paginatedItems:P}=$d({items:w,startIndex:k,stopIndex:x,itemsPerPage:p}),T=t.computed(()=>h(P.value)),{isSelected:A,select:R,selectAll:B,toggleSelect:D}=Wd(e,{allItems:r,currentPage:T}),{isExpanded:F,toggleExpand:$}=Sd(e)
Ad({page:v,itemsPerPage:p,sortBy:u,groupBy:n,search:o})
const M=t.computed(()=>({page:v.value,itemsPerPage:p.value,sortBy:u.value,pageCount:N.value,toggleSort:m,prevPage:C,nextPage:E,setPage:_,setItemsPerPage:I,isSelected:A,select:R,selectAll:B,toggleSelect:D,isExpanded:F,toggleExpand:$,isGroupOpen:y,toggleGroup:b,items:T.value,itemsCount:i.value.length,groupedItems:P.value}))
...
return Bt(()=>{const a=lv.filterProps(e)
return t.createElementVNode("div",{class:"v-data-table-footer"},[l.prepend?.(),t.createElementVNode("div",{class:"v-data-table-footer__items-per-page"},[t.createElementVNode("span",{"aria-label":n(e.itemsPerPageText)},[n(e.itemsPerPageText)]),t.createVNode(ts,{items:v.value,itemColor:e.color,modelValue:c.value,"onUpdate:modelValue":e=>d(Number(e)),density:"compact",variant:"outlined",hideDetails:!0},null)]),t.createElementVNode("div",{class:"v-data-table-footer__info"},[t.createElementVNode("div",null,[n(e.pageText,u.value?i.value+1:0,s.value,u.value)])]),t.createElementVNode("div",{class:"v-data-table-footer__pagination"},[t.createVNode(lv,t.mergeProps({modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,density:"comfortable",firstAriaLabel:e.firstPageLabel,lastAriaLabel:e.lastPageLabel,length:r.value,nextAriaLabel:e.nextPageLabel,previousAriaLabel:e.prevPageLabel,rounded:!0,showFirstLastPage:!0,totalVisible:e.showCurrentPage?1:0,variant:"plain"},I(a,["color"])),null)])])}),{}}}),rv=(iv={align:{type:String,default:"start"},fixed:{type:[Boolean,String],default:!1},fixedOffset:[Number,String],fixedEndOffset:[Number,String],height:[Number,String],lastFixed:Boolean,firstFixedEnd:Boolean,noPadding:Boolean,indent:[Number,String],empty:Boolean,tag:String,width:[Number,String],maxWidth:[Number,String],nowrap:Boolean},sv=(e,a)=>{let{slots:l}=a
const n=e.tag??"td",o="string"==typeof e.fixed?e.fixed:e.fixed?"start":"none"
return t.createVNode(n,{class:t.normalizeClass(["v-data-table__td",{"v-data-table-column--fixed":"start"===o,"v-data-table-column--fixed-end":"end"===o,"v-data-table-column--last-fixed":e.lastFixed,"v-data-table-column--first-fixed-end":e.firstFixedEnd,"v-data-table-column--no-padding":e.noPadding,"v-data-table-column--nowrap":e.nowrap,"v-data-table-column--empty":e.empty},`v-data-table-column--align-${e.align}`]),style:{height:b(e.height),width:b(e.width),maxWidth:b(e.maxWidth),left:"start"===o?b(e.fixedOffset||null):void 0,right:"end"===o?b(e.fixedEndOffset||null):void 0,paddingInlineStart:e.indent?b(e.indent):void 0}},{default:()=>[l.default?.()]})},sv.props=iv,sv)
var iv,sv
const uv=vt({headers:Array},"DataTable-header"),cv=Symbol.for("vuetify:data-table-headers"),dv={title:"",sortable:!1},vv={...dv,width:48}
function pv(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
if(e.children)for(const a of e.children)pv(a,t)
else t.push(e)
return t}function mv(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:new Set
for(const a of e)a.key&&t.add(a.key),a.children&&mv(a.children,t)
return t}function fv(e){if(e.key)return"data-table-group"===e.key?dv:["data-table-expand","data-table-select"].includes(e.key)?vv:void 0}function gv(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
return e.children?Math.max(t,...e.children.map(e=>gv(e,t+1))):t}function hv(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
if(!e)return t
...
return t}function yv(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
if(!e)return t
...
return e}const kv=vt({color:String,disableSort:Boolean,fixedHeader:Boolean,multiSort:Boolean,sortAscIcon:{type:Dt,default:"$sortAsc"},sortDescIcon:{type:Dt,default:"$sortDesc"},headerProps:{type:Object},sticky:Boolean,...Rl(),...Ao(),...cn()},"VDataTableHeaders"),xv=wt()({name:"VDataTableHeaders",props:kv(),setup(e,a){let{slots:l}=a
const{t:n}=ma(),{toggleSort:o,sortBy:r,isSorted:i}=qd(),{someSelected:s,allSelected:u,selectAll:c,showSelectAll:d}=Hd(),{columns:v,headers:p}=Sv(),{loaderClasses:m}=dn(e)
...
return a?"asc"===a.order?e.sortAscIcon:e.sortDescIcon:e.sortAscIcon}const{backgroundColorClasses:h,backgroundColorStyles:y}=dl(()=>e.color),{displayClasses:V,mobile:w}=Ro(e),S=t.computed(()=>({headers:p.value,columns:v.value,toggleSort:o,isSorted:i,sortBy:r.value,someSelected:s.value,allSelected:u.value,selectAll:c,getSortIcon:g})),k=t.computed(()=>["v-data-table__th",{"v-data-table__th--sticky":e.sticky||e.fixedHeader},V.value,m.value]),x=a=>{let{column:n,x:v,y:p}=a
...
return l["data-table-group"]?.({item:e.item,count:d.value.length,props:{icon:a,onClick:r}})??t.createVNode(rv,{class:"v-data-table-group-header-row__column",colspan:v.value},{default:()=>[t.createVNode(Mn,{size:"small",variant:"text",icon:a,onClick:r},null),t.createElementVNode("span",null,[e.item.value]),t.createElementVNode("span",null,[t.createTextVNode("("),d.value.length,t.createTextVNode(")")])]})}if("data-table-select"===a.key){const a=i(d.value),n=s(d.value)&&!a,o=e=>u(d.value,e)
return l["data-table-select"]?.({props:{modelValue:a,indeterminate:n,"onUpdate:modelValue":o}})??t.createVNode(rv,{class:"v-data-table__td--select-row",noPadding:!0},{default:()=>[t.createVNode(oo,{density:e.density,modelValue:a,indeterminate:n,"onUpdate:modelValue":o},null)]})}return""})])}}),Ev=vt({color:String,index:Number,item:Object,cellProps:[Object,Function],collapseIcon:{type:Dt,default:"$collapse"},expandIcon:{type:Dt,default:"$expand"},onClick:Z(),onContextmenu:Z(),onDblclick:Z(),...Rl(),...Ao()},"VDataTableRow"),Iv=wt()({name:"VDataTableRow",props:Ev(),setup(e,a){let{slots:l}=a
const{displayClasses:n,mobile:o}=Ro(e,"v-data-table__tr"),{isSelected:r,toggleSelect:i,someSelected:s,allSelected:u,selectAll:c}=Hd(),{isExpanded:d,toggleExpand:v}=kd(),{toggleSort:p,sortBy:m,isSorted:f}=qd(),{columns:h}=Sv()
...
return t.createVNode(rv,t.mergeProps({align:a.align,indent:a.intent,class:{"v-data-table__td--expanded-row":"data-table-expand"===a.key,"v-data-table__td--select-row":"data-table-select"===a.key},fixed:a.fixed,fixedOffset:a.fixedOffset,fixedEndOffset:a.fixedEndOffset,lastFixed:a.lastFixed,firstFixedEnd:a.firstFixedEnd,maxWidth:o.value?void 0:a.maxWidth,noPadding:x,empty:N,nowrap:a.nowrap,width:o.value?void 0:a.width},S,k),{default:()=>{if("data-table-select"===a.key)return l["item.data-table-select"]?.({...V,props:{color:e.color,disabled:!h.selectable,modelValue:r([h]),onClick:t.withModifiers(()=>i(h),["stop"])}})??t.createVNode(oo,{color:e.color,disabled:!h.selectable,density:e.density,modelValue:r([h]),onClick:t.withModifiers(t=>i(h,e.index,t),["stop"])},null)
...
return o.value?t.createElementVNode(t.Fragment,null,[t.createElementVNode("div",{class:"v-data-table__td-title"},[l[b]?.(w)??a.title]),t.createElementVNode("div",{class:"v-data-table__td-value"},[l[y]?.(V)??n])]):n}})})]))}}),_v=vt({color:String,loading:[Boolean,String],loadingText:{type:String,default:"$vuetify.dataIterator.loadingText"},hideNoData:Boolean,items:{type:Array,default:()=>[]},noDataText:{type:String,default:"$vuetify.noDataText"},rowProps:[Object,Function],cellProps:[Object,Function],...C(Ev(),["collapseIcon","expandIcon","density"]),...C(Nv(),["groupCollapseIcon","groupExpandIcon","density"]),...Ao()},"VDataTableRows"),Pv=wt()({name:"VDataTableRows",inheritAttrs:!1,props:_v(),setup(e,a){let{attrs:l,slots:n}=a
const{columns:o}=Sv(),{expandOnClick:r,toggleExpand:i,isExpanded:s}=kd(),{isSelected:u,toggleSelect:c}=Hd(),{toggleGroup:d,isGroupOpen:v}=Id(),{t:p}=ma(),{mobile:m}=Ro(e)
...
return n["group-header"]?n["group-header"](e):t.createVNode(Cv,t.mergeProps({key:`group-header_${p.id}`,item:p},_t(l,":groupHeader",()=>e),a),n)}if("group-summary"===p.type){const e={index:f,item:p,columns:o.value,toggleGroup:d}
...
return t.createElementVNode(t.Fragment,{key:h.props.key},[n.item?n.item(h):t.createVNode(Iv,h.props,n),s(p)&&n["expanded-row"]?.(g)])})]):t.createElementVNode("tr",{class:"v-data-table-rows-no-data",key:"no-data"},[t.createElementVNode("td",{colspan:o.value.length},[n["no-data"]?.()??p(e.noDataText)])]):t.createElementVNode("tr",{class:"v-data-table-rows-loading",key:"loading"},[t.createElementVNode("td",{colspan:o.value.length},[n.loading?.()??p(e.loadingText)])])}),{}}}),Tv=vt({fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,striped:{type:String,default:null,validator:e=>["even","odd"].includes(e)},...pt(),...Rl(),...Pa(),...ya()},"VTable"),Av=wt()({name:"VTable",props:Tv(),setup(e,a){let{slots:l,emit:n}=a
const{themeClasses:o}=Ca(e),{densityClasses:r}=Bl(e)
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-table",{"v-table--fixed-height":!!e.height,"v-table--fixed-header":e.fixedHeader,"v-table--fixed-footer":e.fixedFooter,"v-table--has-top":!!l.top,"v-table--has-bottom":!!l.bottom,"v-table--hover":e.hover,"v-table--striped-even":"even"===e.striped,"v-table--striped-odd":"odd"===e.striped},o.value,r.value,e.class]),style:t.normalizeStyle(e.style)},{default:()=>[l.top?.(),l.default?t.createElementVNode("div",{class:"v-table__wrapper",style:{height:b(e.height)}},[t.createElementVNode("table",null,[l.default()])]):l.wrapper?.(),l.bottom?.()]})),{}}}),Rv=vt({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},rowProps:[Object,Function],cellProps:[Object,Function],returnObject:Boolean},"DataTable-items")
function Bv(e,t,a){return t.map((t,l)=>function(e,t,a,l){const n=e.returnObject?t:h(t,e.itemValue),o=h(t,e.itemSelectable,!0),r=l.reduce((e,a)=>(null!=a.key&&(e[a.key]=h(t,a.value)),e),{})
return{type:"item",key:e.returnObject?h(t,e.itemValue):n,index:a,value:n,selectable:o,columns:r,raw:t}}(e,t,l,a))}function Dv(e,a){return{items:t.computed(()=>Bv(e,e.items,a.value))}}const Fv=vt({..._v(),hideDefaultBody:Boolean,hideDefaultFooter:Boolean,hideDefaultHeader:Boolean,width:[String,Number],search:String,...Vd(),...xd(),...uv(),...Rv(),...Od(),...Yd(),...I(kv(),["multiSort"]),...Tv()},"DataTable"),$v=vt({...Rd(),...Fv(),...ns(),...nv()},"VDataTable"),Mv=wt()({name:"VDataTable",props:$v(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
const{groupBy:o}=Cd(e),{initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u}=Gd(e),{page:c,itemsPerPage:d}=Dd(e),{disableSort:v}=t.toRefs(e),{columns:p,headers:m,sortFunctions:f,sortRawFunctions:g,filterFunctions:h}=wv(e,{groupBy:o,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:y}=Dv(e,p),b=t.toRef(()=>e.search),{filteredItems:V}=os(e,y,b,{transform:e=>e.columns,customKeyFilter:h}),{toggleSort:w}=Kd({initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u,page:c}),{sortByWithGroups:S,opened:k,extractRows:x,isGroupOpen:N,toggleGroup:C}=Ed({groupBy:o,sortBy:i,disableSort:v}),{sortedItems:E}=Xd(e,V,S,{transform:e=>({...e.raw,...e.columns}),sortFunctions:f,sortRawFunctions:g}),{flatItems:_}=Td(E,o,k,()=>!!n["group-summary"]),P=t.computed(()=>_.value.length),{startIndex:T,stopIndex:A,pageCount:R,setItemsPerPage:B}=Fd({page:c,itemsPerPage:d,itemsLength:P}),{paginatedItems:D}=$d({items:_,startIndex:T,stopIndex:A,itemsPerPage:d}),F=t.computed(()=>x(D.value)),{isSelected:$,select:M,selectAll:z,toggleSelect:L,someSelected:O,allSelected:j}=Wd(e,{allItems:y,currentPage:F}),{isExpanded:W,toggleExpand:H}=Sd(e)
Ad({page:c,itemsPerPage:d,sortBy:i,groupBy:o,search:b}),yt({VDataTableRows:{hideNoData:t.toRef(()=>e.hideNoData),noDataText:t.toRef(()=>e.noDataText),loading:t.toRef(()=>e.loading),loadingText:t.toRef(()=>e.loadingText)}})
...
return Bt(()=>{const a=ov.filterProps(e),o=xv.filterProps(I(e,["multiSort"])),r=Pv.filterProps(e),i=Av.filterProps(e)
return t.createVNode(Av,t.mergeProps({class:["v-data-table",{"v-data-table--show-select":e.showSelect,"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>n.top?.(Y.value),default:()=>n.default?n.default(Y.value):t.createElementVNode(t.Fragment,null,[n.colgroup?.(Y.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead"},[t.createVNode(xv,t.mergeProps(o,{multiSort:!!e.multiSort}),n)]),n.thead?.(Y.value),!e.hideDefaultBody&&t.createElementVNode("tbody",null,[n["body.prepend"]?.(Y.value),n.body?n.body(Y.value):t.createVNode(Pv,t.mergeProps(l,r,{items:D.value}),n),n["body.append"]?.(Y.value)]),n.tbody?.(Y.value),n.tfoot?.(Y.value)]),bottom:()=>n.bottom?n.bottom(Y.value):!e.hideDefaultFooter&&t.createElementVNode(t.Fragment,null,[t.createVNode(er,null,null),t.createVNode(ov,a,{prepend:n["footer.prepend"]})])})}),{}}}),zv=vt({...I(Fv(),["hideDefaultFooter"]),...xd(),...Ui(),...ns()},"VDataTableVirtual"),Lv=wt()({name:"VDataTableVirtual",props:zv(),emits:{"update:modelValue":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
const{groupBy:o}=Cd(e),{initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u}=Gd(e),{disableSort:c}=t.toRefs(e),{columns:d,headers:v,filterFunctions:p,sortFunctions:m,sortRawFunctions:f}=wv(e,{groupBy:o,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:g}=Dv(e,d),h=t.toRef(()=>e.search),{filteredItems:y}=os(e,g,h,{transform:e=>e.columns,customKeyFilter:p}),{toggleSort:V}=Kd({initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u}),{sortByWithGroups:w,opened:S,extractRows:k,isGroupOpen:x,toggleGroup:N}=Ed({groupBy:o,sortBy:i,disableSort:c}),{sortedItems:C}=Xd(e,y,w,{transform:e=>({...e.raw,...e.columns}),sortFunctions:m,sortRawFunctions:f}),{flatItems:E}=Td(C,o,S,()=>!!n["group-summary"]),_=t.computed(()=>k(E.value)),{isSelected:P,select:T,selectAll:A,toggleSelect:R,someSelected:B,allSelected:D}=Wd(e,{allItems:_,currentPage:_}),{isExpanded:F,toggleExpand:$}=Sd(e),{containerRef:M,markerRef:z,paddingTop:L,paddingBottom:O,computedItems:j,handleItemResize:W,handleScroll:H,handleScrollend:Y,calculateVisibleItems:U,scrollToIndex:G}=Gi(e,E),K=t.computed(()=>j.value.map(e=>e.raw))
Ad({sortBy:i,page:t.shallowRef(1),itemsPerPage:t.shallowRef(-1),groupBy:o,search:h}),yt({VDataTableRows:{hideNoData:t.toRef(()=>e.hideNoData),noDataText:t.toRef(()=>e.noDataText),loading:t.toRef(()=>e.loading),loadingText:t.toRef(()=>e.loadingText)}})
const q=t.computed(()=>({sortBy:i.value,toggleSort:V,someSelected:B.value,allSelected:D.value,isSelected:P,select:T,selectAll:A,toggleSelect:R,isExpanded:F,toggleExpand:$,isGroupOpen:x,toggleGroup:N,items:_.value.map(e=>e.raw),internalItems:_.value,groupedItems:E.value,columns:d.value,headers:v.value}))
return Bt(()=>{const a=xv.filterProps(I(e,["multiSort"])),o=Pv.filterProps(e),r=Av.filterProps(e)
return t.createVNode(Av,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},r,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>n.top?.(q.value),wrapper:()=>t.createElementVNode("div",{ref:M,onScrollPassive:H,onScrollend:Y,class:"v-table__wrapper",style:{height:b(e.height)}},[t.createElementVNode("table",null,[n.colgroup?.(q.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead"},[t.createVNode(xv,t.mergeProps(a,{multiSort:!!e.multiSort}),n)]),n.thead?.(q.value),!e.hideDefaultBody&&t.createElementVNode("tbody",{key:"tbody"},[t.createElementVNode("tr",{ref:z,style:{height:b(L.value),border:0}},[t.createElementVNode("td",{colspan:d.value.length,style:{height:0,border:0}},null)]),n["body.prepend"]?.(q.value),t.createVNode(Pv,t.mergeProps(l,o,{items:K.value}),{...n,item:e=>t.createVNode(Yi,{key:e.internalItem.index,renderless:!0,"onUpdate:height":t=>W(e.internalItem.index,t)},{default:a=>{let{itemRef:l}=a
return n.item?.({...e,itemRef:l})??t.createVNode(Iv,t.mergeProps(e.props,{ref:l,key:e.internalItem.index,index:e.internalItem.index}),n)}})}),n["body.append"]?.(q.value),t.createElementVNode("tr",{style:{height:b(O.value),border:0}},[t.createElementVNode("td",{colspan:d.value.length,style:{height:0,border:0}},null)])]),n.tbody?.(q.value),n.tfoot?.(q.value)])]),bottom:()=>n.bottom?.(q.value)})}),{calculateVisibleItems:U,scrollToIndex:G}}}),Ov=vt({itemsLength:{type:[Number,String],required:!0},...Rd(),...Fv(),...nv()},"VDataTableServer"),jv=wt()({name:"VDataTableServer",props:Ov(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:groupBy":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
const{groupBy:o}=Cd(e),{initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u}=Gd(e),{page:c,itemsPerPage:d}=Dd(e),{disableSort:v}=t.toRefs(e),p=t.computed(()=>parseInt(e.itemsLength,10)),{columns:m,headers:f}=wv(e,{groupBy:o,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:g}=Dv(e,m),{toggleSort:h}=Kd({initialSortOrder:r,sortBy:i,multiSort:s,mustSort:u,page:c}),{opened:y,isGroupOpen:b,toggleGroup:V,extractRows:w}=Ed({groupBy:o,sortBy:i,disableSort:v}),{pageCount:S,setItemsPerPage:k}=Fd({page:c,itemsPerPage:d,itemsLength:p}),{flatItems:x}=Td(g,o,y,()=>!!n["group-summary"]),{isSelected:N,select:C,selectAll:E,toggleSelect:_,someSelected:P,allSelected:T}=Wd(e,{allItems:g,currentPage:g}),{isExpanded:A,toggleExpand:R}=Sd(e),B=t.computed(()=>w(g.value))
Ad({page:c,itemsPerPage:d,sortBy:i,groupBy:o,search:t.toRef(()=>e.search)}),t.provide("v-data-table",{toggleSort:h,sortBy:i}),yt({VDataTableRows:{hideNoData:t.toRef(()=>e.hideNoData),noDataText:t.toRef(()=>e.noDataText),loading:t.toRef(()=>e.loading),loadingText:t.toRef(()=>e.loadingText)}})
const D=t.computed(()=>({page:c.value,itemsPerPage:d.value,sortBy:i.value,pageCount:S.value,toggleSort:h,setItemsPerPage:k,someSelected:P.value,allSelected:T.value,isSelected:N,select:C,selectAll:E,toggleSelect:_,isExpanded:A,toggleExpand:R,isGroupOpen:b,toggleGroup:V,items:B.value.map(e=>e.raw),internalItems:B.value,groupedItems:x.value,columns:m.value,headers:f.value}))
Bt(()=>{const a=ov.filterProps(e),o=xv.filterProps(I(e,["multiSort"])),r=Pv.filterProps(e),i=Av.filterProps(e)
return t.createVNode(Av,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>n.top?.(D.value),default:()=>n.default?n.default(D.value):t.createElementVNode(t.Fragment,null,[n.colgroup?.(D.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead",class:"v-data-table__thead",role:"rowgroup"},[t.createVNode(xv,t.mergeProps(o,{multiSort:!!e.multiSort}),n)]),n.thead?.(D.value),!e.hideDefaultBody&&t.createElementVNode("tbody",{class:"v-data-table__tbody",role:"rowgroup"},[n["body.prepend"]?.(D.value),n.body?n.body(D.value):t.createVNode(Pv,t.mergeProps(l,r,{items:x.value}),n),n["body.append"]?.(D.value)]),n.tbody?.(D.value),n.tfoot?.(D.value)]),bottom:()=>n.bottom?n.bottom(D.value):!e.hideDefaultFooter&&t.createElementVNode(t.Fragment,null,[t.createVNode(er,null,null),t.createVNode(ov,a,{prepend:n["footer.prepend"]})])})})}}),Wv=vt({fluid:{type:Boolean,default:!1},...pt(),...ol(),...Pa()},"VContainer"),Hv=wt()({name:"VContainer",props:Wv(),setup(e,a){let{slots:l}=a
const{rtlClasses:n}=ga(),{dimensionStyles:o}=rl(e)
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-container",{"v-container--fluid":e.fluid},n.value,e.class]),style:t.normalizeStyle([o.value,e.style])},l)),{}}}),Yv=No.reduce((e,t)=>(e[t]={type:[Boolean,String,Number],default:!1},e),{}),Uv=No.reduce((e,a)=>(e["offset"+t.capitalize(a)]={type:[String,Number],default:null},e),{}),Gv=No.reduce((e,a)=>(e["order"+t.capitalize(a)]={type:[String,Number],default:null},e),{}),Kv={col:Object.keys(Yv),offset:Object.keys(Uv),order:Object.keys(Gv)}
function qv(e,t,a){let l=e
if(null!=a&&!1!==a){if(t){l+=`-${t.replace(e,"")}`}return"col"===e&&(l="v-"+l),"col"!==e||""!==a&&!0!==a?(l+=`-${a}`,l.toLowerCase()):l.toLowerCase()}}const Xv=["auto","start","end","center","baseline","stretch"],Zv=vt({cols:{type:[Boolean,String,Number],default:!1},...Yv,offset:{type:[String,Number],default:null},...Uv,order:{type:[String,Number],default:null},...Gv,alignSelf:{type:String,default:null,validator:e=>Xv.includes(e)},...pt(),...Pa()},"VCol"),Qv=wt()({name:"VCol",props:Zv(),setup(e,a){let{slots:l}=a
const n=t.computed(()=>{const t=[]
let a
for(a in Kv)Kv[a].forEach(l=>{const n=e[l],o=qv(a,l,n)
o&&t.push(o)})
const l=t.some(e=>e.startsWith("v-col-"))
return t.push({"v-col":!l||!e.cols,[`v-col-${e.cols}`]:e.cols,[`offset-${e.offset}`]:e.offset,[`order-${e.order}`]:e.order,[`align-self-${e.alignSelf}`]:e.alignSelf}),t})
return()=>t.h(e.tag,{class:[n.value,e.class],style:e.style},l.default?.())}}),Jv=["start","end","center"],ep=["space-between","space-around","space-evenly"]
function tp(e,a){return No.reduce((l,n)=>(l[e+t.capitalize(n)]=a(),l),{})}const ap=[...Jv,"baseline","stretch"],lp=e=>ap.includes(e),np=tp("align",()=>({type:String,default:null,validator:lp})),op=[...Jv,...ep],rp=e=>op.includes(e),ip=tp("justify",()=>({type:String,default:null,validator:rp})),sp=[...Jv,...ep,"stretch"],up=e=>sp.includes(e),cp=tp("alignContent",()=>({type:String,default:null,validator:up})),dp={align:Object.keys(np),justify:Object.keys(ip),alignContent:Object.keys(cp)},vp={align:"align",justify:"justify",alignContent:"align-content"}
function pp(e,t,a){let l=vp[e]
if(null!=a){if(t){l+=`-${t.replace(e,"")}`}return l+=`-${a}`,l.toLowerCase()}}const mp=vt({dense:Boolean,noGutters:Boolean,align:{type:String,default:null,validator:lp},...np,justify:{type:String,default:null,validator:rp},...ip,alignContent:{type:String,default:null,validator:up},...cp,...pt(),...Pa()},"VRow"),fp=wt()({name:"VRow",props:mp(),setup(e,a){let{slots:l}=a
const n=t.computed(()=>{const t=[]
let a
for(a in dp)dp[a].forEach(l=>{const n=e[l],o=pp(a,l,n)
o&&t.push(o)})
return t.push({"v-row--no-gutters":e.noGutters,"v-row--dense":e.dense,[`align-${e.align}`]:e.align,[`justify-${e.justify}`]:e.justify,[`align-content-${e.alignContent}`]:e.alignContent}),t})
return()=>t.h(e.tag,{class:["v-row",n.value,e.class],style:e.style},l.default?.())}}),gp=St("v-spacer","div","VSpacer"),hp=vt({active:{type:[String,Array],default:void 0},controlHeight:[Number,String],controlVariant:{type:String,default:"docked"},noMonthPicker:Boolean,disabled:{type:[Boolean,String,Array],default:null},nextIcon:{type:Dt,default:"$next"},prevIcon:{type:Dt,default:"$prev"},modeIcon:{type:Dt,default:"$subgroup"},text:String,monthText:String,yearText:String,viewMode:{type:String,default:"month"}},"VDatePickerControls"),yp=wt()({name:"VDatePickerControls",props:hp(),emits:{"click:year":()=>!0,"click:month":()=>!0,"click:prev":()=>!0,"click:next":()=>!0,"click:prev-year":()=>!0,"click:next-year":()=>!0},setup(e,a){let{emit:l,slots:n}=a
...
return t.createElementVNode("div",{class:t.normalizeClass(["v-date-picker-header",{"v-date-picker-header--clickable":!!e.onClick},o.value]),style:t.normalizeStyle(r.value),onClick:i},[n.prepend&&t.createElementVNode("div",{key:"prepend",class:"v-date-picker-header__prepend"},[n.prepend()]),a&&t.createVNode(gl,{key:"content",name:e.transition},{default:()=>[t.createElementVNode("div",{key:e.header,class:"v-date-picker-header__content"},[n.default?.()??e.header])]}),l&&t.createElementVNode("div",{class:"v-date-picker-header__append"},[n.append?t.createVNode(nl,{key:"append-defaults",disabled:!e.appendIcon,defaults:{VBtn:{icon:e.appendIcon,variant:"text"}}},{default:()=>[n.append?.()]}):t.createVNode(Mn,{key:"append-btn",icon:e.appendIcon,variant:"text",onClick:s},null)])])}),{}}}),wp=vt({allowedDates:[Array,Function],disabled:{type:Boolean,default:null},displayValue:null,modelValue:Array,month:[Number,String],max:null,min:null,showAdjacentMonths:Boolean,year:[Number,String],weekdays:{type:Array,default:()=>[0,1,2,3,4,5,6]},weeksInMonth:{type:String,default:"dynamic"},firstDayOfWeek:{type:[Number,String],default:void 0},firstDayOfYear:{type:[Number,String],default:void 0},weekdayFormat:String},"calendar")
function Sp(e){const a=Lu(),l=t.computed(()=>{if(!e.min)return null
...
return{minDate:l,maxDate:n,clampDate:function(e){return l.value&&a.isBefore(e,l.value)?l.value:n.value&&a.isAfter(e,n.value)?n.value:e},isInAllowedRange:function(e){return(!l.value||a.isAfter(e,l.value))&&(!n.value||a.isBefore(e,n.value))}}}const kp=vt({color:String,hideWeekdays:Boolean,multiple:[Boolean,Number,String],showWeek:Boolean,transition:{type:String,default:"picker-transition"},reverseTransition:{type:String,default:"picker-reverse-transition"},events:{type:[Array,Function,Object],default:()=>null},eventColor:{type:[Array,Function,Object,String],default:()=>null},...I(wp(),["displayValue"])},"VDatePickerMonth"),xp=wt()({name:"VDatePickerMonth",props:kp(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0},setup(e,a){let{emit:l,slots:n}=a
const o=t.ref(),{t:r}=ma(),{daysInMonth:i,model:s,weekNumbers:u,weekdayLabels:c}=function(e){const a=Lu(),l=la(e,"modelValue",[],e=>B(e).map(e=>a.date(e))),n=t.computed(()=>e.displayValue?a.date(e.displayValue):l.value.length>0?a.date(l.value[0]):e.min?a.date(e.min):Array.isArray(e.allowedDates)?a.date(e.allowedDates[0]):a.date()),o=la(e,"year",void 0,e=>{const t=null!=e?Number(e):a.getYear(n.value)
...
return u(l,a.date())}),d=t.computed(()=>u(s.value.flat(),a.date())),v=t.computed(()=>s.value.map(t=>t.length?a.getWeek(t[0],e.firstDayOfWeek,e.firstDayOfYear):null)),{minDate:p,maxDate:m}=Sp(e)
...
d.isBefore(t,v.value)?(p.value=d.endOfDay(v.value),v.value=t):p.value=d.endOfDay(t),s.value=function(e,t,a){const l=Mu(e,t,a),n=[t]
...
return g.value&&!a.isSelected&&(a.isDisabled=!0),t.createElementVNode("div",{class:t.normalizeClass(["v-date-picker-month__day",{"v-date-picker-month__day--adjacent":a.isAdjacent,"v-date-picker-month__day--hide-adjacent":a.isHidden,"v-date-picker-month__day--selected":a.isSelected,"v-date-picker-month__day--week-end":a.isWeekEnd,"v-date-picker-month__day--week-start":a.isWeekStart}]),"data-v-date":a.isDisabled?void 0:a.isoDate},[(e.showAdjacentMonths||!a.isAdjacent)&&(n.day?.(o)??t.createVNode(Mn,o.props,{default:()=>[a.localized,V(a.isoDate)]}))])})])]})]))}}),Np=vt({color:String,height:[String,Number],min:null,max:null,modelValue:Number,year:Number,allowedMonths:[Array,Function]},"VDatePickerMonths"),Cp=wt()({name:"VDatePickerMonths",props:Np(),emits:{"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:n}=a
const o=Lu(),r=la(e,"modelValue"),i=t.computed(()=>{let t=o.startOfYear(o.date())
...
r.value=e}(o)}
return n.month?.({month:a,i:o,props:i})??t.createVNode(Mn,t.mergeProps({key:"month"},i),null)})])])),{}}}),Ep=vt({color:String,height:[String,Number],min:null,max:null,modelValue:Number,allowedYears:[Array,Function]},"VDatePickerYears"),Ip=wt()({name:"VDatePickerYears",props:Ep(),directives:{vIntersect:yl},emits:{"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:n}=a
const o=Lu(),r=la(e,"modelValue"),i=t.computed(()=>{const t=o.getYear(o.date())
let a=t-100,l=t+52
...
return n.year?.({year:a,i:o,props:i})??t.createVNode(Mn,t.mergeProps({key:"month"},i),null)})])]),[[yl,{handler:u},null,{once:!0}]])),{}}}),_p=vt({header:{type:String,default:"$vuetify.datePicker.header"},headerColor:String,headerDateFormat:{type:String,default:"normalDateWithWeekday"},landscapeHeaderWidth:[Number,String],...hp(),...kp({weeksInMonth:"static"}),...I(Np(),["modelValue"]),...I(Ep(),["modelValue"]),...pd({title:"$vuetify.datePicker.title"}),modelValue:null},"VDatePicker"),Pp=wt()({name:"VDatePicker",props:_p(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0,"update:viewMode":e=>!0},setup(e,a){let{emit:l,slots:n}=a
const o=Lu(),{t:r}=ma(),{rtlClasses:i}=ga(),s=la(e,"modelValue",void 0,e=>B(e).map(e=>o.date(e)),t=>e.multiple?t:t[0]),u=la(e,"viewMode"),{minDate:c,maxDate:d,clampDate:v}=Sp(e),p=t.computed(()=>{const e=o.date(),t=s.value?.[0]?o.date(s.value[0]):v(e)
...
return e.landscape&&3===t.split(" ").length?t.replace(" ","\n"):t}),S=t.toRef(()=>o.parseISO(`${y.value}-${g.value+1}-01`)),k=t.toRef(()=>o.format(S.value,"monthAndYear")),x=t.toRef(()=>o.format(S.value,"monthShort")),N=t.toRef(()=>o.format(S.value,"year")),C=t.toRef(()=>`date-picker-header${V.value?"-reverse":""}-transition`),E=t.computed(()=>{if(e.disabled)return!0
const t=[]
...
o.isAfter(a,d.value)&&t.push("next-month"),o.isAfter(l,d.value)&&t.push("next-year")}}return t}),_=t.computed(()=>e.allowedYears||A),P=t.computed(()=>e.allowedMonths||R)
function T(t,a){const l=e.allowedDates
if("function"!=typeof l)return!0
const n=1+Mu(o,t,a)
for(let e=0;e<n;e++)if(l(o.addDays(t,e)))return!0
return!1}function A(t){if("function"==typeof e.allowedDates){const e=o.parseISO(`${t}-01-01`)
return T(e,o.endOfYear(e))}if(Array.isArray(e.allowedDates)&&e.allowedDates.length){for(const a of e.allowedDates)if(o.getYear(o.date(a))===t)return!0
...
return T(a,o.endOfMonth(a))}if(Array.isArray(e.allowedDates)&&e.allowedDates.length){for(const a of e.allowedDates)if(o.getYear(o.date(a))===y.value&&o.getMonth(o.date(a))===t)return!0
return!1}return!0}function D(){g.value<11?g.value++:(y.value++,g.value=0,W()),j()}function F(){g.value>0?g.value--:(y.value--,g.value=11,W()),j()}function $(){if(y.value++,d.value){const e=o.parseISO(`${y.value}-${g.value+1}-01`)
o.isAfter(e,d.value)&&(g.value=o.getMonth(d.value))}W()}function M(){if(y.value--,c.value){const e=o.endOfMonth(o.parseISO(`${y.value}-${g.value+1}-01`))
o.isAfter(c.value,e)&&(g.value=o.getMonth(c.value))}W()}function z(){u.value="month"}function L(){u.value="months"===u.value?"month":"months"}function O(){u.value="year"===u.value?"month":"year"}function j(){"months"===u.value&&L()}function W(){"year"===u.value&&O()}return t.watch(s,(e,t)=>{const a=B(t),l=B(e)
if(!l.length)return
const n=o.date(a[a.length-1]),r=o.date(l[l.length-1]),i=o.getMonth(r),s=o.getYear(r)
i!==g.value&&(g.value=i,j()),s!==y.value&&(y.value=s,W()),V.value=o.isBefore(n,r)}),Bt(()=>{const a=md.filterProps(e),l=I(yp.filterProps(e),["viewMode"]),o=Vp.filterProps(e),v=xp.filterProps(e),p=I(Cp.filterProps(e),["modelValue"]),f=I(Ip.filterProps(e),["modelValue"]),h={color:m.value,header:w.value,transition:C.value}
return t.createVNode(md,t.mergeProps(a,{color:m.value,class:["v-date-picker",`v-date-picker--${u.value}`,{"v-date-picker--show-week":e.showWeek},i.value,e.class],style:[{"--v-date-picker-landscape-header-width":b(e.landscapeHeaderWidth)},e.style]}),{title:()=>n.title?.()??t.createElementVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>n.header?t.createVNode(nl,{defaults:{VDatePickerHeader:{...h}}},{default:()=>[n.header?.(h)]}):t.createVNode(Vp,t.mergeProps({key:"header"},o,h,{onClick:"month"!==u.value?z:void 0}),{prepend:n.prepend,append:n.append}),default:()=>t.createElementVNode(t.Fragment,null,[t.createVNode(yp,t.mergeProps(l,{disabled:E.value,viewMode:u.value,text:k.value,monthText:x.value,yearText:N.value,"onClick:next":D,"onClick:prev":F,"onClick:nextYear":$,"onClick:prevYear":M,"onClick:month":L,"onClick:year":O}),{default:n.controls}),t.createVNode(Ya,{hideOnLeave:!0},{default:()=>["months"===u.value?t.createVNode(Cp,t.mergeProps({key:"date-picker-months"},p,{modelValue:g.value,"onUpdate:modelValue":[e=>g.value=e,j],min:c.value,max:d.value,year:y.value,allowedMonths:P.value}),{month:n.month}):"year"===u.value?t.createVNode(Ip,t.mergeProps({key:"date-picker-years"},f,{modelValue:y.value,"onUpdate:modelValue":[e=>y.value=e,W],min:c.value,max:d.value,allowedYears:_.value}),{year:n.year}):t.createVNode(xp,t.mergeProps({key:"date-picker-month"},v,{modelValue:s.value,"onUpdate:modelValue":e=>s.value=e,month:g.value,"onUpdate:month":[e=>g.value=e,j],year:y.value,"onUpdate:year":[e=>y.value=e,W],min:c.value,max:d.value}),{day:n.day})]})]),actions:n.actions})}),{}}}),Tp=vt({actionText:String,bgColor:String,color:String,icon:Dt,image:String,justify:{type:String,default:"center"},headline:String,title:String,text:String,textWidth:{type:[Number,String],default:500},href:String,to:String,...pt(),...ol(),...Xl({size:void 0}),...ya()},"VEmptyState"),Ap=wt()({name:"VEmptyState",props:Tp(),emits:{"click:action":e=>!0},setup(e,a){let{emit:l,slots:n}=a
...
function Yp(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:""
...
for(const a of e)l.push(...await Yp(a,Up(t,a)))
a(l)})}})}function Up(e,t){return t.isDirectory?`${e}/${t.name}`:e}const Gp=vt({filterByType:String},"file-accept")
const Kp=vt({chips:Boolean,counter:Boolean,counterSizeString:{type:String,default:"$vuetify.fileInput.counterSize"},counterString:{type:String,default:"$vuetify.fileInput.counter"},hideInput:Boolean,multiple:Boolean,showSize:{type:[Boolean,Number,String],default:!1,validator:e=>"boolean"==typeof e||[1e3,1024].includes(Number(e))},truncateLength:{type:[Number,String],default:22},...yo({prependIcon:"$file"}),modelValue:{type:[Array,Object],default:e=>e.multiple?[]:null,validator:e=>B(e).every(e=>null!=e&&"object"==typeof e)},...Gp(),...Fi({clearable:!0})},"VFileInput"),qp=wt()({name:"VFileInput",inheritAttrs:!1,props:Kp(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0,rejected:e=>!0},setup(e,a){let{attrs:l,emit:n,slots:o}=a
...
if(a.length)for(const e of a){const a=await Yp(e,Up(".",e))
...
function N(){b.value!==document.activeElement&&b.value?.focus(),u.value||c()}function C(e){b.value?.click()}function E(e){n("mousedown:control",e)}function I(e){b.value?.click(),n("click:control",e)}function _(a){a.stopPropagation(),N(),t.nextTick(()=>{s.value=[],J(e["onClick:clear"],a)})}function P(e){e.preventDefault(),e.stopImmediatePropagation(),S.value=!0}function T(e){e.preventDefault(),S.value=!1}async function A(e){if(e.preventDefault(),e.stopImmediatePropagation(),S.value=!1,!b.value||!x(e))return
F(await k(e))}function D(t){if(t.target&&!t.repack)if(e.filterByType)F([...t.target.files])
...
o.repack=!0,b.value.dispatchEvent(o)}return t.watch(s,e=>{(!Array.isArray(e)||!e.length)&&b.value&&(b.value.value="")}),Bt(()=>{const a=!(!o.counter&&!e.counter),n=!(!a&&!o.details),[r,i]=R(l),{modelValue:c,...v}=bo.filterProps(e),k={...$i.filterProps(e),"onClick:clear":_},x=void 0!==l.webkitdirectory&&!1!==l.webkitdirectory,B=l.accept?String(l.accept):void 0,F=x?void 0:e.filterByType??B
return t.createVNode(bo,t.mergeProps({ref:h,modelValue:e.multiple?s.value:s.value[0],class:["v-file-input",{"v-file-input--chips":!!e.chips,"v-file-input--dragging":S.value,"v-file-input--hide":e.hideInput,"v-input--plain-underlined":w.value},e.class],style:e.style,"onClick:prepend":C},r,v,{centerAffix:!w.value,focused:u.value}),{...o,default:a=>{let{id:l,isDisabled:n,isDirty:r,isReadonly:c,isValid:v,hasDetails:g}=a
return t.createVNode($i,t.mergeProps({ref:y,prependIcon:e.prependIcon,onMousedown:E,onClick:I,"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"]},k,{id:l.value,active:V.value||r.value,dirty:r.value||e.dirty,disabled:n.value,focused:u.value,details:g.value,error:!1===v.value,onDragover:P,onDrop:A}),{...o,default:a=>{let{props:{class:l,...r},controlRef:u}=a
return t.createElementVNode(t.Fragment,null,[t.createElementVNode("input",t.mergeProps({ref:e=>b.value=u.value=e,type:"file",accept:F,readonly:c.value,disabled:n.value,multiple:e.multiple,name:e.name,onClick:e=>{e.stopPropagation(),c.value&&e.preventDefault(),N()},onChange:D,onDragleave:T,onFocus:N,onBlur:d},r,i),null),t.createElementVNode("div",{class:t.normalizeClass(l)},[!!s.value?.length&&!e.hideInput&&(o.selection?o.selection({fileNames:f.value,totalBytes:p.value,totalBytesReadable:m.value}):e.chips?f.value.map(e=>t.createVNode(Zo,{key:e,size:"small",text:e},null)):f.value.join(", "))])])}})},details:n?l=>t.createElementVNode(t.Fragment,null,[o.details?.(l),a&&t.createElementVNode(t.Fragment,null,[t.createElementVNode("span",null,null),t.createVNode(Ai,{active:!!s.value?.length,value:g.value,disabled:e.disabled},o.counter)])]):void 0})}),So({},h,y,b)}}),Xp=vt({app:Boolean,color:String,height:{type:[Number,String],default:"auto"},...wl(),...pt(),...kl(),...Qt(),...pl(),...Pa({tag:"footer"}),...ya()},"VFooter"),Zp=wt()({name:"VFooter",props:Xp(),setup(e,a){let{slots:l}=a
const n=t.ref(),{themeClasses:o}=Ca(e),{backgroundColorClasses:r,backgroundColorStyles:i}=dl(()=>e.color),{borderClasses:s}=Sl(e),{elevationClasses:u}=xl(e),{roundedClasses:c}=ml(e),d=t.shallowRef(32),{resizeRef:v}=Kt(e=>{e.length&&(d.value=e[0].target.clientHeight)}),p=t.computed(()=>"auto"===e.height?d.value:parseInt(e.height,10))
...
t&&i.value?.submit()}),t.preventDefault()}return Bt(()=>t.createElementVNode("form",{ref:i,class:t.normalizeClass(["v-form",e.class]),style:t.normalizeStyle(e.style),novalidate:!0,onReset:s,onSubmit:u},[n.default?.(r)])),So(r,i)}}),em=vt({disabled:Boolean,modelValue:{type:Boolean,default:null},...ri()},"VHover"),tm=wt()({name:"VHover",props:em(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=la(e,"modelValue"),{runOpenDelay:n,runCloseDelay:o}=ii(e,t=>!e.disabled&&(l.value=t))
return()=>a.default?.({isHovering:l.value,props:{onMouseenter:n,onMouseleave:o}})}}),am=vt({color:String,direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},side:{type:String,default:"end",validator:e=>["start","end","both"].includes(e)},mode:{type:String,default:"intersect",validator:e=>["intersect","manual"].includes(e)},margin:[Number,String],loadMoreText:{type:String,default:"$vuetify.infiniteScroll.loadMore"},emptyText:{type:String,default:"$vuetify.infiniteScroll.empty"},...ol(),...Pa()},"VInfiniteScroll"),lm=Vt({name:"VInfiniteScrollIntersect",props:{side:{type:String,required:!0},rootMargin:String},emits:{intersect:(e,t)=>!0},setup(e,a){let{emit:l}=a
const{intersectionRef:n,isIntersecting:o}=en()
return t.watch(o,async t=>{l("intersect",e.side,t)}),Bt(()=>t.createElementVNode("div",{class:"v-infinite-scroll-intersect",style:{"--v-infinite-margin-size":e.rootMargin},ref:n},[t.createTextVNode(" ")])),{}}}),nm=wt()({name:"VInfiniteScroll",props:am(),emits:{load:e=>!0},setup(e,a){let{slots:l,emit:n}=a
...
return t.createVNode(a,{ref:o,class:t.normalizeClass(["v-infinite-scroll",`v-infinite-scroll--${e.direction}`,{"v-infinite-scroll--start":n,"v-infinite-scroll--end":u}]),style:t.normalizeStyle(V.value)},{default:()=>[t.createElementVNode("div",{class:"v-infinite-scroll__side"},[y("start",r.value)]),n&&c&&t.createVNode(lm,{key:"start",side:"start",onIntersect:f,rootMargin:s.value},null),l.default?.(),u&&c&&t.createVNode(lm,{key:"end",side:"end",onIntersect:f,rootMargin:s.value},null),t.createElementVNode("div",{class:"v-infinite-scroll__side"},[y("end",i.value)])]})}),{reset:function(a){const l=a??e.side
p(l,"ok"),t.nextTick(()=>{"end"!==l&&c(v()-m+d()),"manual"!==e.mode&&t.nextTick(()=>{window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>{"both"===l?(g("start"),g("end")):g(l)})})})})})}}}}),om=Symbol.for("vuetify:v-item-group"),rm=vt({...pt(),...Ol({selectedClass:"v-item--selected"}),...Pa(),...ya()},"VItemGroup"),im=wt()({name:"VItemGroup",props:rm(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:n}=Ca(e),{isSelected:o,select:r,next:i,prev:s,selected:u}=Hl(e,om)
return()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-item-group",n.value,e.class]),style:t.normalizeStyle(e.style)},{default:()=>[l.default?.({isSelected:o,select:r,next:i,prev:s,selected:u.value})]})}}),sm=wt()({name:"VItem",props:jl(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const{isSelected:l,select:n,toggle:o,selectedClass:r,value:i,disabled:s}=Wl(e,om)
return()=>a.default?.({isSelected:l.value,selectedClass:r.value,select:n,toggle:o,value:i.value,disabled:s.value})}}),um=vt({color:String,...wl(),...pt(),...pl(),...Pa({tag:"kbd"}),...ya(),...kl()},"VKbd"),cm=wt()({name:"VKbd",props:um(),setup(e,a){let{slots:l}=a
const{themeClasses:n}=Ca(e),{borderClasses:o}=Sl(e),{roundedClasses:r}=ml(e),{backgroundColorClasses:i,backgroundColorStyles:s}=dl(()=>e.color),{elevationClasses:u}=xl(e)
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-kbd",n.value,i.value,o.value,u.value,r.value,e.class]),style:t.normalizeStyle([s.value,e.style])},l)),{}}}),dm=vt({...pt(),...ol(),...Zt()},"VLayout"),vm=wt()({name:"VLayout",props:dm(),setup(e,a){let{slots:l}=a
const{layoutClasses:n,layoutStyles:o,getLayoutItem:r,items:i,layoutRef:s}=ta(e),{dimensionStyles:u}=rl(e)
return Bt(()=>t.createElementVNode("div",{ref:s,class:t.normalizeClass([n.value,e.class]),style:t.normalizeStyle([u.value,o.value,e.style])},[l.default?.()])),{getLayoutItem:r,items:i}}}),pm=vt({position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...pt(),...Qt()},"VLayoutItem"),mm=wt()({name:"VLayoutItem",props:pm(),setup(e,a){let{slots:l}=a
...
return()=>t.createElementVNode("div",{class:t.normalizeClass(["v-layout-item",e.class]),style:t.normalizeStyle([n.value,e.style])},[l.default?.()])}}),fm=vt({modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...pt(),...ol(),...Pa(),...fl({transition:"fade-transition"})},"VLazy"),gm=wt()({name:"VLazy",directives:{vIntersect:yl},props:fm(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{dimensionStyles:n}=rl(e),o=la(e,"modelValue")
function r(e){o.value||(o.value=e)}return Bt(()=>t.withDirectives(t.createVNode(e.tag,{class:t.normalizeClass(["v-lazy",e.class]),style:t.normalizeStyle([n.value,e.style])},{default:()=>[o.value&&t.createVNode(gl,{transition:e.transition,appear:!0},{default:()=>[l.default?.()]})]}),[[yl,{handler:r,options:e.options},null]])),{}}}),hm=vt({locale:String,fallbackLocale:String,messages:Object,rtl:{type:Boolean,default:void 0},...pt()},"VLocaleProvider"),ym=wt()({name:"VLocaleProvider",props:hm(),setup(e,a){let{slots:l}=a
const{rtlClasses:n}=fa(e)
return Bt(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-locale-provider",n.value,e.class]),style:t.normalizeStyle(e.style)},[l.default?.()])),{}}}),bm=vt({scrollable:Boolean,...pt(),...ol(),...Pa({tag:"main"})},"VMain"),Vm=wt()({name:"VMain",props:bm(),setup(e,a){let{slots:l}=a
...
return a>l&&e>=0?"right":a>l&&e<=0?"left":l>a&&t>=0?"down":l>a&&t<=0?"up":function(){throw new Error}()}}}}}function xm(){throw new Error}const Nm=["start","end","left","right","top","bottom"],Cm=vt({color:String,disableResizeWatcher:Boolean,disableRouteWatcher:Boolean,expandOnHover:Boolean,floating:Boolean,modelValue:{type:Boolean,default:null},permanent:Boolean,rail:{type:Boolean,default:null},railWidth:{type:[Number,String],default:56},scrim:{type:[Boolean,String],default:!0},image:String,temporary:Boolean,persistent:Boolean,touchless:Boolean,width:{type:[Number,String],default:256},location:{type:String,default:"start",validator:e=>Nm.includes(e)},sticky:Boolean,...wl(),...pt(),...ri(),...Ao({mobile:null}),...kl(),...Qt(),...pl(),...I(di(),["disableInitialFocus"]),...Pa({tag:"nav"}),...ya()},"VNavigationDrawer"),Em=wt()({name:"VNavigationDrawer",props:Cm(),emits:{"update:modelValue":e=>!0,"update:rail":e=>!0},setup(e,a){let{attrs:l,emit:n,slots:o}=a
const{isRtl:r}=ga(),{themeClasses:i}=Ca(e),{borderClasses:s}=Sl(e),{backgroundColorClasses:u,backgroundColorStyles:c}=dl(()=>e.color),{elevationClasses:d}=xl(e),{displayClasses:v,mobile:p}=Ro(e),{roundedClasses:m}=ml(e),f=gn(),g=la(e,"modelValue",null,e=>!!e),{ssrBootStyles:h}=_l(),{scopeId:y}=yi(),V=t.ref(),w=t.shallowRef(!1),{runOpenDelay:S,runCloseDelay:k}=ii(e,e=>{w.value=e}),x=t.computed(()=>e.rail&&e.expandOnHover&&w.value?Number(e.width):Number(e.rail?e.railWidth:e.width)),N=t.computed(()=>ge(e.location,r.value)),C=t.toRef(()=>e.persistent),E=t.computed(()=>!e.permanent&&(p.value||e.temporary)),I=t.computed(()=>e.sticky&&!E.value&&"bottom"!==N.value)
...
const s=t.computed(()=>["left","right"].includes(i.value)),{addMovement:u,endTouch:c,getVelocity:d}=km()
let v=!1
const p=t.shallowRef(!1),m=t.shallowRef(0),f=t.shallowRef(0)
let g
function h(e,t){return("left"===i.value?e:"right"===i.value?document.documentElement.clientWidth-e:"top"===i.value?e:"bottom"===i.value?document.documentElement.clientHeight-e:xm())-(t?o.value:0)}function y(e){let t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
const a="left"===i.value?(e-f.value)/o.value:"right"===i.value?(document.documentElement.clientWidth-e-f.value)/o.value:"top"===i.value?(e-f.value)/o.value:"bottom"===i.value?(document.documentElement.clientHeight-e-f.value)/o.value:xm()
return t?F(a):a}function b(e){if(r.value)return
const t=e.changedTouches[0].clientX,a=e.changedTouches[0].clientY,d="left"===i.value?t<25:"right"===i.value?t>document.documentElement.clientWidth-25:"top"===i.value?a<25:"bottom"===i.value?a>document.documentElement.clientHeight-25:xm(),p=l.value&&("left"===i.value?t<o.value:"right"===i.value?t>document.documentElement.clientWidth-o.value:"top"===i.value?a<o.value:"bottom"===i.value?a>document.documentElement.clientHeight-o.value:xm());(d||p||l.value&&n.value)&&(g=[t,a],f.value=h(s.value?t:a,l.value),m.value=y(s.value?t:a),v=f.value>-20&&f.value<80,c(e),u(e))}function V(e){const t=e.changedTouches[0].clientX,a=e.changedTouches[0].clientY
...
return t!==F(t,e.min,e.max)}),y=t.computed(()=>!s.value&&(p.value??0)+e.step<=e.max),b=t.computed(()=>!s.value&&(p.value??0)-e.step>=e.min),V=t.computed(()=>e.hideInput?"stacked":e.controlVariant),w=t.toRef(()=>"split"===V.value?"$plus":"$collapse"),S=t.toRef(()=>"split"===V.value?"$minus":"$expand"),k=t.toRef(()=>"split"===V.value?"default":"small"),x=t.toRef(()=>"stacked"===V.value?"auto":"100%"),N={props:{onClick:T,onPointerup:A,onPointerdown:R,onPointercancel:A}},C={props:{onClick:T,onPointerup:A,onPointerdown:B,onPointercancel:A}}
...
function i(){return l.increment?t.createVNode(nl,{key:"increment-defaults",defaults:{VBtn:{disabled:!y.value,height:x.value,size:k.value,icon:w.value,variant:"text"}}},{default:()=>[l.increment(N)]}):t.createVNode(Mn,{"aria-hidden":"true","data-testid":"increment",disabled:!y.value,height:x.value,icon:w.value,key:"increment-btn",onClick:T,onPointerdown:R,onPointerup:A,onPointercancel:A,size:k.value,variant:"text",tabindex:"-1"},null)}function s(){return l.decrement?t.createVNode(nl,{key:"decrement-defaults",defaults:{VBtn:{disabled:!b.value,height:x.value,size:k.value,icon:S.value,variant:"text"}}},{default:()=>[l.decrement(C)]}):t.createVNode(Mn,{"aria-hidden":"true","data-testid":"decrement",disabled:!b.value,height:x.value,icon:S.value,key:"decrement-btn",onClick:T,onPointerdown:B,onPointerup:A,onPointercancel:A,size:k.value,variant:"text",tabindex:"-1"},null)}function c(){return t.createElementVNode("div",{class:"v-number-input__control"},[s(),t.createVNode(er,{vertical:"stacked"!==V.value},null),i()])}function d(){return e.hideInput||e.inset?void 0:t.createVNode(er,{vertical:!0},null)}const v="split"===V.value?t.createElementVNode("div",{class:"v-number-input__control"},[t.createVNode(er,{vertical:!0},null),i()]):e.reverse||"hidden"===V.value?void 0:t.createElementVNode(t.Fragment,null,[d(),c()]),m=l["append-inner"]||v,f="split"===V.value?t.createElementVNode("div",{class:"v-number-input__control"},[s(),t.createVNode(er,{vertical:!0},null)]):e.reverse&&"hidden"!==V.value?t.createElementVNode(t.Fragment,null,[c(),d()]):void 0,E=l["prepend-inner"]||f
...
return t.createElementVNode(t.Fragment,null,[f,l["prepend-inner"]?.(...a)])}:void 0})}),So({},n)}}),Tm=vt({autofocus:Boolean,divider:String,focusAll:Boolean,label:{type:String,default:"$vuetify.input.otp"},length:{type:[Number,String],default:6},modelValue:{type:[Number,String],default:void 0},placeholder:String,type:{type:String,default:"number"},...ol(),...uo(),...C(Fi({variant:"outlined"}),["baseColor","bgColor","class","color","disabled","error","loading","rounded","style","theme","variant"])},"VOtpInput"),Am=wt()({name:"VOtpInput",props:Tm(),emits:{finish:e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:n,slots:o}=a
...
const Rm=vt({scale:{type:[Number,String],default:.5},...pt()},"VParallax"),Bm=wt()({name:"VParallax",props:Rm(),setup(e,a){let{slots:l}=a
...
e.style.setProperty("transform",`translateY(${r}px) scale(${c})`)}))}return Bt(()=>t.createVNode(Vl,{class:t.normalizeClass(["v-parallax",{"v-parallax--active":o.value},e.class]),style:t.normalizeStyle(e.style),ref:u,cover:!0,onLoadstart:m,onLoad:m},l)),{}}}),Dm=vt({...ao({falseIcon:"$radioOff",trueIcon:"$radioOn"})},"VRadio"),Fm=wt()({name:"VRadio",props:Dm(),setup(e,a){let{slots:l}=a
return Bt(()=>{const a=lo.filterProps(e)
return t.createVNode(lo,t.mergeProps(a,{class:["v-radio",e.class],style:e.style,type:"radio"}),l)}),{}}}),$m=vt({height:{type:[Number,String],default:"auto"},...yo(),...I(Jn(),["multiple"]),trueIcon:{type:Dt,default:"$radioOn"},falseIcon:{type:Dt,default:"$radioOff"},type:{type:String,default:"radio"}},"VRadioGroup"),Mm=wt()({name:"VRadioGroup",inheritAttrs:!1,props:$m(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
...
return t.createElementVNode(t.Fragment,null,[d&&t.createVNode(Zn,{id:l.value},{default:()=>[d]}),t.createVNode(to,t.mergeProps(c,{id:l.value,"aria-describedby":r.value,defaultsTarget:"VRadio",trueIcon:e.trueIcon,falseIcon:e.falseIcon,type:e.type,disabled:s.value,readonly:u.value,"aria-labelledby":d?l.value:void 0,multiple:!1},o,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e}),n)])}})}),So({},s)}}),zm=vt({...uo(),...yo(),...Xc(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},"VRangeSlider"),Lm=wt()({name:"VRangeSlider",props:zm(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,end:e=>!0,start:e=>!0},setup(e,a){let{slots:l,emit:n}=a
const o=t.ref(),r=t.ref(),i=t.ref(),{rtlClasses:s}=ga()
const u=Zc(e),c=la(e,"modelValue",void 0,e=>e?.length?e.map(e=>u.roundValue(e)):[0,0]),{activeThumbRef:d,hasLabels:v,max:p,min:m,mousePressed:f,onSliderMousedown:g,onSliderTouchstart:h,position:y,trackContainerRef:b,disabled:V,readonly:w}=Qc({props:e,steps:u,onSliderStart:()=>{V.value||w.value?d.value?.blur():n("start",c.value)},onSliderEnd:t=>{let{value:a}=t
...
const a=qc(t,o.value.$el,e.direction),l=qc(t,r.value.$el,e.direction),n=Math.abs(a),i=Math.abs(l)
return n<i||n===i&&a<0?o.value.$el:r.value.$el}}),{isFocused:S,focus:k,blur:x}=co(e),N=t.computed(()=>y(c.value[0])),C=t.computed(()=>y(c.value[1]))
return Bt(()=>{const a=bo.filterProps(e),n=!!(e.label||l.label||l.prepend)
return t.createVNode(bo,t.mergeProps({class:["v-slider","v-range-slider",{"v-slider--has-labels":!!l["tick-label"]||v.value,"v-slider--focused":S.value,"v-slider--pressed":f.value,"v-slider--disabled":V.value},s.value,e.class],style:e.style,ref:i},a,{focused:S.value}),{...l,prepend:n?a=>t.createElementVNode(t.Fragment,null,[l.label?.(a)??(e.label?t.createVNode(Zn,{class:"v-slider__label",text:e.label},null):void 0),l.prepend?.(a)]):void 0,default:a=>{let{id:n,messagesId:i}=a
return t.createElementVNode("div",{class:"v-slider__container",onMousedown:w.value?void 0:g,onTouchstartPassive:w.value?void 0:h},[t.createElementVNode("input",{id:`${n.value}_start`,name:e.name||n.value,disabled:V.value,readonly:w.value,tabindex:"-1",value:c.value[0]},null),t.createElementVNode("input",{id:`${n.value}_stop`,name:e.name||n.value,disabled:V.value,readonly:w.value,tabindex:"-1",value:c.value[1]},null),t.createVNode(ad,{ref:b,start:N.value,stop:C.value},{"tick-label":l["tick-label"]}),t.createVNode(ed,{ref:o,"aria-describedby":i.value,focused:S&&d.value===o.value?.$el,modelValue:c.value[0],"onUpdate:modelValue":e=>c.value=[e,c.value[1]],onFocus:e=>{k(),d.value=o.value?.$el,p.value!==m.value&&c.value[0]===c.value[1]&&c.value[1]===m.value&&e.relatedTarget!==r.value?.$el&&(o.value?.$el.blur(),r.value?.$el.focus())},onBlur:()=>{x(),d.value=void 0},min:m.value,max:c.value[1],position:N.value,ripple:e.ripple},{"thumb-label":l["thumb-label"]}),t.createVNode(ed,{ref:r,"aria-describedby":i.value,focused:S&&d.value===r.value?.$el,modelValue:c.value[1],"onUpdate:modelValue":e=>c.value=[c.value[0],e],onFocus:e=>{k(),d.value=r.value?.$el,p.value!==m.value&&c.value[0]===c.value[1]&&c.value[0]===p.value&&e.relatedTarget!==o.value?.$el&&(r.value?.$el.blur(),o.value?.$el.focus())},onBlur:()=>{x(),d.value=void 0},min:c.value[0],max:p.value,position:C.value,ripple:e.ripple},{"thumb-label":l["thumb-label"]})])}})}),So({focus:()=>o.value?.$el.focus()},i)}}),Om=vt({name:String,itemAriaLabel:{type:String,default:"$vuetify.rating.ariaLabel.item"},activeColor:String,color:String,clearable:Boolean,disabled:Boolean,emptyIcon:{type:Dt,default:"$ratingEmpty"},fullIcon:{type:Dt,default:"$ratingFull"},halfIncrements:Boolean,hover:Boolean,length:{type:[Number,String],default:5},readonly:Boolean,modelValue:{type:[Number,String],default:0},itemLabels:Array,itemLabelPosition:{type:String,default:"top",validator:e=>["top","bottom"].includes(e)},ripple:Boolean,...pt(),...Rl(),...Xl(),...Pa(),...ya()},"VRating"),jm=wt()({name:"VRating",props:Om(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
const a=S(m.value)
v.start(a),b=window.setTimeout(()=>{n.value=!1},t)}function w(){f.value=!0,v.reset(),window.clearTimeout(b)}function k(){f.value=!1,V()}function x(e){g.value=e.touches[0].clientY}function N(e){Math.abs(g.value-e.changedTouches[0].clientY)>50&&(n.value=!1)}function C(){f.value&&k()}const E=t.computed(()=>e.location.split(" ").reduce((e,t)=>(e[`v-snackbar--${t}`]=!0,e),{}))
return Bt(()=>{const a=Ii.filterProps(e),g=!!(l.default||l.text||e.text)
return t.createVNode(Ii,t.mergeProps({ref:p,class:["v-snackbar",{"v-snackbar--active":n.value,"v-snackbar--multi-line":e.multiLine&&!e.vertical,"v-snackbar--timer":!!e.timer,"v-snackbar--vertical":e.vertical},E.value,o.value,e.class],style:[h.value,e.style]},a,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,contentProps:t.mergeProps({class:["v-snackbar__wrapper",i.value,s.value,d.value,c.value],style:[u.value],onPointerenter:w,onPointerleave:k},a.contentProps),persistent:!0,noClickAnimation:!0,scrim:!1,scrollStrategy:"none",_disableGlobalStack:!0,onTouchstartPassive:x,onTouchend:N,onAfterLeave:C},r),{default:()=>[Fl(!1,"v-snackbar"),e.timer&&!f.value&&t.createElementVNode("div",{key:"timer",class:"v-snackbar__timer"},[t.createVNode(un,{ref:m,color:"string"==typeof e.timer?e.timer:"info",max:e.timeout,modelValue:v.time.value},null)]),g&&t.createElementVNode("div",{key:"content",class:"v-snackbar__content",role:"status","aria-live":"polite"},[l.text?.()??e.text,l.default?.()]),l.actions&&t.createVNode(nl,{defaults:{VBtn:{variant:"text",ripple:!1,slim:!0}}},{default:()=>[t.createElementVNode("div",{class:"v-snackbar__actions"},[l.actions({isActive:n})])]})],activator:l.activator})}),So({},p)}}),Jm=vt({closable:[Boolean,String],closeText:{type:String,default:"$vuetify.dismiss"},modelValue:{type:Array,default:()=>[]},...I(Zm(),["modelValue"])},"VSnackbarQueue"),ef=wt()({name:"VSnackbarQueue",props:Jm(),emits:{"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:n}=a
...
Bt(()=>{const a=!(!e.closable&&!n.actions),{modelValue:l,...o}=Qm.filterProps(e)
return t.createElementVNode(t.Fragment,null,[i.value&&!!s.value&&(n.default?t.createVNode(nl,{defaults:{VSnackbar:s.value}},{default:()=>[n.default({item:s.value})]}):t.createVNode(Qm,t.mergeProps(o,s.value,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,onAfterLeave:u}),{text:n.text?()=>n.text?.({item:s.value}):void 0,actions:a?()=>t.createElementVNode(t.Fragment,null,[n.actions?t.createVNode(nl,{defaults:{VBtn:v.value}},{default:()=>[n.actions({item:s.value,props:{onClick:d}})]}):t.createVNode(Mn,t.mergeProps(v.value,{onClick:d}),null)]):void 0}))])})}}),tf=vt({autoDraw:Boolean,autoDrawDuration:[Number,String],autoDrawEasing:{type:String,default:"ease"},color:String,gradient:{type:Array,default:()=>[]},gradientDirection:{type:String,validator:e=>["top","bottom","left","right"].includes(e),default:"top"},height:{type:[String,Number],default:75},labels:{type:Array,default:()=>[]},labelSize:{type:[Number,String],default:7},lineWidth:{type:[String,Number],default:4},id:String,itemValue:{type:String,default:"value"},modelValue:{type:Array,default:()=>[]},min:[String,Number],max:[String,Number],padding:{type:[String,Number],default:8},showLabels:Boolean,smooth:[Boolean,String,Number],width:{type:[Number,String],default:300}},"Line"),af=vt({autoLineWidth:Boolean,...tf()},"VBarline"),lf=wt()({name:"VBarline",props:af(),setup(e,a){let{slots:l}=a
...
function nf(e,t){let a=arguments.length>2&&void 0!==arguments[2]&&arguments[2],l=arguments.length>3&&void 0!==arguments[3]?arguments[3]:75
if(0===e.length)return""
const n=e.shift(),o=e[e.length-1]
return(a?`M${n.x} ${l-n.x+2} L${n.x} ${n.y}`:`M${n.x} ${n.y}`)+e.map((a,l)=>{const o=e[l+1],r=e[l-1]||n,i=o&&(u=a,c=r,of((s=o).x+c.x)===of(2*u.x)&&of(s.y+c.y)===of(2*u.y))
var s,u,c
if(!o||i)return`L${a.x} ${a.y}`
const d=Math.min(rf(r,a),rf(o,a)),v=d/2<t?d/2:t,p=sf(r,a,v),m=sf(o,a,v)
return`L${p.x} ${p.y}S${a.x} ${a.y} ${m.x} ${m.y}`}).join("")+(a?`L${o.x} ${l-n.x+2} Z`:"")}function of(e){return parseInt(e,10)}function rf(e,t){return Math.sqrt(Math.pow(t.x-e.x,2)+Math.pow(t.y-e.y,2))}function sf(e,t,a){const l=e.x-t.x,n=e.y-t.y,o=Math.sqrt(l*l+n*n),r=l/o,i=n/o
return{x:t.x+r*a,y:t.y+i*a}}const uf=vt({fill:Boolean,...tf()},"VTrendline"),cf=wt()({name:"VTrendline",props:uf(),setup(e,a){let{slots:l}=a
...
return nf(u(f.value,m.value),a,t,parseInt(e.height,10))}t.watch(()=>e.modelValue,async()=>{if(await t.nextTick(),!e.autoDraw||!s.value||c())return
...
Bt(()=>{const a="trend"===e.type?cf:lf,r="trend"===e.type?cf.filterProps(e):lf.filterProps(e)
return t.createVNode(a,t.mergeProps({key:e.type,class:n.value,style:o.value,viewBox:`0 0 ${e.width} ${parseInt(i.value,10)}`},r),l)})}}),pf=vt({...pt(),..._i({offset:8,minWidth:0,openDelay:0,closeDelay:100,location:"top center",transition:"scale-transition"})},"VSpeedDial"),mf=wt()({name:"VSpeedDial",props:pf(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.withDirectives(t.createElementVNode("button",{class:t.normalizeClass(["v-stepper-item",{"v-stepper-item--complete":c.value,"v-stepper-item--disabled":e.disabled,"v-stepper-item--error":u.value},n?.selectedClass.value]),disabled:!e.editable,type:"button",onClick:function(){n?.toggle()}},[i.value&&Fl(!0,"v-stepper-item"),t.createVNode(qn,{key:"stepper-avatar",class:"v-stepper-item__avatar",color:a?e.color:void 0,size:24},{default:()=>[l.icon?.(v.value)??(d.value?t.createVNode(Jl,{icon:d.value},null):o.value)]}),t.createElementVNode("div",{class:"v-stepper-item__content"},[r&&t.createElementVNode("div",{key:"title",class:"v-stepper-item__title"},[l.title?.(v.value)??e.title]),p&&t.createElementVNode("div",{key:"subtitle",class:"v-stepper-item__subtitle"},[l.subtitle?.(v.value)??e.subtitle]),l.default?.(v.value)])]),[[Fn,e.editable&&e.ripple,null]])}),{}}}),Sf=vt({...I(Tc(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VStepperWindow"),kf=wt()({name:"VStepperWindow",props:Sf(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const n=t.inject(ff,null),o=la(e,"modelValue"),r=t.computed({get:()=>null==o.value&&n?n.items.value.find(e=>n.selected.value.includes(e.id))?.value:o.value,set(e){o.value=e}})
return Bt(()=>{const a=Ac.filterProps(e)
return t.createVNode(Ac,t.mergeProps({_as:"VStepperWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-stepper-window",e.class],style:e.style,mandatory:!1,touch:!1}),l)}),{}}}),xf=vt({...Dc()},"VStepperWindowItem"),Nf=wt()({name:"VStepperWindowItem",props:xf(),setup(e,a){let{slots:l}=a
return Bt(()=>{const a=Fc.filterProps(e)
return t.createVNode(Fc,t.mergeProps({_as:"VStepperWindowItem"},a,{class:["v-stepper-window-item",e.class],style:e.style}),l)}),{}}}),Cf=vt({altLabels:Boolean,bgColor:String,completeIcon:Dt,editIcon:Dt,editable:Boolean,errorIcon:Dt,hideActions:Boolean,items:{type:Array,default:()=>[]},itemTitle:{type:[String,Array,Function],default:"title"},itemValue:{type:[String,Array,Function],default:"value"},itemProps:{type:[Boolean,String,Array,Function],default:"props"},nonLinear:Boolean,flat:Boolean,...Ao()},"Stepper"),Ef=vt({...Cf(),...Ol({mandatory:"force",selectedClass:"v-stepper-item--selected"}),...dd(),...C(gf(),["prevText","nextText"])},"VStepper"),If=wt()({name:"VStepper",props:Ef(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{items:n,next:o,prev:r,selected:i}=Hl(e,ff),{displayClasses:s,mobile:u}=Ro(e),{completeIcon:c,editIcon:d,errorIcon:v,color:p,editable:m,prevText:f,nextText:g}=t.toRefs(e),y=t.computed(()=>e.items.map((t,a)=>{const l={title:h(t,e.itemTitle,t),value:h(t,e.itemValue,a+1),...!0===e.itemProps?t:h(t,e.itemProps)}
return{title:l.title,value:l.value,props:l,raw:t}})),b=t.computed(()=>n.value.findIndex(e=>i.value.includes(e.id)))
return yt({VStepperItem:{editable:m,errorIcon:v,completeIcon:c,editIcon:d,prevText:f,nextText:g},VStepperActions:{color:p,disabled:t.computed(()=>e.disabled?e.disabled:0===b.value?"prev":b.value===n.value.length-1&&"next"),prevText:f,nextText:g}}),Bt(()=>{const a=vd.filterProps(e),n=!(!l.header&&!e.items.length),i=e.items.length>0,c=!(e.hideActions||!i&&!l.actions)
return t.createVNode(vd,t.mergeProps(a,{color:e.bgColor,class:["v-stepper",{"v-stepper--alt-labels":e.altLabels,"v-stepper--flat":e.flat,"v-stepper--non-linear":e.nonLinear,"v-stepper--mobile":u.value},s.value,e.class],style:e.style}),{default:()=>[n&&t.createVNode(yf,{key:"stepper-header"},{default:()=>[y.value.map((e,a)=>{let{raw:n,...o}=e
return t.createElementVNode(t.Fragment,null,[!!a&&t.createVNode(er,null,null),t.createVNode(wf,o.props,{default:l[`header-item.${o.value}`]??l.header,icon:l.icon,title:l.title,subtitle:l.subtitle})])})]}),i&&t.createVNode(kf,{key:"stepper-window"},{default:()=>[y.value.map(e=>t.createVNode(Nf,{value:e.value},{default:()=>l[`item.${e.value}`]?.(e)??l.item?.(e)}))]}),l.default?.({prev:r,next:o}),c&&(l.actions?.({next:o,prev:r})??t.createVNode(hf,{key:"stepper-actions","onClick:prev":r,"onClick:next":o},l))]})}),{prev:r,next:o}}}),_f=vt({indeterminate:Boolean,inset:Boolean,flat:Boolean,loading:{type:[Boolean,String],default:!1},...yo(),...ao()},"VSwitch"),Pf=wt()({name:"VSwitch",inheritAttrs:!1,props:_f(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:indeterminate":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
...
return t.createElementVNode(t.Fragment,null,[l,t.createElementVNode("div",{class:t.normalizeClass(["v-switch__thumb",{"v-switch__thumb--filled":o||e.loading},e.inset||m?void 0:r.value]),style:t.normalizeStyle(e.inset?void 0:i.value)},[n.thumb?t.createVNode(nl,{defaults:{VIcon:{icon:o,size:"x-small"}}},{default:()=>[n.thumb({...h,icon:o})]}):t.createVNode(Ua,null,{default:()=>[e.loading?t.createVNode(vn,{name:"v-switch",active:!0,color:!1===g.value?void 0:f.value},{default:e=>n.loader?n.loader(e):t.createVNode(an,{active:e.isActive,color:e.color,indeterminate:!0,size:"16",width:"2"},null)}):o&&t.createVNode(Jl,{key:String(o),icon:o,size:"x-small"},null)]})])])}})}})}),So({},p)}}),Tf=vt({color:String,height:[Number,String],window:Boolean,...pt(),...kl(),...Qt(),...pl(),...Pa(),...ya()},"VSystemBar"),Af=wt()({name:"VSystemBar",props:Tf(),setup(e,a){let{slots:l}=a
...
return t.createVNode(Mn,t.mergeProps({symbol:Rf,ref:u,class:["v-tab",e.class,v.value?i.value:[]],style:[e.style,v.value?s.value:[]],tabindex:v.value?0:-1,role:"tab","aria-selected":String(v.value),active:!1},a,n,{block:e.fixed,maxWidth:e.fixed?300:void 0,"onGroup:selected":g}),{...l,default:()=>t.createElementVNode(t.Fragment,null,[l.default?.()??e.text,!e.hideSlider&&t.createElementVNode("div",{ref:c,class:t.normalizeClass(["v-tab__slider",o.value]),style:t.normalizeStyle(r.value)},null)])})}),So({},u)}}),Ff=vt({...I(Tc(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VTabsWindow"),$f=wt()({name:"VTabsWindow",props:Ff(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const n=t.inject(Rf,null),o=la(e,"modelValue"),r=t.computed({get:()=>null==o.value&&n?n.items.value.find(e=>n.selected.value.includes(e.id))?.value:o.value,set(e){o.value=e}})
return Bt(()=>{const a=Ac.filterProps(e)
return t.createVNode(Ac,t.mergeProps({_as:"VTabsWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-tabs-window",e.class],style:e.style,mandatory:!1,touch:!1}),l)}),{}}}),Mf=vt({...Dc()},"VTabsWindowItem"),zf=wt()({name:"VTabsWindowItem",props:Mf(),setup(e,a){let{slots:l}=a
return Bt(()=>{const a=Fc.filterProps(e)
return t.createVNode(Fc,t.mergeProps({_as:"VTabsWindowItem"},a,{class:["v-tabs-window-item",e.class],style:e.style}),l)}),{}}})
const Lf=vt({alignTabs:{type:String,default:"start"},color:String,fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,inset:Boolean,insetPadding:[String,Number],insetRadius:[String,Number],sliderColor:String,...C(Bf(),["spaced","sliderTransition","sliderTransitionDuration"]),...Yo({mandatory:"force",selectedClass:"v-tab-item--selected"}),...Rl(),...Pa()},"VTabs"),Of=wt()({name:"VTabs",props:Lf(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:n}=a
...
return t.createElementVNode(t.Fragment,null,[t.createVNode(Uo,t.mergeProps(a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-tabs",`v-tabs--${e.direction}`,`v-tabs--align-tabs-${e.alignTabs}`,{"v-tabs--fixed-tabs":e.fixedTabs,"v-tabs--grow":e.grow,"v-tabs--inset":e.inset,"v-tabs--stacked":e.stacked},i.value,s.value,e.class],style:[{"--v-tabs-height":b(e.height),"--v-tabs-inset-padding":e.inset?b(e.insetPadding):void 0,"--v-tabs-inset-radius":e.inset?b(e.insetRadius):void 0},u.value,e.style],role:"tablist",symbol:Rf},c,l),{default:n.default??(()=>r.value.map(a=>n.tab?.({item:a})??t.createVNode(Df,t.mergeProps(a,{key:a.text,value:a.value,spaced:e.spaced}),{default:n[`tab.${a.value}`]?()=>n[`tab.${a.value}`]?.({item:a}):void 0}))),prev:n.prev,next:n.next}),d&&t.createVNode($f,t.mergeProps({modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,key:"tabs-window"},c),{default:()=>[r.value.map(e=>n.item?.({item:e})??t.createVNode(zf,{value:e.value},{default:()=>n[`item.${e.value}`]?.({item:e})})),n.window?.()]})])}),{}}}),jf=vt({autoGrow:Boolean,autofocus:Boolean,counter:[Boolean,Number,String],counterValue:Function,prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,noResize:Boolean,rows:{type:[Number,String],default:5,validator:e=>!isNaN(parseFloat(e))},maxHeight:{type:[Number,String],validator:e=>!isNaN(parseFloat(e))},maxRows:{type:[Number,String],validator:e=>!isNaN(parseFloat(e))},suffix:String,modelModifiers:Object,...Mi(),...yo(),...Fi()},"VTextarea"),Wf=wt()({name:"VTextarea",directives:{vIntersect:yl},inheritAttrs:!1,props:jf(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0,"update:rows":e=>!0},setup(e,a){let{attrs:l,emit:n,slots:o}=a
...
function S(){V.isSuppressing.value&&V.update(),g.value!==document.activeElement&&g.value?.focus(),i.value||s()}function k(e){S(),n("click:control",e)}function x(e){n("mousedown:control",e)}function N(a){a.stopPropagation(),S(),t.nextTick(()=>{r.value="",J(e["onClick:clear"],a)})}function C(a){const l=a.target
...
case"end":return t[1]
default:return null}})
return Bt(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-timeline",`v-timeline--${e.direction}`,`v-timeline--align-${e.align}`,`v-timeline--justify-${e.justify}`,s.value,{"v-timeline--inset-line":!!e.lineInset},n.value,o.value,i.value,r.value,e.class]),style:t.normalizeStyle([{"--v-timeline-line-thickness":b(e.lineThickness)},e.style])},l)),{}}}),Qf=vt({allowedValues:Function,ampm:Boolean,color:String,disabled:Boolean,displayedValue:null,double:Boolean,format:{type:Function,default:e=>e},max:{type:Number,required:!0},min:{type:Number,required:!0},scrollable:Boolean,readonly:Boolean,rotate:{type:Number,default:0},step:{type:Number,default:1},modelValue:{type:Number}},"VTimePickerClock"),Jf=wt()({name:"VTimePickerClock",props:Qf(),emits:{change:e=>!0,input:e=>!0},setup(e,a){let{emit:l}=a
...
return Math.sqrt(a*a+l*l)}function P(e){null===s.value&&(s.value=e),u.value=e,S(e)}function T(t){if(t.preventDefault(),!i.value&&"click"!==t.type||!n.value)return
...
if(g=E(p-e*h.value,m),k(g))return P(g)}}function A(t){e.disabled||(t.preventDefault(),window.addEventListener("mousemove",T),window.addEventListener("touchmove",T),window.addEventListener("mouseup",R),window.addEventListener("touchend",R),s.value=null,u.value=null,i.value=!0,T(t))}function R(e){e.stopPropagation(),window.removeEventListener("mousemove",T),window.removeEventListener("touchmove",T),window.removeEventListener("mouseup",R),window.removeEventListener("touchend",R),i.value=!1,null!==u.value&&k(u.value)&&l("change",u.value)}t.watch(()=>e.modelValue,e=>{r.value=e}),Bt(()=>t.createElementVNode("div",{class:t.normalizeClass([{"v-time-picker-clock":!0,"v-time-picker-clock--indeterminate":null==e.modelValue,"v-time-picker-clock--readonly":e.readonly}]),onMousedown:A,onTouchstart:A,onWheel:x,ref:n},[t.createElementVNode("div",{class:"v-time-picker-clock__inner",ref:o},[t.createElementVNode("div",{class:t.normalizeClass([{"v-time-picker-clock__hand":!0,"v-time-picker-clock__hand--inner":N(e.modelValue)},d.value]),style:t.normalizeStyle([{transform:`rotate(${e.rotate+h.value*(b.value-e.min)}deg) scaleY(${C(b.value)})`},v.value])},null),w.value.map(a=>{const l=a===b.value
return t.createElementVNode("div",{class:t.normalizeClass([{"v-time-picker-clock__item":!0,"v-time-picker-clock__item--active":l,"v-time-picker-clock__item--disabled":e.disabled||!k(a)},l&&p.value]),style:t.normalizeStyle([I(a),l&&m.value])},[t.createElementVNode("span",null,[e.format(a)])])})])]))}}),eg=vt({active:Boolean,color:String,disabled:Boolean,label:String,modelValue:String,readonly:Boolean},"VTimePickerField"),tg=wt()({name:"VTimePickerField",inheritAttrs:!1,props:eg(),emits:{"update:modelValue":e=>!0},setup(e,a){let{emit:l,attrs:n}=a
...
function ag(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:2
return String(e).padStart(t,"0")}function lg(e){return e?(e-1)%12+1:12}function ng(e,t){return e%12+("pm"===t?12:0)}function og(e){const t=e.replaceAll(/\D/g,"")
return t.length>0?Number(t):null}function rg(e,t){return 59===e&&t?0:0!==e||t?e+(t?1:-1):59}const ig=vt({ampm:Boolean,color:String,disabled:Boolean,hour:[Number,String],minute:[Number,String],second:[Number,String],period:String,readonly:Boolean,useSeconds:Boolean,value:Number,viewMode:String},"VTimePickerControls"),sg=wt()({name:"VTimePickerControls",props:ig(),emits:{"update:period":e=>!0,"update:viewMode":e=>!0,"update:hour":e=>!0,"update:minute":e=>!0,"update:second":e=>!0},setup(e,a){let{emit:l,slots:n}=a
const{t:o}=ma(),r=t=>{if(null==t||isNaN(Number(t)))return null
const a=Number(t)
return e.ampm?ag(lg(a)):ag(a)},i=t=>{if(isNaN(Number(t))||null==t||""===t)return null
const a="string"==typeof t?og(t):Number(t)
return null===a?null:e.ampm?ng(a,e.period??"am"):F(a,0,23)},s=la(e,"hour",void 0,r,i),u=e=>null==e||isNaN(Number(e))?null:ag(`${e}`),c=e=>{if(isNaN(Number(e))||null==e||""===e)return null
const t="string"==typeof e?og(e):Number(e)
...
s.value=ag(o),r&&l("update:period","am"===e.period?"pm":"am")}function m(e){["ArrowUp","ArrowDown"].includes(e.key)&&(e.preventDefault(),e.stopPropagation(),d.value=rg(Number(d.value),"ArrowUp"===e.key))}function f(e){["ArrowUp","ArrowDown"].includes(e.key)&&(e.preventDefault(),e.stopPropagation(),v.value=rg(Number(v.value),"ArrowUp"===e.key))}function g(t,a,l){return n=>{if(!n.data)return
const o=n.target,{value:r,selectionStart:i,selectionEnd:s}=o??{}
if(null===og(n.data))return void n.preventDefault()
...
if(og(u)>t)return n.preventDefault(),o.value=ag(String(og(n.data)).substring(0,2)),void l(o.value)}const c=t(u)
...
function S(){const t=k()
null!==t&&t!==e.modelValue&&l("update:modelValue",t),w.value&&l("update:modelValue",null)}function k(){return null==i.value||null==s.value||e.useSeconds&&null==u.value?null:`${ag(i.value)}:${ag(s.value)}`+(e.useSeconds?`:${ag(u.value)}`:"")}function x(e){if(null==e||""===e)i.value=null,s.value=null,u.value=null
...
i.value=n?ng(parseInt(t,10),n):parseInt(t,10),s.value=parseInt(a,10),u.value=parseInt(l||0,10)}p.value=null==i.value||i.value<12?"am":"pm"}function N(e){if(p.value=e,null!=i.value){const e=i.value+("am"===p.value?-12:12)
i.value=function(e,t){const a=h.value
if(!a)return t
const l=V.value?t<12?cg:dg:ug
return((l.find(e=>a((e+t)%l.length+l[0]))||0)+t)%l.length+l[0]}(0,e)}return l("update:period",e),S(),!0}function C(e){"hour"===m.value?i.value=V.value?ng(e,p.value):e:"minute"===m.value?s.value=e:u.value=e}function E(t){switch(m.value||"hour"){case"hour":l("update:hour",t)
break
...
null!==k()&&(c.value=i.value,d.value=s.value,e.useSeconds&&(v.value=u.value),a&&S())}t.watch(i,S),t.watch(s,S),t.watch(u,S),t.watch(()=>e.period,e=>N(e)),t.watch(()=>e.modelValue,e=>x(e)),t.watch(()=>e.useSeconds,(e,t)=>{t&&!e&&"second"===m.value&&(m.value="minute"),e||null===u.value||(u.value=null)}),t.onMounted(()=>{x(e.modelValue)}),Bt(()=>{const a=I(md.filterProps(e),["hideHeader"]),l=sg.filterProps(e),c=Jf.filterProps(I(e,["format","modelValue","min","max"]))
return t.createVNode(md,t.mergeProps(a,{color:void 0,class:["v-time-picker",`v-time-picker--variant-${e.variant}`,e.class,r.value],hideHeader:e.hideHeader&&"input"!==e.variant,style:e.style}),{title:()=>n.title?.()??t.createElementVNode("div",{class:"v-time-picker__title"},[o(e.title)]),header:()=>t.createVNode(sg,t.mergeProps(l,{ampm:V.value,hour:i.value,minute:s.value,period:p.value,second:u.value,viewMode:m.value,"onUpdate:hour":e=>i.value=e,"onUpdate:minute":e=>s.value=e,"onUpdate:period":e=>N(e),"onUpdate:second":e=>u.value=e,"onUpdate:viewMode":e=>m.value=e,ref:f}),null),default:()=>t.createVNode(Jf,t.mergeProps(c,{allowedValues:"hour"===m.value?h.value:"minute"===m.value?y.value:b.value,double:"hour"===m.value&&!V.value,format:"hour"===m.value?V.value?lg:e=>e:e=>ag(e,2),max:"hour"===m.value?V.value&&"am"===p.value?11:23:59,min:"hour"===m.value&&V.value&&"pm"===p.value?12:0,size:20,step:"hour"===m.value?1:5,modelValue:"hour"===m.value?i.value:"minute"===m.value?s.value:u.value,onChange:E,onInput:C,ref:g}),null),actions:n.actions})})}}),mg=vt({...pt(),...$l({variant:"text"})},"VToolbarItems"),fg=wt()({name:"VToolbarItems",props:mg(),setup(e,a){let{slots:l}=a
return yt({VBtn:{color:t.toRef(()=>e.color),height:"inherit",variant:t.toRef(()=>e.variant)}}),Bt(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-toolbar-items",e.class]),style:t.normalizeStyle(e.style)},[l.default?.()])),{}}}),gg=vt({id:String,interactive:Boolean,text:String,...I(Ei({closeOnBack:!1,location:"end",locationStrategy:"connected",eager:!0,minWidth:0,offset:10,openOnClick:!1,openOnHover:!0,origin:"auto",scrim:!1,scrollStrategy:"reposition",transition:null}),["absolute","retainFocus","captureFocus","disableInitialFocus","persistent"])},"VTooltip"),hg=wt()({name:"VTooltip",props:gg(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return l.default?.(...a)??e.text}})}),So({},s)}}),yg=vt({...I(yr({collapseIcon:"$treeviewCollapse",expandIcon:"$treeviewExpand"}),["subgroup"])},"VTreeviewGroup"),bg=wt()({name:"VTreeviewGroup",props:yg(),setup(e,a){let{slots:l}=a
...
return t.createVNode(br,t.mergeProps(a,{ref:n,class:["v-treeview-group",e.class],subgroup:!0}),{...l,activator:l.activator?e=>t.createElementVNode(t.Fragment,null,[t.createVNode(nl,{defaults:r.value},{default:()=>[l.activator?.(e)]})]):void 0})}),{}}}),Vg=Symbol.for("vuetify:v-treeview"),wg=vt({loading:Boolean,hideActions:Boolean,hasCustomPrepend:Boolean,indentLines:Array,toggleIcon:Dt,...kr({slim:!0})},"VTreeviewItem"),Sg=wt()({name:"VTreeviewItem",props:wg(),emits:{toggleExpand:e=>!0},setup(e,a){let{slots:l,emit:n}=a
const o=t.inject(Vg,{visibleIds:t.ref()}).visibleIds,r=t.ref(),i=t.computed(()=>r.value?.root.activatable.value&&r.value?.isGroupActivator),s=t.computed(()=>r.value?.link.isClickable.value||null!=e.value&&!!r.value?.list),u=t.computed(()=>!e.disabled&&!1!==e.link&&(e.link||s.value||i.value)),c=t.computed(()=>o.value&&!o.value.has(t.toRaw(r.value?.id)))
...
return ie(l.header,{props:d,item:a.raw,internalItem:a,loading:p},()=>t.createVNode(Sg,t.mergeProps({ref:e=>o.value[u]=e},d,{hasCustomPrepend:!!l.prepend,value:e.returnObject?a.raw:v.value,loading:p}),b))},default:()=>t.createElementVNode(t.Fragment,null,[t.createVNode(xg,t.mergeProps(w,{items:d,indentLinesVariant:e.indentLinesVariant,parentIndentLines:y.children,isLastGroup:m,returnObject:e.returnObject}),l),l.footer?.({props:S,item:a.raw,internalItem:a,loading:p})])}):ie(l.item,{props:v,item:a.raw,internalItem:a},()=>"divider"===a.type?ie(l.divider,{props:a.raw},()=>t.createVNode(er,a.props,null)):"subheader"===a.type?ie(l.subheader,{props:a.raw},()=>t.createVNode(Cr,a.props,null)):t.createVNode(Sg,t.mergeProps(v,{hasCustomPrepend:!!l.prepend,hideActions:e.hideActions,indentLines:y.leaf,value:e.returnObject?t.toRaw(a.raw):v.value}),b))})}})
function Ng(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
for(const a of e)t.push(a),a.children&&Ng(a.children,t)
return t}const Cg=vt({openAll:Boolean,indentLines:[Boolean,String],search:String,hideNoData:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},...ns({filterKeys:["title"]}),...I(kg(),["index","path","indentLinesVariant","parentIndentLines","isLastGroup"]),...I(Mr({collapseIcon:"$treeviewCollapse",expandIcon:"$treeviewExpand",slim:!0}),["nav","openStrategy"]),modelValue:Array},"VTreeview"),Eg=wt()({name:"VTreeview",props:Cg(),emits:{"update:opened":e=>!0,"update:activated":e=>!0,"update:selected":e=>!0,"update:modelValue":e=>!0,"click:open":e=>!0,"click:select":e=>!0},setup(e,a){let{slots:l,emit:n}=a
const{t:o}=ma(),{items:r}=$r(e),i=t.toRef(()=>e.activeColor),s=t.toRef(()=>e.baseColor),u=t.toRef(()=>e.color),c=la(e,"activated"),d=la(e,"selected"),v=t.computed({get:()=>e.modelValue??d.value,set(e){d.value=e,n("update:modelValue",e)}}),p=t.ref(),m=t.computed(()=>e.openAll?V(r.value):e.opened),f=t.computed(()=>Ng(r.value)),g=t.toRef(()=>e.search),{filteredItems:h}=os(e,f,g),y=t.computed(()=>{if(!g.value)return null
...
return l}return t.provide(Vg,{visibleIds:y}),yt({VTreeviewGroup:{activeColor:i,baseColor:s,color:u,collapseIcon:t.toRef(()=>e.collapseIcon),expandIcon:t.toRef(()=>e.expandIcon)},VTreeviewItem:{activeClass:t.toRef(()=>e.activeClass),activeColor:i,baseColor:s,color:u,density:t.toRef(()=>e.density),disabled:t.toRef(()=>e.disabled),lines:t.toRef(()=>e.lines),variant:t.toRef(()=>e.variant)}}),Bt(()=>{const a=zr.filterProps(e),n=xg.filterProps(e),i="boolean"==typeof e.indentLines?"default":e.indentLines
return t.createVNode(zr,t.mergeProps({ref:p},a,{class:["v-treeview",{"v-treeview--fluid":e.fluid},e.class],openStrategy:"multiple",style:e.style,opened:m.value,activated:c.value,"onUpdate:activated":e=>c.value=e,selected:v.value,"onUpdate:selected":e=>v.value=e}),{default:()=>[0===y.value?.size&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(xr,{key:"no-data",title:o(e.noDataText)},null)),t.createVNode(xg,t.mergeProps(n,{density:e.density,returnObject:e.returnObject,items:r.value,parentIndentLines:e.indentLines?[]:void 0,indentLinesVariant:i}),l)]})}),{}}}),Ig=wt()({name:"VValidation",props:go(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=ho(e,"validation")
return()=>a.default?.(l)}})
var _g=Object.freeze({__proto__:null,VAlert:Gn,VAlertTitle:jn,VApp:_a,VAppBar:Tl,VAppBarNavIcon:Ln,VAppBarTitle:On,VAutocomplete:ss,VAvatar:qn,VBadge:cs,VBanner:fs,VBannerActions:vs,VBannerText:ps,VBottomNavigation:hs,VBottomSheet:ws,VBreadcrumbs:Es,VBreadcrumbsDivider:ks,VBreadcrumbsItem:Ns,VBtn:Mn,VBtnGroup:Ll,VBtnToggle:Kl,VCalendar:fc,VCard:Cc,VCardActions:hc,VCardItem:Sc,VCardSubtitle:bc,VCardText:xc,VCardTitle:Vc,VCarousel:Bc,VCarouselItem:Mc,VCheckbox:xo,VCheckboxBtn:oo,VChip:Zo,VChipGroup:qo,VClassIcon:Ot,VCode:zc,VCol:Qv,VColorPicker:fd,VCombobox:hd,VComponentIcon:Mt,VConfirmEdit:bd,VContainer:Hv,VCounter:Ai,VDataIterator:tv,VDataTable:Mv,VDataTableFooter:ov,VDataTableHeaders:xv,VDataTableRow:Iv,VDataTableRows:Pv,VDataTableServer:jv,VDataTableVirtual:Lv,VDatePicker:Pp,VDatePickerControls:yp,VDatePickerHeader:Vp,VDatePickerMonth:xp,VDatePickerMonths:Cp,VDatePickerYears:Ip,VDefaultsProvider:nl,VDialog:bs,VDialogBottomTransition:Wa,VDialogTopTransition:Ha,VDialogTransition:za,VDivider:er,VEmptyState:Ap,VExpandTransition:tl,VExpandXTransition:al,VExpansionPanel:zp,VExpansionPanelText:Dp,VExpansionPanelTitle:$p,VExpansionPanels:jp,VFab:Hp,VFabTransition:ja,VFadeTransition:Ya,VField:$i,VFieldLabel:Bi,VFileInput:qp,VFooter:Zp,VForm:Jp,VHover:tm,VIcon:Jl,VImg:Vl,VInfiniteScroll:nm,VInput:bo,VItem:sm,VItemGroup:im,VKbd:cm,VLabel:Zn,VLayout:vm,VLayoutItem:mm,VLazy:gm,VLigatureIcon:Lt,VList:zr,VListGroup:br,VListImg:Lr,VListItem:xr,VListItemAction:jr,VListItemMedia:Hr,VListItemSubtitle:wr,VListItemTitle:Sr,VListSubheader:Cr,VLocaleProvider:ym,VMain:Vm,VMenu:Pi,VMessages:so,VNavigationDrawer:Em,VNoSsr:Im,VNumberInput:Pm,VOtpInput:Am,VOverlay:Ii,VPagination:lv,VParallax:Bm,VProgressCircular:an,VProgressLinear:un,VRadio:Fm,VRadioGroup:Mm,VRangeSlider:Lm,VRating:jm,VResponsive:sl,VRow:fp,VScaleTransition:Ua,VScrollXReverseTransition:Ka,VScrollXTransition:Ga,VScrollYReverseTransition:Xa,VScrollYTransition:qa,VSelect:ts,VSelectionControl:lo,VSelectionControlGroup:to,VSheet:vd,VSkeletonLoader:qm,VSlideGroup:Uo,VSlideGroupItem:Xm,VSlideXReverseTransition:Qa,VSlideXTransition:Za,VSlideYReverseTransition:el,VSlideYTransition:Ja,VSlider:nd,VSnackbar:Qm,VSnackbarQueue:ef,VSpacer:gp,VSparkline:vf,VSpeedDial:mf,VStepper:If,VStepperActions:hf,VStepperHeader:yf,VStepperItem:wf,VStepperWindow:kf,VStepperWindowItem:Nf,VSvgIcon:zt,VSwitch:Pf,VSystemBar:Af,VTab:Df,VTable:Av,VTabs:Of,VTabsWindow:$f,VTabsWindowItem:zf,VTextField:Wi,VTextarea:Wf,VThemeProvider:Yf,VTimePicker:pg,VTimePickerClock:Jf,VTimePickerControls:sg,VTimeline:Zf,VTimelineItem:qf,VToolbar:El,VToolbarItems:fg,VToolbarTitle:Aa,VTooltip:hg,VTreeview:Eg,VTreeviewGroup:bg,VTreeviewItem:Sg,VValidation:Ig,VVirtualScroll:qi,VWindow:Ac,VWindowItem:Fc})
function Pg(e,t){e._mutate?.[t.instance.$.uid]&&(e._mutate[t.instance.$.uid].observer.disconnect(),delete e._mutate[t.instance.$.uid])}const Tg={mounted:function(e,t){const a=t.modifiers||{},l=t.value,{once:n,immediate:o,...r}=a,i=!Object.keys(r).length,{handler:s,options:u}="object"==typeof l?l:{handler:l,options:{attributes:r?.attr??i,characterData:r?.char??i,childList:r?.child??i,subtree:r?.sub??i}},c=new MutationObserver(function(){let a=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],l=arguments.length>1?arguments[1]:void 0
s?.(a,l),n&&Pg(e,t)})
o&&s?.([],c),e._mutate=Object(e._mutate),e._mutate[t.instance.$.uid]={observer:c},c.observe(e,u)},unmounted:Pg}
function Ag(e,t){const{self:a=!1}=t.modifiers??{},l=t.value,n="object"==typeof l&&l.options||{passive:!0},o="function"==typeof l||"handleEvent"in l?l:l.handler,r=a?e:t.arg?document.querySelector(t.arg):window
r&&(r.addEventListener("scroll",o,n),e._onScroll=Object(e._onScroll),e._onScroll[t.instance.$.uid]={handler:o,options:n,target:a?void 0:r})}function Rg(e,t){if(!e._onScroll?.[t.instance.$.uid])return
const{handler:a,options:l,target:n=e}=e._onScroll[t.instance.$.uid]
n.removeEventListener("scroll",a,l),delete e._onScroll[t.instance.$.uid]}const Bg={mounted:Ag,unmounted:Rg,updated:function(e,t){t.value!==t.oldValue&&(Rg(e,t),Ag(e,t))}}
const Dg=function(e,a){const n=function(e,a){return function(n,o,r){const i="function"==typeof a?a(o):a,s=o.value?.text??o.value??i?.text,u=V(o.value)?o.value:{},c=()=>s??n.textContent,d=(r.ctx===o.instance.$?function(e,t){const a=new Set,n=t=>{for(const l of t){if(!l)continue
...
return{mounted:n,updated:n,unmounted(e){t.render(null,e)}}}(hg,e=>({activator:"parent",location:e.arg?.replace("-"," "),text:"boolean"==typeof e.value?void 0:e.value}))
var Fg=Object.freeze({__proto__:null,ClickOutside:Ni,Intersect:yl,Mutate:Tg,Resize:fu,Ripple:Fn,Scroll:Bg,Tooltip:Dg,Touch:Ic})
function $g(e){const t={svg:{component:zt},class:{component:Ot}},a=e?.defaultSet??"mdi"
return"mdi"!==a||t.mdi||(t.mdi=Wt),O({defaultSet:a,sets:t,aliases:{...jt,vuetify:["M8.2241 14.2009L12 21L22 3H14.4459L8.2241 14.2009Z",["M7.26303 12.4733L7.00113 12L2 3H12.5261C12.5261 3 12.5261 3 12.5261 3L7.26303 12.4733Z",.6]],"vuetify-outline":"svg:M7.26 12.47 12.53 3H2L7.26 12.47ZM14.45 3 8.22 14.2 12 21 22 3H14.45ZM18.6 5 12 16.88 10.51 14.2 15.62 5ZM7.26 8.35 5.4 5H9.13L7.26 8.35Z","vuetify-play":["m6.376 13.184-4.11-7.192C1.505 4.66 2.467 3 4.003 3h8.532l-.953 1.576-.006.01-.396.677c-.429.732-.214 1.507.194 2.015.404.503 1.092.878 1.869.806a3.72 3.72 0 0 1 1.005.022c.276.053.434.143.523.237.138.146.38.635-.25 2.09-.893 1.63-1.553 1.722-1.847 1.677-.213-.033-.468-.158-.756-.406a4.95 4.95 0 0 1-.8-.927c-.39-.564-1.04-.84-1.66-.846-.625-.006-1.316.27-1.693.921l-.478.826-.911 1.506Z",["M9.093 11.552c.046-.079.144-.15.32-.148a.53.53 0 0 1 .43.207c.285.414.636.847 1.046 1.2.405.35.914.662 1.516.754 1.334.205 2.502-.698 3.48-2.495l.014-.028.013-.03c.687-1.574.774-2.852-.005-3.675-.37-.391-.861-.586-1.333-.676a5.243 5.243 0 0 0-1.447-.044c-.173.016-.393-.073-.54-.257-.145-.18-.127-.316-.082-.392l.393-.672L14.287 3h5.71c1.536 0 2.499 1.659 1.737 2.992l-7.997 13.996c-.768 1.344-2.706 1.344-3.473 0l-3.037-5.314 1.377-2.278.004-.006.004-.007.481-.831Z",.6]]}},e)}function Mg(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
const{blueprint:a,...l}=e,n=O(a,l),{aliases:r={},components:i={},directives:s={}}=n,u=t.effectScope()
return u.run(()=>{const e=function(e){return t.ref(e)}(n.defaults),a=To(n.display,n.ssr),l=Na(n.theme),c=$g(n.icons),d=pa(n.locale),v=function(e,t){const a=O({adapter:Du,locale:{af:"af-ZA",bg:"bg-BG",ca:"ca-ES",ckb:"",cs:"cs-CZ",de:"de-DE",el:"el-GR",en:"en-US",et:"et-EE",fa:"fa-IR",fi:"fi-FI",hr:"hr-HR",hu:"hu-HU",he:"he-IL",id:"id-ID",it:"it-IT",ja:"ja-JP",ko:"ko-KR",lv:"lv-LV",lt:"lt-LT",nl:"nl-NL",no:"no-NO",pl:"pl-PL",pt:"pt-PT",ro:"ro-RO",ru:"ru-RU",sk:"sk-SK",sl:"sl-SI",srCyrl:"sr-SP",srLatn:"sr-SP",sv:"sv-SE",th:"th-TH",tr:"tr-TR",az:"az-AZ",uk:"uk-UA",vi:"vi-VN",zhHans:"zh-CN",zhHant:"zh-TW"}},e)
return{options:a,instance:zu(a,t)}}(n.date,d),p=function(e,t){return{rtl:t.isRtl,options:O(Do(),e)}}(n.goTo,d)
...
if(m.run(()=>{l.install(u)}),u.onUnmount(()=>m.stop()),u.provide(gt,e),u.provide(Co,a),u.provide(ha,l),u.provide(Ft,c),u.provide(va,d),u.provide(Fu,v.options),u.provide($u,v.instance),u.provide(Bo,p),o&&n.ssr)if(u.$nuxt)u.$nuxt.hook("app:suspense:resolve",()=>{a.update()})
else{const{mount:e}=u
u.mount=function(){const l=e(...arguments)
return t.nextTick(()=>a.update()),u.mount=e,l}}("boolean"!=typeof __VUE_OPTIONS_API__||__VUE_OPTIONS_API__)&&u.mixin({computed:{$vuetify(){return t.reactive({defaults:zg.call(this,gt),display:zg.call(this,Co),theme:zg.call(this,ha),icons:zg.call(this,Ft),locale:zg.call(this,va),date:zg.call(this,$u)})}}})},unmount:function(){u.stop()},defaults:e,display:a,theme:l,icons:c,locale:d,date:v,goTo:p}})}function zg(e){const t=this.$,a=t.parent?.provides??t.vnode.appContext?.provides
if(a&&e in a)return a[e]}Mg.version="3.11.0-beta.0"
const Lg=function(){return Mg({components:_g,directives:Fg,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},Og="3.11.0-beta.0"
Lg.version=Og,e.blueprints=Gt,e.components=_g,e.createVuetify=Lg,e.directives=Fg,e.useDate=Lu,e.useDefaults=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},t=arguments.length>1?arguments[1]:void 0
const{props:a,provideSubDefaults:l}=bt(e,t)
return l(),a},e.useDisplay=Ro,e.useGoTo=zo,e.useHotkey=function(e,l){let n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}
if(!o)return function(){}
const{event:r="keydown",inputs:i=!1,preventDefault:s=!0,sequenceTimeout:u=1e3}=n,c=navigator?.userAgent?.includes("Macintosh")??!1
let d,v=0,p=!1,m=0
function f(){m=0,clearTimeout(v)}function g(e){const a=d[m]
if(a&&!function(){if(t.toValue(i))return!1
const e=document.activeElement
return e&&("INPUT"===e.tagName||"TEXTAREA"===e.tagName||e.isContentEditable||"true"===e.contentEditable)}())if(function(e,t,a){const{modifiers:l,actualKey:n}=function(e){const t=["ctrl","shift","alt","meta","cmd"],{keys:a}=Wu(e.toLowerCase())
...
return e.ctrlKey===o&&e.metaKey===r&&e.shiftKey===l.shift&&e.altKey===l.alt&&e.key.toLowerCase()===n?.toLowerCase()}(e,a,c))if(t.toValue(s)&&e.preventDefault(),p){if(clearTimeout(v),m++,m===d.length)return l(e),void f()
...
return i.every(e=>Wu(e,!0).keys.length>0)?i:(a(`Invalid hotkey sequence: "${e}" contains invalid combinations`),[])}(e.toLowerCase())
p=l.length>1,d=l,f(),window.addEventListener(t.toValue(r),g)}},{immediate:!0}),t.watch(()=>t.toValue(r),(e,t)=>{t&&d&&d.length>0&&(window.removeEventListener(t,g),window.addEventListener(e,g))}),t.onScopeDispose(h,!0),h},e.useLayout=Jt,e.useLocale=ma,e.useMask=function(e){const a=t.computed(()=>"string"==typeof e.mask?e.mask in Hu?Hu[e.mask]:e.mask:e.mask?.mask??""),l=t.computed(()=>({...Yu,...V(e.mask)?e.mask.tokens:null}))
...
else n+=i,t++}return n}function u(e){return!!e&&s(e)===s(i(e))}return{isValid:u,isComplete:function(e){return!!e&&(i(e).length===a.value.length&&u(e))},mask:i,unmask:s}},e.useRtl=ga,e.useTheme=Ea,e.version=Og})
